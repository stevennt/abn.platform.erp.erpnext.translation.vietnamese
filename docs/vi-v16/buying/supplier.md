...
### 2.1 Chi tiết thuế và Thông tin định danh
...
* **Danh mục thuế**: Mục này được liên kết với [Quy tắc thuế](../accounts/tax-rule.md). Nếu một Danh mục thuế được thiết lập tại đây, khi bạn chọn nhà cung cấp này, mẫu Thuế mua hàng và Phí tương ứng sẽ được áp dụng.
...
* **Là đơn vị vận chuyển**: Nếu nhà cung cấp đang bán dịch vụ vận chuyển của bạn, hãy tích vào ô này. Trong phiên bản v16, bạn có thể sử dụng tính năng **Lọc nhà cung cấp không phải đơn vị vận chuyển (Non-transporter supplier filtering)** để tối ưu hóa việc chọn nhà cung cấp trong các giao dịch vận chuyển.
...
* **Số tham chiếu nhà cung cấp (Supplier reference numbers)**: Cho phép bạn lưu trữ các mã số định danh hoặc số tham chiếu riêng của nhà cung cấp để dễ dàng đối chiếu trong các giao dịch mua hàng.
...
### 2.4 Hạn mức tín dụng và Quản lý thanh toán
...
* **Xem trước Sổ cái (Ledger Preview)**: Trong phiên bản v16, bạn có thể xem nhanh các bút toán liên quan đến nhà cung cấp này ngay tại giao diện để kiểm soát công nợ nhanh chóng hơn.
...
> Mẹo: Tài khoản phải trả mặc định được thiết lập trong danh mục Công ty. Nếu bạn muốn thiết lập một tài khoản khác làm Tài khoản mặc định cho khoản phải trả thay vì tài khoản Chủ nợ, hãy đi tới danh mục Công ty và thiết lập tài khoản.

> **Tính năng mới v16**: Hệ thống hỗ trợ tính năng **Email append-to** giúp tự động đính kèm các bản nháp Hóa đơn bán hàng (PI draft) vào luồng email giao tiếp với nhà cung cấp, giúp quy trình làm việc liền mạch hơn.