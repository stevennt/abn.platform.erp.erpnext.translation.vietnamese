...
<img class="screenshot" alt="Purchase taxes" src="https://docs.erpnext.com/docs/v16/assets/img/buying/purchase-taxes.png">
...
* **Reference Row #**: Nếu thuế dựa trên "Previous Row Total", bạn có thể chọn số dòng sẽ được lấy làm cơ sở cho tính toán này (mặc định là dòng trước đó).
   <img class="screenshot" alt="Purchase taxes table" src="https://docs.erpnext.com/docs/v16/assets/img/buying/purchase-taxes-table.png">
