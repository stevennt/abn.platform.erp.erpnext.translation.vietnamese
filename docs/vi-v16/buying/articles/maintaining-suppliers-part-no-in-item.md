...
<img alt="Supplier Item Code" class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/articles/supplier-item-code.png">
...
![Supplier item part print format](https://docs.erpnext.com/docs/v16/assets/img/articles/supplier-item-code-print-format.png)
...
<img alt="Supplier Item Code in transaction" class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/articles/supplier-item-code-in-purchase-order.png">