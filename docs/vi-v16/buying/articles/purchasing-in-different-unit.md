...
<img alt="Item Purchase UoM" class="screenshot" src="../assets/img/articles/editing-uom-in-po.gif">

#### Bước 2: Cập nhật Hệ số chuyển đổi UoM

Trong một Hộp (Box), nếu bạn có 20 cái (Nos) Bút, thì Hệ số chuyển đổi UoM sẽ là 20.

<img alt="Item Conversion Factor" class="screenshot" src="../assets/img/articles/po-conversion-factor.png">
...
<img alt="Purchase Qty in Default UoM" class="screenshot" src="../assets/img/articles/po-qty-in-stock-uom.png">

### Ghi sổ Sổ cái

Bất kể UoM mua hàng nào được chọn, việc ghi sổ cái kho sẽ được thực hiện theo UoM mặc định của mặt hàng. Do đó, bạn nên đảm bảo rằng hệ số chuyển đổi được nhập chính xác khi mua mặt hàng bằng các UoM khác nhau. Bạn có thể sử dụng tính năng **Xem trước Sổ cái (Ledger Preview)** để kiểm tra nhanh các bút toán trước khi Xác nhận.

<img alt="Print Format in Purchase UoM" class="screenshot" src="../assets/img/articles/po-stock-uom-ledger.png">
...
<img alt="Purchase UoM master" class="screenshot" src="../assets/img/articles/item-purchase-uom-conversion.png">

---
*Lưu ý: Trong phiên bản v16, bạn có thể sử dụng tính năng lọc Nhà cung cấp không vận chuyển (Non-transporter supplier filtering) và quản lý số tham chiếu Nhà cung cấp (Supplier reference numbers) để tối ưu hóa quy trình mua hàng này.*