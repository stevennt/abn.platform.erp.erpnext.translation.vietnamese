...
Trong phiên bản v16, việc quản lý nhà cung cấp trở nên linh hoạt hơn với các tính năng như lọc nhà cung cấp không phải đơn vị vận chuyển (Non-transporter supplier filtering), quản lý số tham chiếu nhà cung cấp (Supplier reference numbers) và xem trước sổ cái (Ledger Preview).
...
<img class="screenshot" alt="Supplier Group" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/buying/supplier-group.png">
...
<img class="screenshot" alt="Supplier Group" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/buying/supplier-group-tree.png">

Với [Phân quyền người dùng](https://docs.erpnext.com/docs/v16/user/manual/en/setting-up/users-and-permissions) mới, giờ đây bạn có thể áp dụng các quyền dựa trên phân cấp. Nghĩa là, nếu một Người dùng được phép xem nút cha của Nhóm nhà cung cấp, người đó sẽ mặc nhiên có quyền xem các nút con của nút cha đó.
...
* **Lọc nhà cung cấp không phải đơn vị vận chuyển (Non-transporter supplier filtering):** Giúp tinh chỉnh danh sách nhà cung cấp khi thực hiện các quy trình mua hàng, tách biệt giữa nhà cung cấp hàng hóa và các đơn vị vận chuyển.
* **Số tham chiếu nhà cung cấp (Supplier reference numbers):** Cho phép lưu trữ và quản lý các mã số tham chiếu riêng biệt của nhà cung cấp để đối chiếu hóa đơn và đơn mua hàng dễ dàng hơn.
* **Xem trước sổ cái (Ledger Preview):** Cung cấp khả năng xem nhanh các bút toán liên quan trực tiếp từ giao diện quản lý nhà cung cấp mà không cần chuyển đổi quá nhiều màn hình.
