...
## 2. Cách tạo Bảng điểm Nhà cung cấp
...
<img class="screenshot" alt="Purchase Order" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/buying/supplier-scorecard.png">

## 3. Các tính năng
### 3.1 Thiết lập chấm điểm
...
<img class="screenshot" alt="Purchase Order" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/buying/supplier-scorecard-weighing.png">
...
Xếp hạng bảng điểm của một nhà cung cấp cũng có thể được sử dụng để hạn chế nhà cung cấp không được đưa vào Yêu cầu báo giá hoặc không được xuất Đơn mua hàng. Ngoài ra, trong phiên bản v16, bạn có thể sử dụng tính năng lọc Nhà cung cấp không phải đơn vị vận chuyển (Non-transporter supplier filtering) để tối ưu hóa quy trình mua hàng. Màn hình sau có thể được xem bằng cách mở rộng một hàng trong bảng 'Scoring Standings', nhấp vào mũi tên hướng xuống.
<img class="screenshot" alt="Purchase Order" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/buying/supplier-scorecard-standing.png">

### 3.2 Thiết lập tiêu chí
...
<img class="screenshot" alt="Purchase Order" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/buying/supplier-scorecard-criteria.png">

Lưu ý: Trọng số tiêu chí cho một bảng điểm nên cộng lại bằng 100.

### 3.3 Các biến Bảng điểm Nhà cung cấp
...
![Supplier Scorecard variable](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/buying/supplier-scorecard-variables.png)
...
Điều quan trọng là công thức phải có thể giải được cho tất cả các giá trị biến. Điều này thường là vấn đề nếu giá trị trả về bằng 0. Ví dụ:
```
