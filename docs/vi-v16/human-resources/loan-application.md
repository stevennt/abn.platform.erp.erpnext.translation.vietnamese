...
* [Loại khoản vay](../human-resources/loan-type)
...
1. Lưu và Xác nhận.
  ...
  <img class="screenshot" alt="Loan Application" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/loan-application.png">
...
* Xác nhận.
  ...
  <img class="screenshot" alt="Repayment Fixed Amount Per Period" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/repayment1.png">
...
* Xác nhận.
  ...
  <img class="screenshot" alt="Repayment Fixed Amount Per Period" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/repayment2.png">

## 4. Các chủ đề liên quan

1. [Loại khoản vay](../human-resources/loan-type)
1. [Khoản vay](../human-resources/loan)