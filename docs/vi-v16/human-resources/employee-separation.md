...
* [Designation](/docs/v16/user/manual/vi/human-resources/designation)
* [Employee Grade](/docs/v16/user/manual/vi/human-resources/employee-grade)
...
Khi Xác nhận Nghỉ việc của Nhân viên, một [Project](/docs/v16/user/manual/vi/project-and-task) sẽ được tạo. Trong Dự án, các [Tasks](/docs/v16/user/manual/vi/project-and-task) cũng sẽ được tạo cho mỗi Hoạt động.
...
1. [Employee Promotion](/docs/v16/user/manual/vi/human-resources/employee_promotion)
