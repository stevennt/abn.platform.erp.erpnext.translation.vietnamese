...
1. [Employee](/docs/v16/user/manual/en/human-resources/employee)
1. [Additional Salary](/docs/v16/user/manual/en/human-resources/additional-salary)
1. [Job Applicant](/docs/v16/user/manual/en/human-resources/job-applicant)
...
<img class="screenshot" alt="Leave Allocations"
    src="https://docs.erpnext.com/docs/assets/img/human-resources/employee-referral.png">
...
<img class="screenshot" alt="Leave Allocations"
    src="https://docs.erpnext.com/docs/assets/img/human-resources/create-job-applicant.png">
...
<img class="screenshot" alt="Leave Allocations"
    src="https://docs.erpnext.com/docs/assets/img/human-resources/referral-bonus.png">
...
<img class="screenshot" alt="Leave Allocations"
    src="https://docs.erpnext.com/docs/assets/img/human-resources/create-referral-bonus.png">