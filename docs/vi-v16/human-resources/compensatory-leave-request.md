...
* [Kỳ nghỉ phép](/docs/v16/user/manual/en/human-resources/leave-period)
* [Loại nghỉ phép](/docs/v16/user/manual/en/human-resources/leave-type)
* [Chính sách nghỉ phép](/docs/v16/user/manual/en/human-resources/leave-policy)
* [Phân bổ nghỉ phép](/docs/v16/user/manual/en/human-resources/leave-allocation)
* [Danh sách ngày lễ](/docs/v16/user/manual/en/human-resources/holiday-list)
* [Chấm công](/docs/v16/user/manual/en/human-resources/attendance)

## 2. Cách tạo Yêu cầu Nghỉ bù

1. Đi tới danh sách Yêu cầu Nghỉ bù, nhấn vào **Mới**.
2. Chọn **ID Nhân viên**. Sau khi chọn, **Tên Nhân viên** và **Phòng ban** sẽ được tự động lấy dữ liệu.
3. Chọn **Loại nghỉ phép**.
4. Chọn **Ngày bắt đầu làm việc** và **Ngày kết thúc làm việc**. Đây là ngày (các ngày) mà Nhân viên đã làm việc trong một ngày Lễ.
5. Nhập **Lý do**.
6. **Lưu** và **Xác nhận**.
...
2. [Quy đổi ngày nghỉ thành tiền](/docs/v16/user/manual/en/human-resources/leave-encashment)
3. [Danh sách chặn nghỉ phép](/docs/v16/user/manual/en/human-resources/leave-block-list)