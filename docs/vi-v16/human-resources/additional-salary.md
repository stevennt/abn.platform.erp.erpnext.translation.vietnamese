...
1. Đi đến danh sách Additional Salary, nhấn vào **Mới**.
2. Chọn **Nhân viên**.
3. Chọn **Thành phần lương**.
4. Nhập **Số tiền**.
5. Nhập **Ngày tính lương**. Nếu Ngày tính lương cho Lương bổ sung nằm trong khoảng thời gian mà lương được xử lý, nó sẽ được cộng vào các khoản thu nhập/khấu trừ.
6. **Lưu** và **Xác nhận**.
