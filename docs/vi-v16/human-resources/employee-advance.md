...
1. [Hệ thống tài khoản](/docs/v16/user/manual/en/accounts/chart-of-accounts)
...
1. Lưu.
    ...
    <img class="screenshot" alt="Expense Claim" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/employee-advance.png">
...
Sau khi lưu Tạm ứng Nhân viên, Nhân viên nên [Giao tài liệu cho Người phê duyệt](/docs/v16/user/manual/en/using-erpnext/assignment). Khi được giao, người dùng phê duyệt cũng sẽ nhận được thông báo qua email. Để tự động hóa thông báo email, bạn cũng có thể thiết lập [Thông báo Email](/docs/v16/user/manual/en/setting-up/notifications.html).
...
Sau khi xác nhận bản ghi Tạm ứng Nhân viên, người dùng kế toán sẽ có thể tạo một [Thanh toán](/docs/v16/user/manual/en/accounts/payment-entry) bằng cách sử dụng nút 'Create'.

Bút toán thanh toán sẽ trông như sau:

<img class="screenshot" alt="Employee Advance Payment via Payment Entry" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/employee-advance-payment-entry.png">

#### Tạm ứng Nhân viên qua Bút toán
Ngoài ra, một [Bút toán](/docs/v16/user/manual/en/accounts/journal-entry) cũng có thể được tạo cho khoản Tạm ứng Nhân viên.


<img class="screenshot" alt="Employee Advance Payment via Journal Entry" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/employee-advance-journal-entry1.png">
...
<img class="screenshot" alt="Employee Advance Payment via Journal Entry" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/employee-advance-journal-entry2.png">
...
Sau này khi nhân viên yêu cầu thanh toán chi phí, một bản ghi tạm ứng có thể được lấy trong [Yêu cầu thanh toán chi phí](/docs/v16/user/manual/en/human-resources/expense-claim) và liên kết với bản ghi yêu cầu.
...
* Nếu số tiền chưa được sử dụng, hãy nhấp vào nút **Return** để hoàn trả số tiền Tạm ứng đã thanh toán
    ![Return Button](https://docs.erpnext.com/docs/v16/assets/img/human-resources/advance-return-button.png)
...
* Nếu chỉ một phần số tiền được yêu cầu và phần còn lại được hoàn trả, số tiền hoàn trả sẽ được hiển thị trong trường 'Returned Amount'.
    ![Return advance Amount](https://docs.erpnext.com/docs/v16/assets/img/human-resources/advance-returned-amount.png)

## 4. Các chủ đề liên quan

1. [Yêu cầu thanh toán chi phí](/docs/v16/user/manual/en/human-resources/expense-claim)
