...
* [Loại khoản vay](/docs/v16/user/manual/vi/human-resources/loan-type)
* [Đơn xin vay vốn](/docs/v16/user/manual/vi/human-resources/loan-application)
* [Hệ thống tài khoản](/docs/v16/user/manual/vi/accounts/chart-of-accounts)
...
1. Nhập Ngày bắt đầu thanh toán.
  ...
  <img class="screenshot" alt="Loan" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/human-resources/loan1.png">
...
1. Lưu. Sau khi Lưu, Lịch trình thanh toán sẽ tự động được tạo. Ngày thanh toán đầu tiên sẽ được thiết lập theo "Ngày bắt đầu thanh toán".
  ...
  <img class="screenshot" alt="Repayment Schedule" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/human-resources/loan2.png">

> Lưu ý: Tích chọn "Repay from Salary" nếu khoản thanh toán khoản vay sẽ được khấu trừ vào lương.

Ngoài ra, bạn có thể tạo bản ghi Khoản vay trực tiếp từ [Đơn xin vay vốn](/docs/v16/user/manual/vi/human-resources/loan-application)
...
<img class="screenshot" alt="Disbursement Entry" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/human-resources/disbursement-entry.png">
...
<img class="screenshot" alt="Salary Slip" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/human-resources/loan-repayment-salary-slip.png">
...
![Extending Loan](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/human-resources/change-loan-amount.gif)

## 4. Các chủ đề liên quan

1. [Bút toán](/docs/v16/user/manual/vi/accounts/journal-entry)
1. [Bút toán bảng lương](/docs/v16/user/manual/vi/human-resources/payroll-entry)