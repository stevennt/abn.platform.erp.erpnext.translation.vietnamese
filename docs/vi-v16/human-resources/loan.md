...
1. Nhập Ngày bắt đầu thanh toán.
  ...
  <img class="screenshot" alt="Loan" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/loan1.png">
...
1. Lưu. Sau khi Lưu, Lịch trình thanh toán sẽ tự động được tạo. Ngày thanh toán đầu tiên sẽ được thiết lập theo "Ngày bắt đầu thanh toán".
  ...
  <img class="screenshot" alt="Repayment Schedule" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/loan2.png">
...
<img class="screenshot" alt="Disbursement Entry" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/disbursement-entry.png">
...
<img class="screenshot" alt="Salary Slip" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/loan-repayment-salary-slip.png">
...
![Extending Loan](https://docs.erpnext.com/docs/v16/assets/img/human-resources/change-loan-amount.gif)
