...
1. Lưu và Xác nhận.
    ...
    <img class="screenshot" alt="Attendance" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/attendance.png">
...
1. Nhấn vào nút **Mark Attendance** và nhấn **Yes**.
    ...
    <img class="screenshot" alt="Attendance" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/marking_unmarked_attendance.gif">
