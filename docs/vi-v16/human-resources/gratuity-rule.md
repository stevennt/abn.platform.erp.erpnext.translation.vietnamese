...
<img class="screenshot" alt="Gratuity Rule" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/gratuity-rule.png">
...
<img class="screenshot" alt="gratuity-rule-example" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/gratuity-rule-example.png">
