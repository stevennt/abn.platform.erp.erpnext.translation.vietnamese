...
* [Department](/docs/v16/user/manual/vi/human-resources/department)
* [Leave Period](/docs/v16/user/manual/vi/human-resources/leave-period)
* [Holiday List](/docs/v16/user/manual/vi/human-resources/holiday-list)
* [Leave Type](/docs/v16/user/manual/vi/human-resources/leave-type)
* [Leave Policy](/docs/v16/user/manual/vi/human-resources/leave-policy)
* [Leave Allocation](/docs/v16/user/manual/vi/human-resources/leave-allocation)
...
1. Một bảng về Số ngày nghỉ được phân bổ (Allocated Leaves) sẽ được hiển thị. Dựa trên số ngày nghỉ đã sử dụng, số ngày nghỉ còn lại sẽ được hiển thị cho mỗi Loại nghỉ phép.
     ...
     <img class="screenshot" alt="Leave Application" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/leave-app.png">
...
1. Nhập Lý do nghỉ phép (Reason for Leave).
    ...
    <img class="screenshot" alt="Leave Application" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/leave-app1.png">
...
1. Bạn cũng có thể liên kết Phiếu lương (Salary Slip) của Nhân viên trong Đơn xin nghỉ phép để lưu hồ sơ.
    ...
    <img class="screenshot" alt="Leave Application" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/leave-app3.png">

1. Nhấn vào Lưu (Save). Sau khi Nhân viên lưu Đơn xin nghỉ phép, trạng thái của Đơn xin nghỉ phép sẽ chuyển sang 'Mở' (Open), và một email sẽ được gửi đến Người phê duyệt nghỉ phép để phê duyệt. Mẫu thông báo phê duyệt nghỉ phép có thể được cấu hình trong [HR Settings](/docs/v16/user/manual/vi/human-resources/hr-settings) tại phần Leave Settings.
...
Người phê duyệt nghỉ phép là người dùng có thể phê duyệt Đơn xin nghỉ phép của một Nhân viên. Trong phiên bản ERPNext 16, Người phê duyệt nghỉ phép có thể được thiết lập ở hai cấp độ:

* **Cấp độ Phòng ban:** Người phê duyệt nghỉ phép cho mỗi phòng ban có thể được cấu hình trong danh mục [Department](/docs/v16/user/manual/vi/human-resources/department). Có thể thiết lập nhiều Người phê duyệt nghỉ phép trong một Phòng ban. Người phê duyệt nghỉ phép đầu tiên trong danh sách sẽ được coi là Người phê duyệt mặc định.

    <img class="screenshot" alt="Leave Application - Leave Approvers" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/leave-app4.png">
...
Người phê duyệt nghỉ phép cũng có thể được thiết lập theo từng Nhân viên trong danh mục nhân viên.
 ...
 <img class="screenshot" alt="Leave Application - Leave Approvers" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/employee-level-approvers.png">
...
>* Nhân viên không thể đăng ký nghỉ phép nếu số ngày nghỉ còn lại không đủ.