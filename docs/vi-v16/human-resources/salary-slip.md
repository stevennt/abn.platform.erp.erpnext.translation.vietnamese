...
<img class="screenshot" alt="Create Salary Slip based on Timesheets" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/create-salary-slip-based-on-timesheets.png">
...
<img class="screenshot" alt="Year to Date and Month to Date" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/ytd-and-mtd.png">
...
<img class="screenshot" alt="Year to Date for Salary Slip Components" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/ytd-component.png">