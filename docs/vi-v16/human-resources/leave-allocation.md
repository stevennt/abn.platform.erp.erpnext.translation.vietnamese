...
1. Lưu và Xác nhận.
    ...
    src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/leave-allocation.png">
...
### 2.1 Phân bổ nghỉ phép thông qua Kỳ nghỉ phép
 ...
 <img class="screenshot" alt="Grant Leaves from Leave Period"
    src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/grant-button.png">
...
<img class="screenshot" alt="Manual Leave Allocation"
    src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/leave-allocation2.png">
