...
* [Employee Tax Exemption Category](#31-danh-mục-miễn-thuế-cho-nhân-viên-employee-tax-exemption-category)
* [Employee Tax Exemption Sub Category](#32-danh-mục-phụ-miễn-thuế-cho-nhân-viên-employee-tax-exemption-sub-category)
...
1. Lưu và Xác nhận.
    ...
    <img class="screenshot" alt="Employee Tax Exemption Declaration" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/employee-tax-exemption-declaration.png">
...
Bạn có thể cấu hình Employee Tax Exemption Category bằng cách đi đến: **Employee Tax and Benefits > Employee Tax Exemption Category**
 ...
 <img class="screenshot" alt="Employee Tax Exemption Category" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/employee-tax-exemption-sub-category1.png">
...
Bạn có thể cấu hình Employee Tax Exemption Sub Category bằng cách đi đến: **Employee Tax and Benefits > Employee Tax Exemption Sub-Category**

 <img class="screenshot" alt="Employee Tax Exemption Category" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/employee-tax-exemption-category1.png">
...
Nhập Monthly House Rent (Tiền thuê nhà hàng tháng) và đánh dấu vào ô 'Rented in Metro City' nếu áp dụng, sau đó Lưu và Xác nhận biểu mẫu. Mức Miễn thuế HRA Hàng năm và Hàng tháng sẽ được tự động tính toán.

Sau khi bản khai báo được Xác nhận, bạn có thể gửi bằng chứng miễn thuế của mình bằng cách nhấp vào nút *Submit Proof*.

<img class="screenshot" alt="Employee Tax Exemption Declaration" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/hra-exemption.png">
...
1. [Employee Tax Exemption Proof Submission](../human-resources/employee-tax-exemption-proof-submission)
1. [Employee Benefit Application](../human-resources/employee-benefit-application)
1. [Employee Benefit Claim](../human-resources/employee-benefit-claim)
