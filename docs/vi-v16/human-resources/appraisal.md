...
1. Chọn Mẫu đánh giá. Nếu chưa có, hãy tạo một Mẫu đánh giá. Nhập Tên mẫu đánh giá và các Khu vực kết quả chính (KRAs) cùng với trọng số của chúng.
    ...
    <img class="screenshot" alt="Appraisal" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/appraisal-template.png">
...
1. Lưu và Xác nhận.
    ...
    <img class="screenshot" alt="Appraisal" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/appraisal.png">
