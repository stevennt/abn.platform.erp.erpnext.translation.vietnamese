...
Trong ERPNext, các hoạt động tiêu chuẩn này có thể được theo dõi trong Tiếp nhận Nhân viên. Để truy cập Tiếp nhận Nhân viên, hãy đi đến:
...
1. Lưu và Xác nhận.
  ...
  <img class="screenshot" alt="Onboarding Template" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/employee-onboarding1.png">
...
1. Đề cập các Hoạt động để tiếp nhận. Đối với mỗi Hoạt động, bạn cũng có thể đề cập Người dùng hoặc Vai trò, hoặc một trong hai, người mà Hoạt động này sẽ được giao.
  ...
  <img class="screenshot" alt="Onboarding Template" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/onboarding-template.png">
...
<img class="screenshot" alt="Onboarding Template" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/project-task.png">

Ngoài ra, mỗi Hoạt động có thể được gán trọng số dựa trên tầm quan trọng của nó.

<img class="screenshot" alt="Tasks and Assignments" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/employee-onboarding3.png">
...
<img class="screenshot" alt="Onboarding Template" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/onboarding-employee.png">


## 4. Các chủ đề liên quan

1. [Employee Promotion](../human-resources/employee_promotion.md)
1. [Employee Separation](../human-resources/employee-separation.md)
1. [Employee Transfer](../human-resources/employee_transfer.md)