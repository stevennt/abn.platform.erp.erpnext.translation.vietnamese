...
<img class="screenshot" alt="Employee Benefit Application" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/employee-benefit-application.png">
...
> **Lưu ý:** Việc tính Thuế thông thường không bao gồm các Phúc lợi linh hoạt vì trong hầu hết các trường hợp, các khoản này được miễn Thuế. Để tính thuế cho các thành phần này bất kỳ lúc nào trước kỳ lương cuối cùng, hãy sử dụng *Deduct Tax For Unclaimed Employee Benefits* trong Payroll Entry / Salary Slip khi đang xử lý Lương.
