...
2. Chọn Tần suất thanh toán lương.
3. Chọn Chi nhánh, Chức danh và Phòng ban để lọc nhân viên (tùy chọn).
4. Chọn Dự án (tùy chọn) nếu bạn muốn chạy bảng lương theo một dự án.
5. Chọn các ô kiểm 'Validate Attendance' (Xác nhận chấm công) và 'Salary Slip Based on Timesheet' (Phiếu lương dựa trên bảng chấm công) trong trường hợp bạn muốn khấu trừ lương dựa trên việc chấm công và nếu bạn cũng muốn xem xét bảng chấm công của nhân viên tương ứng.
6. Chọn Tài khoản thanh toán để thực hiện Bút toán ngân hàng.
7. **Lưu**.
...
<img class="screenshot" alt="Payroll Entry" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/payroll-entry-get-employees.png">
...
<img class="screenshot" alt="Payroll Entry" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/payroll-entry.png">
...
<img class="screenshot" alt="Payroll Entry" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/payroll-make-accrual-entry.png">
...
<img class="screenshot" alt="Payroll Entry" src="https://docs.erpnext.com/docs/v16/assets/img/human-resources/payroll-make-bank-entry.png">

> **Lưu ý:** Đối với các Thành phần lương là Phúc lợi linh hoạt và có tích chọn *Create Separate Payment Entry Against Benefit Claim* (Tạo Bút toán thanh toán riêng cho yêu cầu phúc lợi), ERPNext sẽ hạch toán các Bút toán nháp riêng biệt.

## 3. Các chủ đề liên quan

1. [Thành phần lương](../human-resources/salary-component.md)
2. [Cấu trúc lương](../human-resources/salary-structure.md)
3. [Kỳ lương](../human-resources/payroll-period.md)
4. [Bút toán](../accounts/journal-entry.md)
