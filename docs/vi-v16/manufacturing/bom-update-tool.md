...
> Sản xuất > Công cụ > Công cụ cập nhật BOM

## 1. Cách sử dụng Công cụ cập nhật BOM
Hãy xem xét một tình huống để hiểu rõ hơn về chức năng này.

Giả sử một công ty sản xuất máy tính, Định mức nguyên vật liệu (BOM) cho máy tính sẽ trông như sau:
...
<img class="screenshot" alt="BOM Update Tool" src="../assets/img/manufacturing/bom-update-tool.png">
...
Chức năng này cũng có thể được thực hiện tự động hàng ngày. Để làm điều đó, bạn cần bật "Update BOM Cost Automatically" từ Cài đặt sản xuất (Manufacturing Settings).