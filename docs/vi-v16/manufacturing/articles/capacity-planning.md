...
<img alt="Role Desk Permission" class="screenshot" src="../assets/img/articles/capacity-1.png">
...
1.  **Công đoạn**
    ...
    `Sản xuất > Định mức nguyên vật liệu > Công đoạn`

2.  **Máy công tác**

    Thêm từng Máy công tác vào tài khoản ERPNext của bạn từ:

    `Sản xuất > Định mức nguyên vật liệu > Máy công tác`
...
<img alt="Role Desk Permission" class="screenshot" src="../assets/img/articles/capacity-2.png">
...
Nếu bạn muốn bỏ qua kiểm tra trên và cho phép sắp xếp công việc sản xuất vượt quá giờ làm việc của Máy công tác, hãy bật **Overtime** trong Cài đặt sản xuất (Manufacturing Settings).

<img alt="Role Desk Permission" class="screenshot" src="../assets/img/articles/capacity-3.png">

Nếu bạn muốn vô hiệu hóa hoàn toàn tính năng Lập kế hoạch năng lực, trong Cài đặt sản xuất (Manufacturing Settings), hãy tích vào trường "Disable Capacity Planning and Time Tracking".