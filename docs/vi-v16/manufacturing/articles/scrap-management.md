...
## Phế liệu trong Định mức nguyên vật liệu (BOM)
...
<img class="screenshot" alt="Scrap in BOM" src="../assets/img/manufacturing/scrap-1.png">

## Phế liệu trong Phiếu sản xuất

Khi quá trình sản xuất hoàn tất, Phiếu sản xuất (Work Order/Manufacture Entry) sẽ được tạo dựa trên Lệnh sản xuất. Trong phiếu này, mặt hàng phế liệu sẽ được lấy vào bảng Item, và chỉ có Kho (Warehouse) đích được cập nhật cho mặt hàng đó. Hãy đảm bảo rằng Giá trị tính giá (Valuation Rate) đã được cập nhật cho mặt hàng này để phục vụ mục đích hạch toán kế toán.

<img class="screenshot" alt="Scrap in Manufacture Entry" src="../assets/img/manufacturing/scrap-2.gif">
