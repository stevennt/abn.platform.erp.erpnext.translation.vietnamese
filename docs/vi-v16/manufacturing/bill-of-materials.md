...
**Định mức nguyên vật liệu** (BOM) là trung tâm của hệ thống Sản xuất và là tài liệu quan trọng nhất giúp tạo ra các loại tài liệu khác như Lệnh sản xuất và Thẻ công việc. ERPNext hỗ trợ BOM đa cấp. Để biết thêm, hãy truy cập [trang này](/docs/v16/user/manual/en/manufacturing/articles/managing-multi-level-bom).
...
<img class="screenshot" alt="Work Order" src="https://docs.erpnext.com/docs/v16/assets/img/manufacturing/manufacturing-flow-bom.png">
...
* [Mặt hàng](/docs/v16/user/manual/en/stock/item)
* [Công đoạn](/docs/v16/user/manual/en/manufacturing/operation)
* [Máy móc/Trạm làm việc](/docs/v16/user/manual/en/manufacturing/workstation)
* [Quy trình công nghệ](/docs/v16/user/manual/en/manufacturing/routing)
...
1. Trong bảng Mặt hàng, chọn các nguyên vật liệu (Mặt hàng) cần thiết để sản xuất Mặt hàng. Sau đó tiến hành:
 ...
 1. Nhập tỷ lệ phế phẩm sẽ còn lại sau khi nguyên vật liệu này được sử dụng.
  ![BOM Materials](https://docs.erpnext.com/docs/v16/assets/img/manufacturing/bom-materials.png)
...
1. Trong phần Phế phẩm, chọn Mặt hàng phế phẩm sẽ được tạo ra khi sản xuất và số lượng của nó. Mặt hàng phế phẩm cũng có thể có Đơn giá nếu nó là sản phẩm phụ chứ không phải là chất thải. Bỏ qua phần này nếu 100% nguyên vật liệu được sử dụng hết hoàn toàn.
  ![BOM Scrap](https://docs.erpnext.com/docs/v16/assets/img/manufacturing/bom-scrap.png)
...
Trong bảng Mặt hàng, bạn sẽ thấy tùy chọn 'Include Item in Manufacturing' (Bao gồm Mặt hàng trong Sản xuất). Các Nguyên vật liệu cần được tích chọn ô này. Trong trường hợp có các Công đoạn hoặc dịch vụ bạn cần đưa vào BOM mà không nhất thiết là một Mặt hàng dùng để sản xuất, hãy bỏ tích ô này. Ví dụ, việc xử lý nhựa với hóa chất đòi hỏi một số chi phí nhưng nó không phải là một Mặt hàng và chi phí đó cần được theo dõi.
  ...
  <img class="screenshot" alt="Task" src="https://docs.erpnext.com/docs/v16/assets/img/manufacturing/bom-item-include.png">

### 2.1 Định mức nguyên vật liệu có Công đoạn
Để thêm [Công đoạn](/docs/v16/user/manual/en/manufacturing/operation), hãy tích vào ô 'With Operations' (Có Công đoạn). Bây giờ, một bảng Công đoạn có thể được nhìn thấy. Tùy chọn này hữu ích để theo dõi chi phí của các Công đoạn khác nhau được thực hiện để sản xuất [Mặt hàng](/docs/v16/user/manual/en/stock/item). Các Công đoạn có thể được thêm dễ dàng bằng cách thiết lập một mẫu với [Quy trình công nghệ](/docs/v16/user/manual/en/manufacturing/routing) chính.

<img class="screenshot" alt="Task" src="https://docs.erpnext.com/docs/v16/assets/img/manufacturing/bom-operations.png">

1. Trong bảng “Operations” (Công đoạn), thêm các công đoạn cần được thực hiện để sản xuất Mặt hàng cụ thể này.
1. Đối với mỗi công đoạn, bạn sẽ được yêu cầu nhập [Máy móc/Trạm làm việc](/docs/v16/user/manual/en/manufacturing/workstation) nơi Công đoạn sẽ được thực hiện. Một Máy móc/Trạm làm việc mặc định có thể được thiết lập từ tài liệu [Công đoạn](/docs/v16/user/manual/en/manufacturing/operation).
...
> Lưu ý: Các Máy móc/Trạm làm việc chỉ được định nghĩa cho mục đích tính giá thành sản phẩm và lập lịch Công đoạn của Lệnh sản xuất, không phải để theo dõi tồn kho. Tồn kho được theo dõi trong các [Kho](/docs/v16/user/manual/en/stock/warehouse) được thiết lập trong bảng Mặt hàng của BOM.

Transfer Material Against (Chuyển vật tư theo) cần được thiết lập cho một BOM có Công đoạn. Vật tư có thể được chuyển theo một [Lệnh sản xuất](/docs/v16/user/manual/en/manufacturing/work-order) theo lô hoặc theo từng [Thẻ công việc](/docs/v16/user/manual/en/manufacturing/job-card) riêng lẻ. Việc thay đổi này ảnh hưởng đến việc 'Chuyển vật tư để sản xuất' được thực hiện theo Lệnh sản xuất cùng một lúc hay thực hiện nhiều lần theo từng Thẻ công việc riêng lẻ. Việc thiết lập tùy chọn này phụ thuộc vào các yếu tố như thời gian sản xuất mặt hàng, giá trị của các mặt hàng được sản xuất, số lượng linh kiện được sử dụng trong sản xuất, kỹ năng của nhân công tham gia, v.v.

![BOM transfer materials against](https://docs.erpnext.com/docs/v16/assets/img/manufacturing/bom-transfer-materials.png)