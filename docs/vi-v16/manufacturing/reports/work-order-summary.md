...
Người dùng có thể sử dụng báo cáo này để:
* Kiểm tra trạng thái của các Lệnh sản xuất được liên kết với Đơn bán hàng.
* Theo dõi tiến độ các Lệnh sản xuất dựa trên trạng thái: Chưa bắt đầu, Đang thực hiện, Đã hoàn thành và Đã dừng.
