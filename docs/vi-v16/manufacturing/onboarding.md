...
<img class="screenshot" alt="BOM" src="../assets/img/manufacturing/onboarding.png">
...
1. [Kho](../user/manual/stock/warehouse)
1. [Trạm làm việc / Máy móc](../user/manual/manufacturing/workstation)
1. [Công đoạn](../user/manual/manufacturing/operation)
1. [Nguyên vật liệu / Thành phẩm](../user/manual/stock/item)
1. [Quy trình sản xuất](../user/manual/manufacturing/routing)
...
1. [Định mức nguyên vật liệu](../user/manual/manufacturing/bill-of-materials)
1. [Lệnh sản xuất](../user/manual/manufacturing/work-order)
1. [Thẻ công việc](../user/manual/manufacturing/job-card)
1. [Kế hoạch sản xuất](../user/manual/manufacturing/production-plan)
...
Đối với các hệ thống sản xuất theo thiết kế, phân hệ Sản xuất nên được sử dụng cùng với [phân hệ Dự án](../user/manual/projects).
