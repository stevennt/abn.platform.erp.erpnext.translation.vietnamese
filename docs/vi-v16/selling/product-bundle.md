...
4. Lưu.
<img class="screenshot" alt="Product Bundle" src="https://docs.erpnext.com/docs/v16/assets/img/selling/product-bundle.png">
...
<img class="screenshot" alt="Product Bundle" src="https://docs.erpnext.com/docs/v16/assets/img/selling/product-bundle.gif">
...
**Lưu ý về Cutoff date (Ngày chốt):** Trong phiên bản v16, khi tạo Phiếu giao hàng (DN) từ Đơn bán hàng (SO), hệ thống sẽ áp dụng ngày chốt để đảm bảo tính chính xác của dữ liệu tồn kho và các giao dịch liên quan.

**Quản lý Khách hàng:** Tại biểu mẫu Khách hàng, bạn có thể sử dụng các nút SO/Quotation để nhanh chóng tạo Đơn bán hàng hoặc Báo giá trực tiếp từ thông tin khách hàng.

**Giữ chỗ tồn kho (Stock Reservation):** Khi sử dụng Gói sản phẩm trong các đơn hàng, hệ thống v16 hỗ trợ tính năng Giữ chỗ tồn kho, giúp đảm bảo các mặt hàng con trong gói được giữ riêng cho đơn hàng đó, tránh tình trạng thiếu hụt khi thực hiện giao hàng.
