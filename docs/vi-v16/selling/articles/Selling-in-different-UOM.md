...
![Item Unit of Measure](https://docs.erpnext.com/docs/v16/assets/img/selling/Item-UOM.png)
...
![Sale Order Unit of Measure](https://docs.erpnext.com/docs/v16/assets/img/selling/Sale-Order-UOM.png)
...
![UOM in Stock Ledger](https://docs.erpnext.com/docs/v16/assets/img/selling/uom-in-stock-ledger.png)
