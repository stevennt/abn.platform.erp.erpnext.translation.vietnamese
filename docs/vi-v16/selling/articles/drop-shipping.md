...
<img class="screenshot" alt="Setup Item Master" src="https://docs.erpnext.com/docs/v16/assets/img/selling/setup-drop-ship-on-item-master.png">
...
<img class="screenshot" alt="Setup Drop Shipping on Sales Order Item" src="https://docs.erpnext.com/docs/v16/assets/img/selling/setup-drop-ship-on-sales-order-item.png">
...
<img class="screenshot" alt="Setup Drop Shipping on Sales Order Item" src="https://docs.erpnext.com/docs/v16/assets/img/selling/drop-ship-sales-order.png">
...
<img class="screenshot" alt="Purchase Order for Drop Shipping" src="https://docs.erpnext.com/docs/v16/assets/img/selling/drop-ship-purchase-order.png">
...
<img class="screenshot" alt="Close Sales Order" src="https://docs.erpnext.com/docs/v16/assets/img/selling/close-option-in-sales-order.png">
...
<img class="screenshot" alt="Drop Dhip Print Format" src="https://docs.erpnext.com/docs/v16/assets/img/selling/drop-ship-print-format.png">
