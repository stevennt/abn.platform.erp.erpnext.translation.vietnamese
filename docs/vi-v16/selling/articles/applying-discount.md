...
![Discount on Price List Rate](https://docs.erpnext.com/docs/v16/assets/img/selling/discount-on-price-list-rate.png)
...
![Additional Discount](https://docs.erpnext.com/docs/v16/assets/img/selling/additional-discount.png)
...
![Discount on Net Total](https://docs.erpnext.com/docs/v16/assets/img/selling/discount-on-net-total.png)
...
![Discount on Grand Total](https://docs.erpnext.com/docs/v16/assets/img/selling/discount-on-grand-total.png)
