...
![Close Option in Sales Order](https://docs.erpnext.com/docs/v16/assets/img/selling/close-option-in-sales-order.png)
...
![Closed Sales Order](https://docs.erpnext.com/docs/v16/assets/img/selling/closed-sales-order.png)
