...
![Sales taxes](https://docs.erpnext.com/docs/v16/assets/img/selling/sales-taxes.png)
...
* **Reference Row # (Số dòng tham chiếu)**: Nếu thuế dựa trên "On Previous Row Total", bạn có thể chọn số dòng sẽ được lấy làm cơ sở cho tính toán này (mặc định là dòng trước đó).
    ![Sales taxes table](https://docs.erpnext.com/docs/v16/assets/img/selling/sales-taxes-table.png)
