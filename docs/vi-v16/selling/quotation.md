...
![Make Quotation from Opportunity](https://docs.erpnext.com/docs/v16/assets/img/selling/selling-flow-quo.png)
...
* [Khách hàng](https://docs.erpnext.com/docs/v16/user/manual/en/CRM/customer)
* [Khách hàng tiềm năng](https://docs.erpnext.com/docs/v16/user/manual/en/CRM/lead)
...
7. Thêm các loại thuế và phí bổ sung nếu áp dụng.
8. **Lưu**.

Bạn cũng có thể tạo Báo giá từ một Cơ hội như sau.

![Make Quotation from Opportunity](https://docs.erpnext.com/docs/v16/assets/img/selling/make-quote-from-opp.png)
...
* Trong phần **Lập kế hoạch**, bạn có thể thấy Số lượng dự kiến và số lượng thực tế hiện có. Để biết thêm về các trường này, [nhấp vào đây](../stock/projected-quantity.md). Bạn cũng có thể sử dụng tính năng **Stock Reservation** (Giữ hàng trong kho) để đảm bảo mặt hàng được dành riêng cho đơn hàng này. Nếu bạn nhấp vào nút 'Số dư kho', nó sẽ đưa bạn đến một DocType nơi bạn có thể tạo báo cáo tồn kho cho mặt hàng đó.
...
![Taxes in Quotation](https://docs.erpnext.com/docs/v16/assets/img/selling/quotation-taxes.png)
...
Ngoài việc đưa ra chiết khấu cho từng mặt hàng, bạn có thể thêm một khoản chiết khấu cho toàn bộ báo giá trong phần này. Khoản chiết khấu này có thể dựa trên Tổng cộng, tức là sau thuế/phí hoặc Tổng ròng, tức là trước thuế/phí.

### 3.6 Lưu ý về ngày cắt (Cutoff date)
Trong phiên bản v16, khi bạn chuyển đổi từ Báo giá sang Đơn bán hàng (SO) và sau đó tạo Phiếu giao hàng (DN), hệ thống sẽ áp dụng quy tắc **Cutoff date**. Điều này đảm bảo rằng các giao dịch kho và kế toán được ghi nhận chính xác tại thời điểm thực tế phát sinh, tránh sai lệch số liệu tồn kho giữa các kỳ báo cáo.