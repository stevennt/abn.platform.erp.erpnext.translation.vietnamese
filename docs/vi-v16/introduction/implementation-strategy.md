...
Trước khi bạn bắt đầu quản lý các hoạt động vận hành trong ERPNext v16, trước tiên bạn phải làm quen với hệ thống và các thuật ngữ được sử dụng. Vì lý do này, chúng tôi khuyên rằng việc triển khai nên diễn ra theo hai giai đoạn.
...
### Giai đoạn Thử nghiệm
  ...
  * Hoàn thành một chu trình bán hàng tiêu chuẩn - Khách hàng tiềm năng > Cơ hội > Báo giá > Đơn bán hàng > Phiếu giao hàng > Hóa đơn > Thanh toán (Bút toán).
...
Khi bạn đã quen với ERPNext v16, hãy bắt đầu nhập dữ liệu thực tế của bạn!
