...
1. Nhập Mã mặt hàng, Tên mặt hàng, Nhóm mặt hàng và Đơn giá bán.
    ![New Item](https://docs.erpnext.com/docs/v16/assets/img/website/new-item.png)
...
> Đọc [tài liệu về Mặt hàng](../stock/item) để tìm hiểu thêm.
...
![Item with Variants](https://docs.erpnext.com/docs/v16/assets/img/website/item-with-variants.png)
*Mặt hàng có Biến thể*

> Tìm hiểu thêm về cách tạo Mặt hàng có Biến thể [tại đây](../stock/item-variants)
...
![Item Website Description](https://docs.erpnext.com/docs/v16/assets/img/website/item-website-description.png)
...
![Item Image and Slideshow](https://docs.erpnext.com/docs/v16/assets/img/website/item-image-slideshow.png)
...
![Item Website Specifications](https://docs.erpnext.com/docs/v16/assets/img/website/item-website-specifications.png)
...
![Publish Item](https://docs.erpnext.com/docs/v16/assets/img/website/publish-item.png)
*Xuất bản Mặt hàng*

Bây giờ bạn sẽ thấy liên kết **See on Website** ở thanh bên. Nhấp vào đó để xem
trang sản phẩm của bạn.

![Product Page](https://docs.erpnext.com/docs/v16/assets/img/website/product-page.png)
*Trang Sản phẩm*
...
![Custom Website Content](https://docs.erpnext.com/docs/v16/assets/img/website/custom-website-content.png)
*Nội dung Website Tùy chỉnh*

![Product Page with Custom Content](https://docs.erpnext.com/docs/v16/assets/img/website/product-page-with-custom-content.png)
*Trang Sản phẩm với Nội dung Tùy chỉnh*

### 2.6 Kho Website
Tính năng này có sẵn trong [Mặt hàng](../stock/item#318-website). Chọn một kho hiện có hoặc tạo một kho mới cho các giao dịch thông qua website của bạn. Kho này sẽ khác với các Kho ngoại tuyến của bạn. Tồn kho cho bất kỳ giao dịch trực tuyến nào sẽ được trừ vào Kho được thiết lập trong phần Kho Website.
