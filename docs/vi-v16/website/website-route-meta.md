...
> Home > Website > Website Route Meta

## 1. Cách thêm thẻ meta vào một trang web

1. Đi tới danh sách Website Route Meta và nhấn vào **Mới** (New).
...
![New Website Route Meta](https://docs.erpnext.com/docs/v16/assets/img/website/new-website-route-meta.png)
