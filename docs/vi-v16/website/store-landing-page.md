...
Sau khi kích hoạt Giỏ hàng (Shopping Cart) cho ứng dụng của bạn, bạn có thể tạo một trang đích tùy chỉnh cho cửa hàng của mình bằng cách sử dụng [Trình xây dựng Trang Web](../user/manual/website/web-page-builder).

![Store Landing Page](https://docs.erpnext.com/docs/v16/assets/img/website/store-landing-page.png)
*Trang đích Cửa hàng tùy chỉnh*

## 1. Cách tạo Trang đích Cửa hàng tùy chỉnh

1. Thực hiện theo các bước được đề cập tại đây để [tạo một Trang Web](../user/manual/website/web-page).
...
1. Chọn một Mẫu Web (Web Template).
	...
	![Store Web Templates](https://docs.erpnext.com/docs/v16/assets/img/website/store-web-templates.png)
...
6. Thêm Giá trị.
	...
	- **Hero Slider (Trình trượt chính):**
		...
		![Store Hero Slider](https://docs.erpnext.com/docs/v16/assets/img/website/store-hero-slider.png)
		*Cấu hình Hero Slider*

	- **Product Category Cards (Thẻ Nhóm mặt hàng):**
		Có thể cấu hình tối đa 8 thẻ nhóm mặt hàng. Mỗi nhóm mặt hàng sẽ liên kết đến một [Nhóm mặt hàng](../user/manual/stock/item-group).
		Đảm bảo rằng tùy chọn **Show in Website** được tích trong biểu mẫu Nhóm mặt hàng để đường dẫn cho nhóm mặt hàng được tạo ra.

		![Store Product Category Cards](https://docs.erpnext.com/docs/v16/assets/img/website/store-product-category.png)
	...
	- **Item Card Group (Nhóm thẻ Mặt hàng):**
		...
		Mỗi thẻ sẽ liên kết đến một [Mặt hàng](../user/manual/stock/item). Nếu mục **featured** được chọn, mặt hàng sẽ chiếm 2 cột không gian.

		![Store Item Card Group](https://docs.erpnext.com/docs/v16/assets/img/website/store-item-card-group.png)
...
7. Xuất bản Trang Web của bạn.
	...
	![Store Page Published](https://docs.erpnext.com/docs/v16/assets/img/website/store-page-published.png)
	*Xuất bản Trang Web của bạn*

8. Thiết lập làm Trang chủ.

	Thực hiện theo các bước [tại đây](../user/manual/website/articles/website-home-page) để thiết lập trang này làm trang chủ Website của bạn.