...
Bạn cũng có thể thiết lập một [Web Page](../user/manual/en/website/web-page) làm trang đích.

Nếu bạn muốn sử dụng [Homepage](../user/manual/en/website/homepage) của ERPNext, bạn phải thiết lập nó là `home`.
...
Tạo một giao diện cá nhân hóa cho Website của bạn và thiết lập tại đây. Tìm hiểu thêm về cách cấu hình Website Theme [tại đây](../user/manual/en/website/website-theme).
...
- Tạo Google OAuth 2.0 Credentials thông qua [Google Settings](../user/manual/en/erpnext_integration/google_settings)
