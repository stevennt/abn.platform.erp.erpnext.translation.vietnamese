...
![Website Settings - Landing Page](https://docs.erpnext.com/docs/v16/assets/img/website/website-settings-landing-page.png)
...
![Website Settings - Banner Image](https://docs.erpnext.com/docs/v16/assets/img/website/website-settings-banner-image.png)
...
![Website Settings - Favicon](https://docs.erpnext.com/docs/v16/assets/img/website/website-settings-favicon.png)
*Website Settings - Favicon*

Xem website của bạn bằng cách nhấp vào **View Website** trên thanh hành động ở góc trên bên phải.

![Website with Brand and Favicon](https://docs.erpnext.com/docs/v16/assets/img/website/website-brand-and-favicon.png)
...
![Website Setting - Top Bar](https://docs.erpnext.com/docs/v16/assets/img/website/website-settings-top-bar.png)
*Website Setting - Top Bar*

![Website Navbar Items](https://docs.erpnext.com/docs/v16/assets/img/website/website-navbar-items.png)
...
![Website Settings - Banner](https://docs.erpnext.com/docs/v16/assets/img/website/website-settings-banner.png)
*Website Settings - Banner*

![Website Banner](https://docs.erpnext.com/docs/v16/assets/img/website/website-banner.png)
*Website Banner*
...
![Website Settings - Footer Address](https://docs.erpnext.com/docs/v16/assets/img/website/website-settings-footer-address.png)
*Website Settings - Footer Address*

![Website Settings - Footer Links](https://docs.erpnext.com/docs/v16/assets/img/website/website-settings-footer-links.png)
*Website Settings - Footer Links*

![Website Footer](https://docs.erpnext.com/docs/v16/assets/img/website/website-footer.png)
*Website Footer*
...
![Google Integrations](https://docs.erpnext.com/docs/v16/assets/img/website/website-settings-integrations.png)
*Google Integrations*
...
![Website Settings - Header](https://docs.erpnext.com/docs/v16/assets/img/website/website-settings-header.png)
...
![Website Settings - Robots](https://docs.erpnext.com/docs/v16/assets/img/website/website-settings-robots-txt.png)
