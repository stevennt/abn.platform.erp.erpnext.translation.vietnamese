...
<img alt="Standard Desk Page" class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/customize/standard-desk-page.png">
...
<img alt="Desk Page List" class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/customize/desk-page-list.png">
...
<img alt="Customize Desk Page" class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/customize/customize-desk-page.png">

## Trang Desk Tùy chỉnh

Bạn cũng có thể tạo các Trang Desk của riêng mình bằng cách chỉ cần tạo một tài liệu Trang Desk mới.

<img alt="New Desk Page" class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/customize/new-desk-page.png">
...
<img alt="Desk Page Card" class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/customize/desk-page-card.png">
