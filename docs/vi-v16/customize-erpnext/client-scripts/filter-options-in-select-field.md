...
Giả sử bạn có hai trường thả xuống (drop-down) tên là State (Bang) và City (Thành phố). State có hai giá trị là Karnataka và Maharashtra, còn City có bốn giá trị là Bangalore, Mysore, Mumbai và Pune. Nếu bạn muốn lọc các tùy chọn trong City dựa trên giá trị đã chọn trong State, bạn có thể viết một script tùy chỉnh như dưới đây.
...
<img class="screenshot" alt="Opening Account" src="../assets/img/customize/filter_dropdown.gif">
