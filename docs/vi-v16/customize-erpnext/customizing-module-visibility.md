...
*Trong Phiên bản 16, bạn có thể tùy chỉnh hiển thị các module thông qua giao diện quản trị để tối ưu hóa không gian làm việc trên màn hình chính.*

<img alt="Module Visibility" class="screenshot" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/customize/customize-module-visibility-2.png">

<img alt="Module Visibility" class="screenshot" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/customize/customize-module-visibility.gif">

> Lưu ý: Các Module sẽ tự động bị ẩn đối với những người dùng không có quyền đối với các tài liệu trong module đó. Ví dụ: nếu một Người dùng không có quyền đối với Đơn mua hàng, Nhà cung cấp, thì module “Buying” sẽ tự động bị ẩn đối với Người dùng đó.
...
<img alt="Module Visibility" class="screenshot" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/customize/customize-module-visibility-4.png">
...
<img alt="Module Visibility" class="screenshot" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/customize/customize-module-visibility-1.png">
