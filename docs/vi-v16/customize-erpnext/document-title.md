...
Từ phiên bản ERPNext 6.0 trở đi, tất cả các giao dịch đều có thuộc tính 'Title' (Tiêu đề). Nếu không có thuộc tính tiêu đề, bạn có thể thêm một **Trường tùy chỉnh** (Custom Field) làm tiêu đề và thiết lập **Title Field** thông qua **Customize Form**.
