...
![Tùy chọn Tùy chỉnh trong Chế độ xem danh sách](https://docs.erpnext.com/docs/v16/assets/img/customize/customize-option-in-list-view.png)
...
![Trường tùy chỉnh mới](https://docs.erpnext.com/docs/v16/assets/img/customize/new-custom-field.png)
...
![Thêm Trường tùy chỉnh từ Tùy chỉnh Biểu mẫu](https://docs.erpnext.com/docs/v16/assets/img/customize/customize-erpnext-custom-field-from-customize-form.gif)
...
1. **Options**: Trường này sẽ xuất hiện khi bạn muốn dữ liệu của mình mang tính cụ thể hoặc chỉ định dữ liệu. Ví dụ: khi bạn đã chọn Loại trường là 'Select Field' (Trường lựa chọn), bạn sẽ cần nhập các tùy chọn lựa chọn tại đây.
  ...
  ![Trường tùy chỉnh với Loại trường là Select](https://docs.erpnext.com/docs/v16/assets/img/customize/custom-field-with-select-fieldtype.png)
...
1. **Depends On**: Bạn có thể xác định một điều kiện tại đây để Trường được hiển thị. Ví dụ: trong DocType Item, hai trường 'Asset Category' (Danh mục tài sản) và 'Asset Naming Series' (Chuỗi đặt tên tài sản) sẽ chỉ xuất hiện nếu Trường 'Is Fixed Asset' (Là tài sản cố định) được tích chọn. Điều kiện phụ thuộc ở đây sẽ là `is_fixed_asset`.
  ...
  ![Tùy chọn Depends On](https://docs.erpnext.com/docs/v16/assets/img/customize/custom-field-dpends-on.png)

1. **Field Description**: Bạn có thể thêm mô tả của Trường tại đây, mô tả này có thể được hiển thị bên dưới Trường này.

   ![Mô tả Trường tùy chỉnh](https://docs.erpnext.com/docs/v16/assets/img/customize/custom-field-description.png)
