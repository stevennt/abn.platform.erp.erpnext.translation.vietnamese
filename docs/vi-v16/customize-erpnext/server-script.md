...
4. Chọn loại server script: **Document Event**, **API**, hoặc **Permission Query**.
...
- Before Save
- After Save
- Before Submit (Xác nhận)
- After Submit (Xác nhận)
- Before Cancel (Hủy)
- After Cancel (Hủy)
- Before Delete
- After Delete
...
### 3.1 Thay đổi giá trị của một thuộc tính trước khi Lưu
