...
<img class="screenshot" alt="Standard fields in Sales Order" src="../assets/img/customize/customize-fetch-data-1.png">

Hóa đơn bán hàng (các trường tùy chỉnh)

<img class="screenshot" alt="Custom Field in Sales Invoice" src="../assets/img/customize/customize-fetch-data-2.png">
...
<img class="screenshot" alt="Values fetching from Sales Order to Sales Invoice" src="../assets/img/customize/customize-fetch-data-3.png">

<img class="screenshot" alt="Values fetching from Sales Order to Sales Invoice" src="../assets/img/customize/customize-fetching-data.gif">
