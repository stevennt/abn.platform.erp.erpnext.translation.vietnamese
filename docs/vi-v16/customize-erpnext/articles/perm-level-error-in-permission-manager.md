...
Trong khi tùy chỉnh các quy tắc trong [Permission Manager](/docs/v16/user/manual/vi/setting-up/users-and-permissions/role-based-permissions), bạn có thể nhận được thông báo lỗi như sau:
...
> (Dịch: Đối với System Manager _(hoặc bất kỳ vai trò nào khác)_ ở cấp độ 2 _(hoặc cấp độ khác)_ trong Khách hàng _(hoặc bất kỳ tài liệu nào khác)_ tại dòng 8: Quyền ở cấp độ 0 phải được thiết lập trước khi thiết lập các cấp độ cao hơn.)
