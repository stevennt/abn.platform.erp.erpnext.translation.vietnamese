...
![Authorization Rule](https://docs.erpnext.com/docs/v16/assets/img/customize/authorization-rule.png)
...
![Authorization Rule](https://docs.erpnext.com/docs/v16/assets/img/customize/new-authorization-rule.png)

Nếu Nhân viên bán hàng cố gắng Xác nhận Đơn bán hàng có giá trị cao hơn 10.000, họ sẽ nhận được thông báo lỗi.

![Authorization Rule Validation Message](https://docs.erpnext.com/docs/v16/assets/img/customize/authorization-rule-validation-message.png)
