...
![Appointment Booking Settings](https://docs.erpnext.com/docs/v16/assets/img/crm/appointment-booking-settings.png)

## 1. Cho phép lập lịch hẹn

Ô đánh dấu này sẽ cho phép lập lịch hẹn và cũng cho phép kích hoạt Route `/book_appointment` cho người dùng website (Khách hàng của bạn). Khách hàng của bạn sẽ thấy một giao diện cổng thông tin. Để biết thêm chi tiết, hãy truy cập [Trang Lịch hẹn](../user/manual/en/CRM/appointment)
...
Bạn có thể liên kết một [danh sách ngày nghỉ](../user/manual/en/human-resources/holiday-list) tại đây để áp dụng cho lịch hẹn. Nếu ngày đó là ngày nghỉ, việc lập lịch hẹn vào ngày đó sẽ không được cho phép.
