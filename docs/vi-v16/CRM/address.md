...
4. Lưu.
    ![Contact](https://docs.erpnext.com/docs/v16/assets/img/crm/address.png)
...
![Add Address From Customer](https://docs.erpnext.com/docs/v16/assets/img/crm/add-address-from-customer.png)

Để Nhập nhiều địa chỉ từ bảng tính, hãy sử dụng [Công cụ Nhập dữ liệu](../user/manual/setting-up/data/data-import).
...
![Link One Address to Multiple Entities](https://docs.erpnext.com/docs/v16/assets/img/crm/link-address-to-multiple-entities.png)
...
![Address Title](https://docs.erpnext.com/docs/v16/assets/img/crm/address-title.png)

### 2.3 Địa chỉ Thanh toán ưu tiên và Địa chỉ Giao hàng ưu tiên

Nếu bạn tích vào 'Preferred Shipping Address', địa chỉ sẽ tự động được thêm vào Địa chỉ giao hàng trong các giao dịch Đơn bán hàng, Hóa đơn và Phiếu giao hàng.

Tương tự, nếu bạn tích vào 'Preferred Billing Address', địa chỉ sẽ tự động được thêm vào Địa chỉ thanh toán trong các giao dịch Đơn bán hàng, Hóa đơn và Phiếu giao hàng.
...
![GST Details in Address](https://docs.erpnext.com/docs/v16/assets/img/crm/gst-details-in-address.png)

Trong các giao dịch bán hàng, cùng với địa chỉ, GSTIN cũng sẽ được lấy ra.

![GST Details in Sales Order](https://docs.erpnext.com/docs/v16/assets/img/crm/gst-details-in-sales-order.png)
...
![Company Address](https://docs.erpnext.com/docs/v16/assets/img/crm/company-address.png)
