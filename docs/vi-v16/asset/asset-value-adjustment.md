...
Trong trường hợp quản lý tài sản cố định, đôi khi giá trị của một tài sản cần được điều chỉnh. Ví dụ, nếu một chiếc máy tính xách tay bị hư hỏng vì lý do nào đó, giá trị của nó sẽ giảm xuống ngay lập tức. Trong trường hợp đó, chúng ta phải điều chỉnh lại giá trị của tài sản.
...
1. [Tài sản](/docs/v16/user/manual/vi/asset/asset)
1. Bật 'Calculate Depreciation' trong biểu mẫu Tài sản

## 2. Cách tạo Điều chỉnh giá trị tài sản

1. Đi tới danh sách Điều chỉnh giá trị tài sản, nhấn vào **Mới**.
...
1. [Khấu hao tài sản](/docs/v16/user/manual/vi/asset/asset-depreciation)
1. [Thanh lý tài sản](/docs/v16/user/manual/vi/asset/scrapping-an-asset)
