...
* [Mặt hàng](/docs/v16/user/manual/en/stock/item) với tùy chọn 'Is Fixed Asset' được bật.
* [Danh mục tài sản](/docs/v16/user/manual/en/asset/asset-category)
...
<img class="screenshot" alt="Asset Item" src="https://docs.erpnext.com/docs/v16/assets/img/asset/asset-item.png">
...
<img class="screenshot" alt="Asset" src="https://docs.erpnext.com/docs/v16/assets/img/asset/asset-auto-create.png">
...
<img class="screenshot" alt="Asset Location in Purchase Receipt" src="https://docs.erpnext.com/docs/v16/assets/img/asset/asset-location-in-purchase-receipt.png">

Một thông báo xác nhận việc tạo tài sản sẽ được hiển thị khi Xác nhận Phiếu nhập hàng.

<img class="screenshot" alt="Asset Creation Confirmation Message" src="https://docs.erpnext.com/docs/v16/assets/img/asset/asset-auto-create-on-purchase.png">
...
<img class="screenshot" alt="Manual Creation of Assets" src="https://docs.erpnext.com/docs/v16/assets/img/asset/asset-manual-creation-message.png">

Thực hiện theo các bước dưới đây để tạo tài sản thủ công.

1. Đi tới danh sách Tài sản, nhấn vào Mới.
2. Nhập tên cho tài sản.
3. Chọn Mã mặt hàng. Tên mặt hàng và Danh mục tài sản sẽ được lấy tự động.
4. Chọn Chủ sở hữu tài sản, tức là Công ty, Nhà cung cấp hoặc Khách hàng.
5. Chọn Công ty/Nhà cung cấp/Khách hàng.
6. Chọn Phiếu nhập hàng/Hóa đơn mua hàng. Ngày mua và Tổng số tiền mua sẽ được lấy tự động.
7. Chọn một Vị trí. Ví dụ: Văn phòng Mumbai. Thông tin này sẽ được lấy tự động nếu được chỉ định trong bảng mặt hàng của Phiếu nhập hàng.
8. Thiết lập Ngày sẵn sàng sử dụng. Khấu hao sẽ được tính bắt đầu từ ngày này.
9. Lưu và Xác nhận.
...
<img class="screenshot" alt="Existing Asset" src="https://docs.erpnext.com/docs/v16/assets/img/asset/existing-asset.png">

Để biết thêm, hãy truy cập trang [Mua một Tài sản](/docs/v16/user/manual/en/asset/purchasing-an-asset).
...
* **Tổng số lần khấu hao**: Tổng số lần khấu hao trong suốt thời gian sử dụng hữu ích của Tài sản. Trong trường hợp tài sản hiện có đã được khấu hao một phần, hãy ghi số lần khấu hao còn lại.