...
1. Bạn cũng có thể bật 'Auto Create Assets on Purchase' để tự động tạo tài sản. (Tùy chọn)
  ...
  <img class="screenshot" alt="Purchasing Asset" src="https://docs.erpnext.com/docs/v16/assets/img/asset/asset-auto-create.png">

1. Sau đó, cần tuân thủ [quy trình mua hàng](../buying/purchase-order) để mua tài sản.
1. Nhập Vị trí tài sản (Asset Location) trong bảng Mặt hàng của [Phiếu nhập hàng](../stock/purchase-receipt) hoặc [Hóa đơn mua hàng](../accounts/purchase-invoice) mà bạn đang dùng để nhận mặt hàng.
...
<img class="screenshot" alt="Purchasing Asset" src="https://docs.erpnext.com/docs/v16/assets/img/asset/asset-auto-create-on-purchase.png">
...
<img class="screenshot" alt="Asset" src="https://docs.erpnext.com/docs/v16/assets/img/asset/asset-purchase-receipt-gl-entries.png">
...
1. [Tài sản](../asset/asset)
1. [Phiếu nhập hàng](../stock/purchase-receipt)
1. [Hóa đơn mua hàng](../accounts/purchase-invoice)
