...
1. Chọn quy tắc phân công.
    ...
    ![Assignment Rule](https://docs.erpnext.com/docs/v16/assets/img/automation/assignment-rule-select.png)
    ...
    * **Load Balancing**: Phân công các chứng từ mới cho Người dùng có số lượng công việc được phân công ít nhất.
        ...
        ![Users in Assignment Rule](https://docs.erpnext.com/docs/v16/assets/img/automation/auto-assign-2.png)

    * **Based on Field**: Quy tắc này có thể được sử dụng để phân công một chứng từ cho Người dùng được thiết lập trong trường đã cấu hình.

        Chọn trường liên kết Người dùng (User link field) để xác định Quy tắc phân công này sẽ áp dụng cho ai:
        ![Field Assign](https://docs.erpnext.com/docs/v16/assets/img/automation/field-auto-assign.png)
...
![Assignment Rule with Higher Priority](https://docs.erpnext.com/docs/v16/assets/img/automation/assignment-rule-with-higher-priority.png)
...
![Due Date Based On](https://docs.erpnext.com/docs/v16/assets/img/automation/assignment-rule-due-date-based-on.png)
...
1. [Workflows](../setting-up/workflows)
1. [Workflow Actions](../setting-up/workflow-actions)
