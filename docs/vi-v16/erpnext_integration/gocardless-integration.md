...
![GoCardless Settings](https://docs.erpnext.com/docs/v16/assets/img/setup/integrations/gocardless_account.png)
...
![GoCardless COA](https://docs.erpnext.com/docs/v16/assets/img/setup/integrations/gocardless_coa.png)
...
![Payment Gateway Account](https://docs.erpnext.com/docs/v16/assets/img/setup/integrations/payment_gateway_account_gocardless.png)
