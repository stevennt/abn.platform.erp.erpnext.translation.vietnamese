...
<img class="screenshot" alt="Menu Section" src="https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/app_menu.png">

2. Nhấp vào **Manage private apps** để tạo private app
<img class="screenshot" alt="Manage Private Apps" src="https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/manage_private_apps.png">

3. Điền đầy đủ thông tin và tạo ứng dụng. Mỗi ứng dụng sẽ có API key, Password và Shared secret riêng
<img class="screenshot" alt="App Details" src="https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/app_details.png">
...
<img class="screenshot" alt="Setup Private App Credentials" src="https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/app_details.png">

2. Thiết lập cấu hình Khách hàng, Công ty và Kho
<img class="screenshot" alt="ERP Configurations" src="https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/erp_configurations.png">
...
<img class="screenshot" alt="Sync Configure" src="https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/sync_config.png">
...
<img class="screenshot" alt="Taxes and Shipping Charges" src="https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/tax_config.png">
...
<img class="screenshot" alt="Sync Order By Date" src="https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/shopify-order-sync-date.png">
...
<img class="screenshot" alt="Shopify Order ID" src="https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/shopify-order-id.png">

<img class="screenshot" alt="Sync Order ID" src="https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/shopify-order-sync-id.png">
