...
<img class="screenshot" alt="Mpesa Credentials" src="https://docs.erpnext.com/docs/v16/assets/img/setup/integrations/mpesa_credentials.png">
...
<img class="screenshot" alt="Mpesa Settings" src="https://docs.erpnext.com/docs/v16/assets/img/setup/integrations/mpesa_settings.png">
...
<img class="screenshot" alt="Mpesa COA" src="https://docs.erpnext.com/docs/v16/assets/img/setup/integrations/mpesa_coa.png">

<img class="screenshot" alt="Mpesa POS Settings" src="https://docs.erpnext.com/docs/v16/assets/img/setup/integrations/mpesa_pos_settings.png">
...
<img class="screenshot" alt="Payment Gateway Account" src="https://docs.erpnext.com/docs/v16/assets/img/setup/integrations/payment_gateway_account_mpesa.png">
...
<img class="screenshot" alt="POS Additional Information" src="https://docs.erpnext.com/docs/v16/assets/img/setup/integrations/additional-information.png">
...
<img class="screenshot" alt="POS Account Balance" src="https://docs.erpnext.com/docs/v16/assets/img/setup/integrations/mpesa_account_balance.png">
