...
<img class="screenshot" alt="Paytm Credentials" src="../assets/img/setup/integrations/paytm_credentials.png">
...
<img class="screenshot" alt="Paytm Settings" src="../assets/img/setup/integrations/paytm_settings.png">
...
<img class="screenshot" alt="Paytm COA" src="../assets/img/setup/integrations/paytm_coa.png">
...
<img class="screenshot" alt="Payment Gateway Account" src="../assets/img/setup/integrations/payment_gateway_account_paytm.png">
