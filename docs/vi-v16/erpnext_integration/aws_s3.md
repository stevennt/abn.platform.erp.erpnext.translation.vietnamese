...
- [Tài khoản Email](../user/manual/en/setting-up/email/email-account)
...
2. Mở Identity and Access Management (IAM).
    ...
    2. Tạo một người dùng (user) mới để truy cập bằng lập trình.
        ...
        ![Screenshot of "Add User" in AWS](https://docs.erpnext.com/docs/v16/assets/img/erpnext_integrations/s3_backup_add_user.png)
...
![S3 Backup Settings in ERPNext](https://docs.erpnext.com/docs/v16/assets/img/erpnext_integrations/s3_backup_settings.png)