...
<img class="screenshot" alt="Menu Section" src="https://docs.erpnext.com/docs/v16/assets/img/erpnext_integrations/app_menu.png">

2. Nhấp vào **Manage private apps** để tạo ứng dụng riêng tư
<img class="screenshot" alt="Manage Private Apps" src="https://docs.erpnext.com/docs/v16/assets/img/erpnext_integrations/manage_private_apps.png">

3. Điền đầy đủ thông tin và tạo ứng dụng. Mỗi ứng dụng sẽ có Mật khẩu (Password) và Mã bí mật chia sẻ (Shared secret) riêng
<img class="screenshot" alt="App Details" src="https://docs.erpnext.com/docs/v16/assets/img/erpnext_integrations/app_details.png">
...
<img class="screenshot" alt="Setup Private App Credentials" src="https://docs.erpnext.com/docs/v16/assets/img/erpnext_integrations/app_details.png">

2. Thiết lập cấu hình Khách hàng, Công ty và Kho hàng
<img class="screenshot" alt="ERP Configurations" src="https://docs.erpnext.com/docs/v16/assets/img/erpnext_integrations/ecommerce_integrations/shopify/main-settings.png">
...
<img class="screenshot" alt="Sync Configure" src="https://docs.erpnext.com/docs/v16/assets/img/erpnext_integrations/ecommerce_integrations/shopify/series-setting.png">
...
<img class="screenshot" alt="Taxes and Shipping Charges" src="https://docs.erpnext.com/docs/v16/assets/img/erpnext_integrations/ecommerce_integrations/shopify/tax-mapping.png">
...
<img class="screenshot" alt="Sync Order By Date" src="https://docs.erpnext.com/docs/v16/assets/img/erpnext_integrations/ecommerce_integrations/shopify/sync-old-orders.png">
...
<img class="screenshot" alt="Inventory Syncing with Shopify" src="https://docs.erpnext.com/docs/v16/assets/img/erpnext_integrations/ecommerce_integrations/shopify/inventory-sync.png">

> Lưu ý: Bộ kết nối này giả định rằng ERPNext là nguồn thông tin chính về mức tồn kho, bất kỳ thay đổi nào được thực hiện đối với