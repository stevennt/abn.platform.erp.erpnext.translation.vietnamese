...
Trình kết nối Amazon sẽ lấy Mặt hàng và Đơn bán hàng từ sàn thương mại điện tử Amazon.
Việc đồng bộ Mặt hàng và Đơn bán hàng được thực hiện tuần tự. Bạn phải đồng bộ Mặt hàng trước khi đồng bộ Đơn bán hàng.
...
<img class="screenshot" alt="Setup Credentials" src="../assets/img/erpnext_integrations/amazon_mws_settings_1.png">
...
<img class="screenshot" alt="ERPNext Configurations" src="../assets/img/erpnext_integrations/amazon_mws_settings_2.png">

#### 3. Thiết lập Cấu hình Đồng bộ
Sử dụng After Date (Ngày sau ngày này), bạn có thể đồng bộ các mặt hàng và đơn hàng được tạo sau một ngày cụ thể. Trong trường hợp bạn đang nhập nhiều dữ liệu lịch sử, bạn nên bắt đầu theo thứ tự thời gian đảo ngược của After Date và nhập dữ liệu thành từng phần nhỏ.
<img class="screenshot" alt="Sync Configurations" src="../assets/img/erpnext_integrations/amazon_mws_settings_3.png">
...
#### 4. Đồng bộ Mặt hàng
Nhấp vào nút này để đồng bộ mặt hàng. Sau khi thành công, bạn sẽ thấy các sản phẩm Amazon của mình dưới dạng Mặt hàng trong ERPNext.

<img class="screenshot" alt="Sync Configurations" src="../assets/img/erpnext_integrations/amazon_mws_settings_4.png">
<img class="screenshot" alt="Sync Configurations" src="../assets/img/erpnext_integrations/amazon_mws_settings_5.png">
...
<img class="screenshot" alt="Sync Configurations" src="../assets/img/erpnext_integrations/amazon_mws_settings_6.png">
