...
Để thiết lập RazorPay, hãy truy cập:

`Explore > Integrations > RazorPay Settings`

<img class="screenshot" alt="Razorpay Settings" src="../assets/img/setup/integrations/razorpay-api.gif">

#### Thiết lập RazorPay

Để kích hoạt dịch vụ thanh toán RazorPay, bạn cần cấu hình các tham số như API Key và API Secret.

<img class="screenshot" alt="Razorpay Settings" src="../assets/img/setup/integrations/razorpay_settings.png">
...
<img class="screenshot" alt="Razorpay COA" src="../assets/img/setup/integrations/razorpay_coa.png">
...
<img class="screenshot" alt="Payment Gateway Account" src="../assets/img/setup/integrations/payment_gateway_account_razorpay.png">
