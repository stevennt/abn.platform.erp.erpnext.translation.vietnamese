...
Việc thêm dịch vụ ERPNext của bạn dưới dạng một client đang được [cung cấp dưới dạng dịch vụ bởi fairkom](https://erp.fairkom.net/cloud/fairlogin-client).

![ERPnext keycloak Settings](https://docs.erpnext.com/docs/v16/assets/img/erpnext_integrations/fairloginKeycloakERPnext.png)
...
![ERPnext fairlogin Settings](https://docs.erpnext.com/docs/v16/assets/img/erpnext_integrations/fairloginERPnextSettings.png)
