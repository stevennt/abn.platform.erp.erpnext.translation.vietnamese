...
- Tạo Thông tin xác thực OAuth 2.0 thông qua [Google Settings](../user/manual/erpnext_integration/google_settings).
...
- Sau khi đã được Ủy quyền (Authorized), bạn có thể đồng bộ hóa Sự kiện Google Calendar một cách thủ công hoặc để ERPNext tự động đồng bộ hàng ngày.
...
- Tạo một Sự kiện trong ERPNext
  <img class="screenshot" src="../assets/img/erpnext_integrations/erpnext-gc.gif">
- Xóa một Sự kiện trong ERPNext
  <img class="screenshot" src="../assets/img/erpnext_integrations/gc-erpnext.gif">
...
- Đồng bộ hóa Sự kiện từ Google Calendar sang ERPNext
  <img class="screenshot" src="../assets/img/erpnext_integrations/gc-sync.gif">