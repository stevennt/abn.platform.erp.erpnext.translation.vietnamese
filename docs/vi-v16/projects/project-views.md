...
![Task - Gantt View](https://docs.erpnext.com/docs/v16/assets/img/project/task-gantt-chart.png)
...
Nếu bạn muốn tùy chỉnh thêm biểu đồ và làm cho nó nhiều màu sắc hơn, hãy đọc [bài viết này](../user/manual/projects/articles/make-a-colorful-gantt-chart)
...
![Task - Kanban View](https://docs.erpnext.com/docs/v16/assets/img/project/task-kanban.png)
...
Đọc [tùy chỉnh bảng Kanban](../user/manual/customize-erpnext/kanban-board) để tìm hiểu thêm.
...
![Task - Calendar View](https://docs.erpnext.com/docs/v16/assets/img/project/task-calendar.png)
