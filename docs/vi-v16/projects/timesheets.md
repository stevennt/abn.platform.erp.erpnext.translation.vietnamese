...
### 1.1. Ngoài ra, một Timesheet cũng có thể được tạo từ một Nhiệm vụ theo cách sau:
  ...
  <img class="screenshot" alt="Timesheet" src="https://docs.erpnext.com/docs/v16/assets/img/project/projects-timesheet-from-task.gif">
...
<img class="screenshot" alt="Timer in Progress" src="https://docs.erpnext.com/docs/v16/assets/img/project/projects-timer-in-timesheet.gif">
...
<img class="screenshot" alt="Timer Exceeded" src="https://docs.erpnext.com/docs/v16/assets/img/project/projects-timer-time-exceed.png">
...
Khi được mở rộng, Timesheet cho phép bạn nhập các chi tiết sau:
   ...
   * **Costing Amount**: Số tiền chi phí được tự động tính toán dựa trên số giờ và đơn giá chi phí.
   ...
   <img class="screenshot" alt="Timesheet" src="https://docs.erpnext.com/docs/v16/assets/img/project/projects-time-sheet-expansion.png">
...
<img class="screenshot" alt="Timesheet" src="https://docs.erpnext.com/docs/v16/assets/img/project/projects-timesheet-billing-details.png">
