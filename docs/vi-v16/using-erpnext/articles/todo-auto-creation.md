...
Mọi Tài liệu trong ERPNext đều có một tùy chọn gọi là 'Assign To' (Giao cho) ở thanh bên. Sử dụng tùy chọn này, bất kỳ Tài liệu nào cũng có thể được giao cho người dùng. Người dùng đó sẽ đồng thời được giao một Việc cần làm (To-Do).

![ToDo Auto Creation](https://docs.erpnext.com/docs/v16/assets/img/using-erpnext/using-todo-auto-assign-1.gif)
...
![ToDo](https://docs.erpnext.com/docs/v16/assets/img/using-erpnext/using-to-do-6.png)