...
Tương tự, đối với Phiếu giao hàng và Hóa đơn dựa trên Đơn bán hàng này, việc giao việc có thể được thực hiện cho một Người dùng Kho và một Người dùng Kế toán.

![Assignment](https://docs.erpnext.com/docs/v16/assets/img/using-erpnext/using-assignment-1.png)
...
![Assignment](https://docs.erpnext.com/docs/v16/assets/img/using-erpnext/using-assignment-2.gif)

Cùng với việc giao việc, bạn cũng có thể để lại một bình luận để người được giao việc xem xét.

![Assignment](https://docs.erpnext.com/docs/v16/assets/img/using-erpnext/using-assignment-3.gif)
...
![Assignment](https://docs.erpnext.com/docs/v16/assets/img/using-erpnext/using-assignment-4.png)

### Hủy giao việc

Người dùng có thể hủy các giao việc bằng cách nhấp vào nút "Closed" trong tài liệu.

![Assignment](https://docs.erpnext.com/docs/v16/assets/img/using-erpnext/using-assignment-5.png)
