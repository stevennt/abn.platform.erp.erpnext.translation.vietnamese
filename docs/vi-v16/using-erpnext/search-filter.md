...
![Search Filter](https://docs.erpnext.com/docs/v16/assets/img/using-erpnext/using-search-filer-1.png)
...
![Search Filter](https://docs.erpnext.com/docs/v16/assets/img/using-erpnext/using-search-filter-2.png)
...
![Search Filter](https://docs.erpnext.com/docs/v16/assets/img/using-erpnext/using-search-filter-3.png)
...
![Search Filter](https://docs.erpnext.com/docs/v16/assets/img/using-erpnext/using-search-filter.gif)
...
![Search Filter](https://docs.erpnext.com/docs/v16/assets/img/using-erpnext/using-search-filter-4.png)
