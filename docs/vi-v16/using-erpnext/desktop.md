...
- **Domains**: Đây là nơi bạn có thể tìm thấy tất cả các module chuyên biệt theo lĩnh vực như Giáo dục (Education) và Sản xuất (Manufacturing). Bạn có thể tìm hiểu thêm về tất cả các module chuyên biệt theo ngành tại [đây](./user/manual/industry-specific-modules.md).
