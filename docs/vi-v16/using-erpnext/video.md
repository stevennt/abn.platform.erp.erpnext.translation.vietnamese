...
![Video](https://docs.erpnext.com/docs/v16/assets/img/education/video-after-save.png)

Bạn cũng có thể xem Video ngay trong chính Tài liệu sau khi lưu nó.
![Video](https://docs.erpnext.com/docs/v16/assets/img/education/video-watch.gif)
...
![Video](https://docs.erpnext.com/docs/v16/assets/img/education/video-settings.png)
...
![Video](https://docs.erpnext.com/docs/v16/assets/img/education/video-stats.png)
...
![Video](https://docs.erpnext.com/docs/v16/assets/img/education/youtube-interactions.png)

> **Lưu ý** : Hạn ngạch cho số lượng yêu cầu **không tính phí** tới YouTube Data API là 10.000 yêu cầu. ERPNext tự động cập nhật lên đến 50 video trong 1 yêu cầu. Tương tự, đối với 100 video sẽ mất 2 yêu cầu.<br>
