...
![Tree Master Renaming](https://docs.erpnext.com/docs/v16/assets/img/using-erpnext/using-global-search-2.gif)
...
![Tree Master Renaming](https://docs.erpnext.com/docs/v16/assets/img/using-erpnext/using-global-search-1.gif)