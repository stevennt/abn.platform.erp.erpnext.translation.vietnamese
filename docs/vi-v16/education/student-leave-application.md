...
7. Lưu. 'Tổng số ngày nghỉ' sẽ được tính toán và thiết lập trong tài liệu sau khi loại trừ các ngày lễ nằm trong [Danh sách ngày lễ](/docs/v16/user/manual/en/human-resources/holiday-list) mặc định của bạn.
    ...
    ![Student Leave Application](https://docs.erpnext.com/docs/v16/assets/img/education/student-leave-application.png)
...
![Student Attendance](https://docs.erpnext.com/docs/v16/assets/img/education/leave-attendance-record.png)
