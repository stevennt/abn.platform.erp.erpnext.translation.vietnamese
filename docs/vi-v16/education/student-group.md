...
![Student Group](https://docs.erpnext.com/docs/v16/assets/img/education/education-student-workflow.png)
...
1. [Program Enrollment](../program-enrollment.md)
1. [Student Batch name](../student-batch-name.md)
1. [Student Category](../student-category.md)
...
![Student Group](https://docs.erpnext.com/docs/v16/assets/img/education/education-student-group-1)
...
1. **Max Strength**: Nhập Số lượng học sinh tối đa có thể tham gia Nhóm học sinh này. Nếu số lượng học sinh được chọn trong nhóm nhiều hơn Max Strength, hệ thống sẽ không cho phép bạn Lưu nhóm này và một thông báo lỗi sẽ hiển thị.
    ...
    ![Student Group](https://docs.erpnext.com/docs/v16/assets/img/education/education-student-group-max-student-limit-error.png)
...
![Student Group](https://docs.erpnext.com/docs/v16/assets/img/education/education-student-group-4.png)

## 3. Sau khi tạo Nhóm học sinh

Sau khi nhóm học sinh đã được tạo và Lưu, các mục sau có thể được tạo từ Nhóm học sinh:

1. **Attendance**: Bạn sẽ được chuyển hướng đến [Student Attendance Tool](../student-attendance-tool.md), qua đó bạn có thể điểm danh cho tất cả học sinh vào một ngày cụ thể.
1. **Course Schedule**: Bạn sẽ được chuyển hướng đến [Course Schedule](../course-schedule.md), tại đây bạn có thể xem lịch trình cho nhóm học sinh này và sau đó bạn cũng có thể tạo Lịch học mới cho các học sinh trong nhóm này.
...
1. **Update Email Group**: Khi bạn chọn tùy chọn này, các Địa chỉ Email của Học sinh trong nhóm này sẽ được thêm vào Nhóm Email và bạn sẽ có thể gửi bản tin cho tất cả những người đăng ký trong Nhóm học sinh này.
    ...
    ![Student Group](https://docs.erpnext.com/docs/v16/assets/img/education/education-student-group-update-email.png)
