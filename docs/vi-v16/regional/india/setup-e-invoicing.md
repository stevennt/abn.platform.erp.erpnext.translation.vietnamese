...
![Generate IRN in Invoice](https://docs.erpnext.com/docs/v16/assets/img/regional/india/generate-irn-in-invoice.png)
...
![IRN in Invoice](https://docs.erpnext.com/docs/v16/assets/img/regional/india/irn-in-invoice.png)
...
![E Invoice Print Format](https://docs.erpnext.com/docs/v16/assets/img/regional/india/einv-print-format.png)
...
![E Invoice Cancel IRN Button](https://docs.erpnext.com/docs/v16/assets/img/regional/india/einv-cancel-irn-button.png)

Sau khi bạn hủy IRN, hóa đơn sẽ trông giống như thế này.

![E Invoice WIth IRN Cancelled](https://docs.erpnext.com/docs/v16/assets/img/regional/india/einv-cancelled-irn.png)
...
![E Invoice Generate Eway Bill](https://docs.erpnext.com/docs/v16/assets/img/regional/india/einv-generate-ewaybill-button.png)

Bạn sẽ thấy một cửa sổ bật lên với thông tin liên quan trước khi gửi:
![E Way Bill Dialog](https://docs.erpnext.com/docs/v16/assets/img/regional/india/einv-gen-ewaybill-dialog.png)
...
![Cancel E-way Bill](https://docs.erpnext.com/docs/v16/assets/img/regional/india/einv-cancel-ewaybill-button.png)

<img class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/regional/india/einv_cancelled_ewaybill.png">
