...
![GSTIN in Customer](https://docs.erpnext.com/docs/v16/assets/img/regional/india/gstin-customer.gif)
...
![GST in Company](https://docs.erpnext.com/docs/v16/assets/img/regional/india/gstin-company.gif)
...
![GST in Address Template](https://docs.erpnext.com/docs/v16/assets/img/regional/india/address-template-gstin.png)
...
![HSN in Item](https://docs.erpnext.com/docs/v16/assets/img/regional/india/hsn-item.gif)
...
![GST Ledgers](https://docs.erpnext.com/docs/v16/assets/img/regional/india/gst-ledger.png)
...
![GST Settings](https://docs.erpnext.com/docs/v16/assets/img/regional/india/gst-settings.png)
...
![GST Tax Template](https://docs.erpnext.com/docs/v16/assets/img/regional/india/gst-tax-template.png)
...
![GST Invoice](https://docs.erpnext.com/docs/v16/assets/img/regional/india/gst-invoice.gif)
...
![Sample GST Tax Invoice](https://docs.erpnext.com/docs/v16/assets/img/regional/india/sample-gst-tax-invoice.png)
...
![Reversal of Input Tax Credit](https://docs.erpnext.com/docs/v16/assets/img/regional/india/reversal-of-itc.png)
...
![GST Reverse Charge Settings](https://docs.erpnext.com/docs/v16/assets/img/regional/india/gst-reverse-charge-setting.png)
...
![Reverse Charge](https://docs.erpnext.com/docs/v16/assets/img/regional/india/reverse-charge-add.png)

* "Khấu trừ" cùng một số tiền thuế đó bằng cách sử dụng các tài khoản thuế suất đảo ngược để số thuế GST thực tế phải trả.