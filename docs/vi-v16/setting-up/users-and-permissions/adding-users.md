...
1. Lưu.
    ...
    <img class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/users-and-permissions/add-user-details.png" alt="Add User Details">
...
<img class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/setup/users/user-2.png" alt="User Roles">
...
<img class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/setup/users/user-3.png" alt="User Block Module">
...
<img class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/setup/users/module-profile.png" alt="Module Profile">
