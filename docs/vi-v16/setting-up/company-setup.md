...
![Company Master](https://docs.erpnext.com/docs/v16/assets/img/accounts/company-master.png)
...
<img class="screenshot" alt="Company Tree" src="https://docs.erpnext.com/docs/v16/assets/img/accounts/company-tree.png">
...
Đối với mỗi Công ty, master cho Hệ thống tài khoản được duy trì riêng biệt. Điều này cho phép bạn duy trì kế toán riêng biệt cho từng công ty theo các yêu cầu pháp lý. Bạn cũng có thể nhập hệ thống tài khoản bằng cách sử dụng [Charts Of Accounts Importer](../user/manual/setting-up/chart-of-accounts-importer).
...
<img class="screenshot" alt="Company Chart of Accounts" src="https://docs.erpnext.com/docs/v16/assets/img/accounts/new-company-coa-based-on.png">
...
Thiết lập con số mục tiêu doanh số hàng tháng bằng tiền tệ của công ty, ví dụ: $10,000. Tổng doanh số hàng tháng sẽ hiển thị sau khi các giao dịch được thực hiện. Để biết thêm [nhấp vào đây](../user/manual/setting-up/setting-company-sales-goal).

### 2.2 Cài đặt Tài khoản
Một số tài khoản sau đây sẽ được thiết lập mặc định khi bạn tạo một công ty mới, những tài khoản khác có thể được tạo thêm. Các tài khoản có thể được xem trong [Hệ thống tài khoản](../user/manual/accounts/chart-of-accounts). Các giá trị này có thể được thay đổi sau nếu cần.
...
* Default Expense Claim Payable Account (Tài khoản phải trả yêu cầu thanh toán mặc định)