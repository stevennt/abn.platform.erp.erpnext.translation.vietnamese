...
[Setup](/docs/v16/user/manual/en/setting-up/personal-data-deletion-request) > [Xóa dữ liệu cá nhân
...
1. Để bắt đầu xóa dữ liệu nhận dạng cá nhân, bạn cần truy cập [host-name]/request-to-delete-data (ví dụ: example.erpnext.com/request-to-delete-data) vào trường URL.
    ...
    <img class="screenshot" alt="Request Data Webform" src="../assets/img/setup/personal-data-deletion-request/request-to-delete-data-webform.png">

2. Nhập email liên kết với tài khoản ERPNext của bạn. Sau khi gửi yêu cầu, bạn sẽ nhận được phản hồi thành công.

    <img class="screenshot" alt="Deletion Request Success" src="../assets/img/setup/personal-data-deletion-request/deletion-request-success.png">

3. Thao tác này sẽ gửi một email có chứa liên kết xác nhận để xóa dữ liệu đến địa chỉ email liên kết với người dùng.

    <img class="screenshot" alt="Verification Email" src="../assets/img/setup/personal-data-deletion-request/verification-email.png">

4. Sau khi người dùng nhấp vào liên kết xác nhận, một thông báo xác nhận sẽ được hiển thị.
    <img class="screenshot" alt="Confirmed Verification" src="../assets/img/setup/personal-data-deletion-request/confirmed-verification.png">
...
<img class="screenshot" alt="Personal Data Download Request Doctype" src="../assets/img/setup/personal-data-deletion-request/personal-data-deletion-request-doctype.png">
...
<img class="screenshot" alt="Pending Verification" src="../assets/img/setup/personal-data-deletion-request/pending-verification.png">
...
<img class="screenshot" alt="Pending Approval" src="../assets/img/setup/personal-data-deletion-request/pending-approval.png">
...
<img class="screenshot" alt="Deleted User" src="../assets/img/setup/personal-data-deletion-request/deleted-user.png">

### 3. Các chủ đề liên quan
1. [Personal Data Download](../user/manual/en/setting-up/personal-data-download)