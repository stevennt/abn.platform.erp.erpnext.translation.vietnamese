...
<img class="screenshot" alt="Send Email" src="https://docs.erpnext.com/docs/v16/assets/img/setup/email/send-email.gif">
...
![Email Queue](https://docs.erpnext.com/docs/v16/assets/img/setup/email/email-queue.png)
...
![Email Print Options](https://docs.erpnext.com/docs/v16/assets/img/setup/email/email-print-options.png)
