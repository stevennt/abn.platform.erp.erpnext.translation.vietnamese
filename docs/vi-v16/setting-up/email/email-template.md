...
Bạn có thể thiết lập Mẫu Email Mặc định cho mỗi loại tài liệu thông qua [Tùy chỉnh Biểu mẫu](../user/manual/vi/customize-erpnext/customize-form).

### 1.2 Cách lấy tên trường (fieldnames)
Các tên trường mà bạn có thể sử dụng trong mẫu email của mình là các trường trong tài liệu mà bạn đang gửi email. Bạn có thể tìm thấy các trường của bất kỳ tài liệu nào thông qua [Tùy chỉnh Biểu mẫu](../user/manual/vi/customize-erpnext/customize-form) và chọn loại tài liệu (ví dụ: Đơn bán hàng).
...
1. [Tài khoản Email](../user/manual/vi/setting-up/email/email-account)
1. [Hộp thư Email](../user/manual/vi/setting-up/email/email-inbox)