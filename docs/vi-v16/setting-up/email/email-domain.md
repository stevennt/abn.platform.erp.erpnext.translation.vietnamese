...
Bạn có thể bỏ qua bước này và chuyển thẳng đến phần tạo [Tài khoản Email](../setting-up/email/email-account) nếu bạn đang sử dụng một trong các dịch vụ được liệt kê [tại đây](../setting-up/email/email-inbox#2-create-an-email-domain).
...
![Email domain in email account](https://docs.erpnext.com/docs/v16/assets/img/setup/email/email-domain1.png)
...
1. [Hộp thư Email](../setting-up/email/email-inbox)