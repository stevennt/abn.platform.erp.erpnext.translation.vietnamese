...
Trước khi tạo một Tài khoản Email, bạn cần có một [Email Domain](/docs/v16/user/manual/en/setting-up/email/email-domain). Tuy nhiên, bạn có thể bỏ qua bước tạo Email Domain nếu bạn đang sử dụng một trong các dịch vụ được liệt kê [tại đây](/docs/v16/user/manual/en/setting-up/email/email-inbox#2-create-an-email-domain).

## 2. Cách tạo Tài khoản Email
1. Đi tới danh sách Email Account, nhấn vào New.
1. Nhập địa chỉ email kèm theo tên miền. [Domains](/docs/v16/user/manual/en/setting-up/email/email-domain) cần phải được tạo để có thể tạo tài khoản email.
    Bạn không cần tạo domain nếu bạn đang đồng bộ hóa email từ một số nhà cung cấp nhất định được liệt kê [tại đây](/docs/v16/user/manual/en/setting-up/email/email-inbox#2-create-an-email-domain).
...
<img class="screenshot" alt="Defining Criteria" src="https://docs.erpnext.com/docs/v16/assets/img/setup/email/email-account-list.png">
...
<img class="screenshot" alt="Incoming EMail" src="https://docs.erpnext.com/docs/v16/assets/img/setup/email/email-account-incoming.png">
...
Kích hoạt Automatic Linking trong Documents sẽ liên kết email với các tài liệu, để biết thêm chi tiết [nhấn vào đây](/docs/v16/user/manual/en/setting-up/email/linking-emails-to-document).
...
<img class="screenshot" alt="Incoming EMail" src="https://docs.erpnext.com/docs/v16/assets/img/setup/email/email-account-unreplied.png">
...
<img class="screenshot" alt="Incoming EMail Conditions" src="https://docs.erpnext.com/docs/v16/assets/img/setup/email/email-account-incoming-conditions.png">
...
<img class="screenshot" alt="Outgoing EMail" src="https://docs.erpnext.com/docs/v16/assets/img/setup/email/email-account-outgoing.png">