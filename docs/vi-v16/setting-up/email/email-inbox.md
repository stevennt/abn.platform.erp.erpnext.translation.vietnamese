...
Để biết cách thêm Người dùng mới, hãy đi đến [trang Người dùng](../setting-up/users-and-permissions/adding-users).

## 2. Tạo Tên miền Email

Tên miền Email cho các Dịch vụ sau đã có sẵn sẵn dùng và bạn có thể tiến hành trực tiếp để tạo [Tài khoản Email](../setting-up/email/email-account). Tìm hiểu thêm về cách tạo Tên miền Email [tại đây](../setting-up/email/email-domain).
...
Tìm hiểu thêm về Tên miền Email [tại đây](../setting-up/email/email-domain). Sau khi bạn đã cấu hình Tên miền Email cho Dịch vụ Email của mình, nó sẽ được sử dụng để tạo các Tài khoản Email cho tất cả Người dùng trong tài khoản ERPNext của bạn.
...
Đọc [tài liệu về Tài khoản Email](../setting-up/email/email-account) để biết thêm chi tiết về cách thiết lập.
...
1. [Tài khoản Email](../setting-up/email/email-account)
1. [Gửi Email](../setting-up/email/sending-email)
1. [Tên miền Email](../setting-up/email/email-domain)