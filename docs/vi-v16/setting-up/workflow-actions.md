...
**Hành động Quy trình là nơi duy nhất để quản lý tất cả các hành động đang chờ xử lý mà bạn có thể thực hiện đối với các Quy trình.**
...
![Workflow Action Email](https://docs.erpnext.com/docs/v16/assets/img/setup/workflow-actions-email.png)

Ngoài ra, người dùng sẽ thấy các mục nhập trong danh sách Hành động Quy trình của họ:
![Workflow Action List](https://docs.erpnext.com/docs/v16/assets/img/setup/workflow-actions-list.png)
...
1. [Workflows](../user/manual/en/setting-up/workflows)
1. [Assignment Rule](../user/manual/en/automation/assignment-rule)
