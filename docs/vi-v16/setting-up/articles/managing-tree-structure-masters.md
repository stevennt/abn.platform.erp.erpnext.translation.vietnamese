...
<img alt="Default Territories" class="screenshot" src="../assets/img/articles/territory-2.png">
...
<img alt="Default Territories" class="screenshot" src="../assets/img/articles/territory-1.gif">

Sau đây là cách các Khu vực con sẽ được liệt kê dưới một Khu vực Cha.

<img alt="Adding new Territories" class="screenshot" src="../assets/img/articles/territory-3.png">
