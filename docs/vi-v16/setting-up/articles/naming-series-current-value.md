...
<img alt="Update Series Section" class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/articles/current-no-1.png">

#### Chọn Tiền tố

Xét tình huống của chúng ta, tiền tố cho Đơn bán hàng sẽ là "SO".

<img alt="Series Prefix" class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/articles/current-no-2.png">

#### Giá trị hiện tại

Nếu hiện tại bạn có 322 Đơn bán hàng đã được tạo trong tài khoản của mình, thì giá trị hiện tại được cập nhật sẽ là 322. Bạn có thể chỉnh sửa Giá trị hiện tại thành 322, sau đó nhấp vào Update Series Number.

<img alt="Series Current Value" class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/articles/current-no-3.png">
...
3. Kiểm tra phần B của Update Series
4. Chọn Tiền tố cho ToDo là "TDI"
5. Đảm bảo rằng số cao nhất cho ToDo đã được cập nhật làm Giá trị hiện tại trong Naming Series. Nếu chưa, hãy sửa lại Giá trị hiện tại, và nhấp vào "Update Series Numbering".