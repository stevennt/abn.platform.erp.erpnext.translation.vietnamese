...
Cấp độ Quyền (viết tắt của Permission Level) cho một trường có thể được xác định trong [Tùy chỉnh Form](../user/manual/en/customize-erpnext/customize-form.md).

<img alt="Perm Level Field" class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/articles/perm-level-1.gif">
...
Đối với tất cả các trường liên quan mà bạn không muốn cho xem, bạn có thể đặt Cấp độ Quyền là (ví dụ) 2.
...
<img alt="Perm Level Rule" class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/articles/perm-level-2.png">
...
<img alt="Perm Level Rule 2" class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/articles/perm-level-3.png">
