...
<img alt="Report Permission Error" class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/articles/report-permission-1.png">
...
3. Để giải quyết vấn đề này, hãy gán quyền Read cho Account User đối với Territory master thông qua Role Permissions Manager.
    ...
    <img alt="Permission Manager" class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/articles/report-permission-2.png">
