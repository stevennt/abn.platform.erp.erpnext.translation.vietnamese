...
* **Phương thức xác thực OTP** (OTP App = TOTP sử dụng ứng dụng Token hoặc Token phần cứng, trong khi Email/SMS = HOTP sử dụng Email hoặc SMS).
* **Thời gian hết hạn của Mã QR** trên máy chủ nếu chọn OTP App.
* **Tên nhà phát hành OTP** (OTP Issuer Name).

<img alt="Enable Two Factor Auth" class="screenshot" src="../assets/img/articles/twofactor/twofactor-1.png">
...
<img alt="Role Enable Two Factor Auth" class="screenshot" src="../assets/img/articles/twofactor/twofactor-2.png">

Nếu sử dụng xác thực qua SMS, vui lòng đảm bảo rằng các cài đặt SMS của bạn đã được cập nhật.

<img alt="SMS Settings" class="screenshot" src="../assets/img/articles/twofactor/twofactor-3.png">

Nếu sử dụng Email, hãy đảm bảo rằng các cài đặt tài khoản Email gửi đi của bạn đã được cập nhật.

<img alt="Email Settings" class="screenshot" src="../assets/img/articles/twofactor/twofactor-4.png">
...
<img alt="Email Notify Two Factor" class="screenshot" src="../assets/img/articles/twofactor/twofactor-5.png">
<img alt="QR Code Page" class="screenshot" src="../assets/img/articles/twofactor/twofactor-6.png">
...
<img alt="Two Factor Scan App" class="screenshot" src="../assets/img/articles/twofactor/twofactor_app.jpeg">

Nếu sử dụng Email hoặc SMS làm phương thức xác thực, bạn cũng sẽ nhận được các thông báo.

<img alt="Email and SMS" class="screenshot" src="../assets/img/articles/twofactor/twofactor-8.png">