...
<img alt="Start Import" class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/setup/data-import/task-menu-import.png">
...
![Download Template](https://docs.erpnext.com/docs/v16/assets/img/setup/data-import/download-template.gif)

### 1.2 Nhập dữ liệu vào Mẫu

Mẫu bạn tải xuống sẽ trông giống như thế này:

![Blank Template](https://docs.erpnext.com/docs/v16/assets/img/setup/data-import/blank-template-file.png)
...
![Customer Template with Data](https://docs.erpnext.com/docs/v16/assets/img/setup/data-import/customer-template-with-data.png)
...
![Upload Template File](https://docs.erpnext.com/docs/v16/assets/img/setup/data-import/upload-template-file.png)
...
![Import Warnings](https://docs.erpnext.com/docs/v16/assets/img/setup/data-import/import-warnings.png)
...
![Import Success](https://docs.erpnext.com/docs/v16/assets/img/setup/data-import/import-success.png)
...
![Customer Template for Update](https://docs.erpnext.com/docs/v16/assets/img/setup/data-import/customer-template-for-update.png)
...
![Child Table Export](https://docs.erpnext.com/docs/v16/assets/img/setup/data-import/child-table-export.png)
