...
2. Xác định các sự kiện bạn muốn theo dõi trong mục Send Alert On. Các sự kiện bao gồm:
    ...
    3. Days Before/Days After: Kích hoạt cảnh báo này vài ngày trước hoặc sau **Ngày tham chiếu (Reference Date).** Để thiết lập số ngày, hãy đặt **Days Before or After**. Điều này hữu ích trong việc nhắc nhở về các hạn chót sắp tới hoặc nhắc nhở bạn theo dõi một số Khách hàng tiềm năng hoặc Báo giá nhất định.
    4. Value Change: Khi một giá trị cụ thể trong loại đã chọn thay đổi.
    5. Method: Gửi thông báo khi một phương thức cụ thể được kích hoạt. Ví dụ: `before_insert`.
    6. Custom: Gửi thông báo đến một [Tài khoản Email](../user/manual/setting-up/email/email-account) đã chọn.
...
<img class="screenshot" alt="Setting Subject" src="../assets/img/setup/notifications/email-alert-subject.png">
...
<img class="screenshot" alt="Setting Condition" src="../assets/img/setup/notifications/email-alert-condition.png">
...
Bạn có thể sử dụng cả Thẻ Jinja (`{% raw %}{{ doc.[field_name] }}{% endraw %}`) và các thẻ HTML trong ô soạn thảo tin nhắn.
    ...
    <ul>
    <li>Khách hàng: {{ doc.customer }}</li>
    <li>Số tiền: {{ doc.total_amount }}</li>
    </ul>{% endraw %}
...
<img class="screenshot" alt="Setting Property in Notification" src="../assets/img/setup/notifications/email-alert-subject.png">

### 1.5 Ví dụ

1. Định nghĩa Tiêu chí
    <img class="screenshot" alt="Defining Criteria" src="../assets/img/setup/notifications/email-alert-1.png">

2. Thiết lập Người nhận và Tin nhắn
    <img class="screenshot" alt="Set Message" src="../assets/img/setup/notifications/email-alert-2.png">
...
2. Nhấp vào "Create a Slack App".
    <img class="screenshot" alt="Set Message" src="../assets/img/setup/notifications/slack_notification_1.png">
...
3. Đặt tên cho Ứng dụng của bạn và chọn không gian làm việc (workspace) phù hợp.
    ...
    <img class="screenshot" alt="Set Message" src="../assets/img/setup/notifications/slack_notification_2.png">
...
4. Sao chép liên kết đã tạo, quay lại ERPNext và sử dụng nó để tạo một Slack Webhook URL mới trong Integrations > Slack Webhook URL.
    <img class="screenshot" alt="Set Message" src="../assets/img/setup/notifications/slack_notification_3.png">
...
Không giống như tin nhắn Email, tin nhắn Slack sử dụng định dạng Markdown để hiển thị văn bản.