...
Sau khi một Quy trình công việc được tạo, bạn có thể thực hiện các hành động trên đó thông qua [Workflow Actions](../setting-up/workflow-actions).

## 1. Điều kiện tiên quyết
Trước khi tạo một Quy trình công việc, bạn nên tạo các thành phần này trước:

* [Workflow Actions](../setting-up/workflow-actions)
...
Trong ERPNext v16, bạn có thể sử dụng các hàm ngày/giờ (date/time), session, get_value và get_list trong các biểu thức điều kiện của mình.
