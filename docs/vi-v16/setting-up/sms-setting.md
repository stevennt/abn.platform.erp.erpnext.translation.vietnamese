...
<img class="screenshot" alt="SMS Setting 2" src="../assets/img/setup/sms-settings2.jpg">
...
<img class="screenshot" alt="SMS Setting" src="../assets/img/setup/sms-settings1.png">

### Các chủ đề liên quan
1. [Tài khoản Email](../user/manual/setting-up/email/email-account)
1. [Thông báo](../user/manual/setting-up/notifications)