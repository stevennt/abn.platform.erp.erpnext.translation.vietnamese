...
<img class="screenshot" alt="Print Settings" src="https://docs.erpnext.com/docs/v16/assets/img/setup/print/print-settings.png">
...
![Incompact Print Format Settings](https://docs.erpnext.com/docs/v16/assets/img/setup/print/incompact-print.png)

Đây là giao diện của Mẫu in Thu gọn:
![Compact Print Format Settings](https://docs.erpnext.com/docs/v16/assets/img/setup/print/compact-print.png)
...
Bạn có thể bật in thô và in tới nhiều loại máy in nhiệt được hỗ trợ. Đọc [In thô](../setting-up/print/raw-printing) để biết thêm chi tiết.

## 5. Các chủ đề liên quan
1. [Mẫu in](../setting-up/print/print-format)
1. [Kiểu in](../setting-up/print/print-style)
1. [Tiêu đề in](../setting-up/print/print-headings)
1. [Dịch tùy chỉnh](../setting-up/print/custom-translations)