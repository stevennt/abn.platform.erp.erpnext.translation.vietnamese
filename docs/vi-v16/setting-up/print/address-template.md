...
**Mẫu địa chỉ cho phép lưu trữ các định dạng địa chỉ khác nhau dựa trên khu vực.**

Mỗi khu vực có cách xác định địa chỉ riêng. Để quản lý nhiều định dạng địa chỉ cho các Chứng từ của bạn (như Báo giá, Hóa đơn, v.v.), bạn có thể tạo các **Mẫu địa chỉ** theo từng quốc gia.
...
Công cụ tạo mẫu dựa trên HTML và hệ thống [Jinja Templating](../jinja_templating.md). Tất cả các trường (bao gồm cả Trường tùy chỉnh) sẽ có sẵn để tạo mẫu.
...
1. [Mẫu Điều khoản và Điều kiện](../setting-up/print/terms-and-conditions.md)
1. [Mẫu in Séc](../setting-up/print/cheque-print-template.md)