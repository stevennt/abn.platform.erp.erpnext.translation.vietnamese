...
* Sử dụng [Print Format Builder](/docs/v16/user/manual/setting-up/print/print-format-builder) để tạo các mẫu in bằng giao diện người dùng (UI)
...
Để thiết kế Mẫu in bằng Jinja/JS tùy chỉnh, hãy nhấp vào Custom Format. Nếu bạn chọn tùy chọn này, sẽ có một ô đánh dấu cho việc in thô (raw printing). Để biết thêm về in thô, [nhấp vào đây](/docs/v16/user/manual/setting-up/print/raw-printing).
...
1. [Print Style](/docs/v16/user/manual/setting-up/print/print-style)
1. [Print Headings](/docs/v16/user/manual/setting-up/print/print-headings)
1. [Letter Head](/docs/v16/user/manual/setting-up/print/letter-head)
1. [Cheque Print Template](/docs/v16/user/manual/setting-up/print/cheque-print-template)
1. [Disabling Line Breaks in Print Format Sections](/docs/v16/user/manual/setting-up/articles/print-format-sections)