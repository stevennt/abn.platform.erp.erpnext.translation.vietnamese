...
Bạn có thể có nhiều chuỗi cho tất cả các giao dịch của mình. Ví dụ, các ID Hóa đơn có thể được tạo ra như sau:
...
2. Chỉnh sửa chuỗi theo yêu cầu với các tiền tố duy nhất cho mỗi chuỗi.
   ...
   ![Multiple naming series](https://docs.erpnext.com/docs/v16/assets/img/setup/settings/multiple-naming-series.gif)
...
4. Bạn cũng có thể cập nhật điểm bắt đầu của một chuỗi bằng cách nhập tên chuỗi và điểm bắt đầu trong phần “Update Series”.

5. Nhấp vào nút Update để cập nhật bộ Chuỗi đặt tên cho tài liệu đã chọn.
...
Như bạn có thể thấy, trong ảnh chụp màn hình sau của một Hóa đơn, năm 2019 được liệt kê:

![Fiscal year in Naming Series](https://docs.erpnext.com/docs/v16/assets/img/setup/settings/year-naming-series.png)
...
2. Giá trị hiện tại sẽ được truy xuất và hiển thị.
3. Thay đổi số thứ tự bắt đầu/hiện tại nếu cần.
4. Nhấp vào Update Series Number.
...
Để biết thêm về điều này, [truy cập bài viết này](../user/manual/setting-up/articles/naming-series-current-value).
...
1. Một trường tùy chỉnh "Vendor ID" được tạo trong DocType: Nhà cung cấp (Supplier).
2. Sau đó trong Naming Series, chúng ta cho phép thứ gì đó như:
   `PO-.YY.MM.-.vendor_id.-.####`
...
1. [Bulk Rename](../user/manual/setting-up/settings/bulk-rename)