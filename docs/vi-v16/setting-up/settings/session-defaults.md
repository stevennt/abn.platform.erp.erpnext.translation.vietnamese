...
4. Lưu.
    ...
    <img class="screenshot" alt="Session Defaults Settings" src="../assets/img/setup/settings/session-defaults-settings.png">
...
1. Nhấp vào menu 'Cài đặt' (Settings) trên thanh công cụ. Bạn sẽ tìm thấy tùy chọn 'Thiết lập mặc định của phiên' (Session Defaults) tại đó. Nhấp vào nó.
    ...
    <img class="screenshot" alt="Session Defaults Menu" src="../assets/img/setup/settings/session-defaults-menu.png">
...
2. Một thông báo 'Thiết lập mặc định của phiên' (Session Defaults) sẽ xuất hiện. Hãy thiết lập các giá trị mặc định cho các trường tương ứng và Lưu.
    ...
    <img class="screenshot" alt="Session Defaults Prompt" src="../assets/img/setup/settings/session-defaults-prompt.png">
...
<img class="screenshot" alt="Session Defaults Set" src="../assets/img/setup/settings/session-defaults-set-1.png">

Mở một Công việc (Task) mới. Trường 'Dự án' (Project) đã được thiết lập theo Dự án mặc định.

<img class="screenshot" alt="Session Default Set" src="../assets/img/setup/settings/session-defaults-set-2.png">

Mở một báo cáo, ví dụ: Sổ cái (General Ledger). Bộ lọc Công ty đã được thiết lập theo Công ty mặc định.

<img class="screenshot" alt="Session Default " src="../assets/img/setup/settings/session-defaults-set-3.png">
...
<img class="screenshot" alt="Session Defaults Prompt" src="../assets/img/setup/settings/settings-button.png">

## 3. Các chủ đề liên quan
1. [Thiết lập mặc định toàn cầu (Global Defaults)](/docs/v16/user/manual/en/setting-up/settings/global-defaults)
1. [Cài đặt hệ thống (System Settings)](/docs/v16/user/manual/en/setting-up/settings/system-settings)