...
Trước khi tạo một khoản Quyên góp, trước tiên bạn cần tạo một [Nhà tài trợ](../non_profit/donor).
...
<img class="screenshot" alt="Donation" src="https://docs.erpnext.com/docs/v16/assets/img/non_profit/donation.png">
...
Bạn có thể thiết lập RazorPay để thu tiền quyên góp. Bạn có thể tìm thấy hướng dẫn thiết lập razorpay [tại đây](../erpnext_integration/razorpay-integration).
...
Bạn có thể tìm thấy hướng dẫn thiết lập razorpay [tại đây](../erpnext_integration/razorpay-integration).

Để thu tiền quyên góp, bạn cần thiết lập một số giá trị mặc định trong phần Cài đặt Phi lợi nhuận (Non Profit Settings) trong [Non Profit Settings](../non_profit/non_profit_settings)
...
<img class="screenshot" alt="Donation Settings" src="https://docs.erpnext.com/docs/v16/assets/img/non_profit/donation-settings.png">

#### 3.2.2 Thiết lập webhook

Bạn có thể thiết lập một webhook từ bảng điều khiển RazorPay trong phần Cài đặt. Bạn có thể đọc thêm về webhooks trong RazorPay [tại đây](https://razorpay.com/docs/webhooks/). Webhook này sẽ thông báo cho trang ERPNext của bạn bất cứ khi nào một khoản quyên góp mới được tạo.

<img class="screenshot" alt="Donation Webhook" src="https://docs.erpnext.com/docs/v16/assets/img/non_profit/donation-webhook.png">
