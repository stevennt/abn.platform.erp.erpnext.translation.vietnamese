...
<img class="screenshot" alt="Make Loan Disbursement" src="https://docs.erpnext.com/docs/v16/assets/img/loan-management/loan-disbursement-flow.png">

Để truy cập danh sách Giải ngân khoản vay, hãy đi tới:
> Home > Loan Management > Disbursement and Repayment > Loan Disbursement


<img class="screenshot" alt="Loan Disbursement" src="https://docs.erpnext.com/docs/v16/assets/img/loan-management/loan-disbursement.png">
...
5. Nhấn **Lưu** để lưu bản Nháp của Giải ngân khoản vay.
6. Nhấn **Xác nhận** để xác nhận Cam kết bảo lãnh khoản vay.
