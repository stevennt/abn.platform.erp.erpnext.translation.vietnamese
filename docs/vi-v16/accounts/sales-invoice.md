...
* **Hạn thanh toán (Due Date)**: Ngày mà khoản thanh toán đến hạn (nếu bạn bán hàng trả chậm). Hạn mức tín dụng có thể được thiết lập từ danh mục [Khách hàng](../crm/customer.md).
