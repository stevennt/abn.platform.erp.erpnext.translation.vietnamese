<!-- add-breadcrumbs -->
#Đóng băng các bút toán kế toán

Để đóng băng các bút toán kế toán cho đến một ngày nhất định, hãy thực hiện theo các bước dưới đây.

#### Bước 1: Đi đến:

`Accounting > Accounting Msters > Accounts Settings`

#### Bước 2: Thiết lập ngày

Thiết lập ngày trong trường **Accounts Frozen Upto**.

![Books Closed Through](https://docs.erpnext.com/docs/v13/assets/img/articles/books-closed-through.png)
...
![Frozen Date Error](https://docs.erpnext.com/docs/v13/assets/img/articles/error-message-in-transaction.png)
...
![Role Allowed To Close Books](https://docs.erpnext.com/docs/v13/assets/img/articles/role-allowed-to-close-books.png)
