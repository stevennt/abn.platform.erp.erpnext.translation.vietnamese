...
* Bỏ chọn trường "Allow Stale Exchange Rates".
    ...
    ![Allow Stale Exchange Rates](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/articles/allow-stale-exchange-rates.png)
