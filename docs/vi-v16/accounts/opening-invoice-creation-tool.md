...
Trong phiên bản v16, công cụ này được tối ưu hóa để hỗ trợ các tính năng kế toán mới như **Ledger Preview** (Xem trước bút toán) trước khi **Xác nhận**, giúp đảm bảo tính chính xác của số dư đầu kỳ trước khi ghi sổ.
...
3. Đánh dấu vào ô "Create Missing Party" sẽ tự động tạo Khách hàng hoặc Nhà cung cấp nếu chưa có dựa trên tên được cung cấp trong cột Đối tác (Party).
    ...
    <img class="screenshot" alt="Opening Invoice Creation Tool" src="https://docs.erpnext.com/docs/v16/assets/img/setup/opening-invoice-creation-tool.png">
...
5. **Kiểm tra Bút toán (Ledger Preview)**: Trước khi nhấn **Lưu** hoặc **Xác nhận**, bạn nên sử dụng tính năng Xem trước bút toán để kiểm tra xem các dòng nợ/có (Debit/Credit) có khớp với số dư mong muốn hay không.
