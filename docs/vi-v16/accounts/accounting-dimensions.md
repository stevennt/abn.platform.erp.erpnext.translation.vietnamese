...
![Creating Accounting Dimension](https://docs.erpnext.com/docs/v13/assets/img/accounts/accounting-dimension.png)
...
![Accounting Dimension in Sales Invoice](https://docs.erpnext.com/docs/v13/assets/img/accounts/accounting-dimension-in-invoice.png)
...
![Accounting Dimension in Reports](https://docs.erpnext.com/docs/v13/assets/img/accounts/report-dimensions.png)
...
![Accounting Dimension Mandatory in Transaction](https://docs.erpnext.com/docs/v13/assets/img/accounts/dimension-mandatory.png)
...
![Disable Accounting Dimension](https://docs.erpnext.com/docs/v13/assets/img/accounts/dimension-disable.png)
