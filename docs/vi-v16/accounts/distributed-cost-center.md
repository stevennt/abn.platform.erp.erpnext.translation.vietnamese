...
Trong ERPNext v16, bạn có thể tạo Trung tâm chi phí phân bổ và sử dụng chúng trong các giao dịch, báo cáo tài chính và các tính năng kế toán định kỳ.
...
Các báo cáo sau sẽ được cập nhật tự động khi bộ lọc Trung tâm chi phí được thêm vào:
  ...
  * [Báo cáo kế toán](accounting-reports.md)
    * Báo cáo tài chính (Financial Report Templates)
    * Bảng cân đối thử hợp nhất (Consolidated Trial Balance)
    * Sổ cái (Ledger)
    * Xem trước sổ cái (Ledger Preview) trước khi Xác nhận
    * Biến động ngân sách
  * [Phân tích khả năng sinh lời](articles/tracking-project-profitability-using-cost-center.md)

*Lưu ý: Với các cập nhật mới trong v16, việc phân bổ chi phí sẽ hỗ trợ tốt hơn cho các tính năng như Kế toán định kỳ (Periodic Accounting) và tính toán Giá vốn hàng bán (COGS) tách biệt với Chi phí dịch vụ (Service Expenses).*
