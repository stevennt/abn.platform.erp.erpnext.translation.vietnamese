...
1. Đi tới Hóa đơn mua hàng tương ứng và nhấp vào **Create > Return / Debit Note**.
 ![Debit Note from Invoice](https://docs.erpnext.com/docs/v16/assets/img/accounts/debit-note-from-purchase-invoice.png)
...
1. **Lưu** và **Xác nhận**.
 ...
 ![Debit Note](https://docs.erpnext.com/docs/v16/assets/img/accounts/debit-note.png)
...
![Debit Note Ledger](https://docs.erpnext.com/docs/v16/assets/img/accounts/debit-note-ledger.png)
...
![Creating Debit Note](https://docs.erpnext.com/docs/v16/assets/img/accounts/creating-debit-note.gif)
