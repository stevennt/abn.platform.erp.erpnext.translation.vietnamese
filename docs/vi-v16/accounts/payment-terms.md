...
<img class="screenshot" alt="Payment Terms" src="https://docs.erpnext.com/docs/v16/assets/img/accounts/payment-terms.png">
...
<img class="screenshot" alt="Payment Terms with Discount" src="https://docs.erpnext.com/docs/v16/assets/img/accounts/payment-terms-with-discount.png">
...
![Payment Schedule](https://docs.erpnext.com/docs/v16/assets/img/accounts/payment-term-in-invoice.png)

Lưu ý: Lịch trình thanh toán có thể được hiển thị trong Chế độ xem in bằng cách sử dụng [Print Format Builder](https://docs.erpnext.com/docs/v16/user/manual/en/setting-up/print/print-format-builder).
