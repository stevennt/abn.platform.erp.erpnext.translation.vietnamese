...
*(Nội dung này chưa được cung cấp trong bản gốc, vui lòng bổ sung nếu cần)*
...
- **Mẫu báo cáo tài chính (Financial Report Templates):** ERPNext v16 cho phép tùy chỉnh các mẫu báo cáo linh hoạt hơn.
- **Bảng cân đối thử hợp nhất (Consolidated Trial Balance):** Hỗ trợ xem báo cáo tổng hợp từ nhiều công ty.
- **Giá vốn hàng bán (COGS):** Trong v16, chi phí dịch vụ (Service Expenses) được tách biệt khỏi COGS để báo cáo chính xác hơn.
- **Xem trước Sổ cái (Ledger Preview):** Cho phép kiểm tra các bút toán trước khi nhấn Xác nhận (Submit).
- **Tự động chốt tồn kho (Automatic Closing Stock):** Hệ thống tự động tính toán giá trị tồn kho cuối kỳ.
- **Kế toán định kỳ (Periodic Accounting):** Hỗ trợ các nghiệp vụ kế toán theo kỳ hạn một cách tự động.
