...
<img class="screenshot" alt="Cost Center" src="https://docs.erpnext.com/docs/v13/assets/img/accounts/chart-of-cost-center.png">

![Chart of Cost Centers](https://docs.erpnext.com/docs/v13/assets/img/accounts/company-master.png)
