...
![Process Deferred Revenue](https://docs.erpnext.com/docs/v16/assets/img/accounts/process-deferred-accounting.png)

## 3. Các tính năng mới và cải tiến trên v16

### 3.1 Xem trước Bút toán (Ledger Preview)
Trong phiên bản v16, trước khi nhấn **Xác nhận**, người dùng có thể sử dụng tính năng **Xem trước Bút toán** để kiểm tra các dòng Bút toán (JE) sẽ được tạo. Điều này giúp đảm bảo tính chính xác của việc phân bổ doanh thu hoặc chi phí vào các tài khoản tương ứng trước khi ghi sổ chính thức.
...
### 3.3 Bật kế toán hoãn lại tự động
