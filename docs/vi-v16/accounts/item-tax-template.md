...
![Item Tax In Item](https://docs.erpnext.com/docs/v16/assets/img/accounts/item-tax-in-item.png)
...
![Item-wise Tax](https://docs.erpnext.com/docs/v16/assets/img/accounts/item-wise-tax.png)

Đối với Mặt hàng được miễn thuế hoàn toàn, hãy ghi mức thuế là 0% trong danh mục Mặt hàng.

![Tax Exempted Item](https://docs.erpnext.com/docs/v16/assets/img/accounts/tax-exempted-item.png)
...
![Tax Calculation](https://docs.erpnext.com/docs/v16/assets/img/accounts/tax-calculation.png)
...
![Select Item Tax Template](https://docs.erpnext.com/docs/v16/assets/img/accounts/select-item-tax-template.png)
...
![Item Tax Template in Item Group](https://docs.erpnext.com/docs/v16/assets/img/accounts/item-tax-template-in-item-group.png)
...
<img class="screenshot" alt="Item Tax in Item Group" src="https://docs.erpnext.com/docs/v16/assets/img/accounts/item-tax-in-item.png">
...
![Item Tax Net Range](https://docs.erpnext.com/docs/v16/assets/img/accounts/item-tax-net-range.png)
