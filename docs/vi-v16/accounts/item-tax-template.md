...
Nếu một số [Mặt hàng](../stock/item.md) của bạn có mức thuế suất khác với mức thuế tiêu chuẩn được chỉ định trong bảng Thuế và Phí, bạn có thể tạo một Mẫu Thuế theo Mặt hàng và gán nó cho một [Mặt hàng](../stock/item.md) hoặc [Nhóm mặt hàng](../stock/item-group.md). Mức thuế được chỉ định trong Mẫu Thuế theo Mặt hàng sẽ được ưu tiên hơn mức thuế tiêu chuẩn được chỉ định trong bảng Thuế và Phí.

Ví dụ, nếu thuế GST 18% được thêm vào bảng Thuế và Phí trong [Đơn bán hàng](../selling/sales-order.md), thì nó sẽ được áp dụng cho tất cả các mặt hàng trong Đơn bán hàng đó. Tuy nhiên, nếu bạn cần áp dụng mức thuế suất khác cho một số mặt hàng, các bước được cung cấp dưới đây.
...
![Item Tax In Item](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/item-tax-in-item.png)
...
![Tax Calculation](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/tax-calculation.png)
...
![Select Item Tax Template](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/select-item-tax-template.png)
...
![Item Tax Template in Item Group](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/item-tax-template-in-item-group.png)
...
<img class="screenshot" alt="Item Tax in Item Group" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/item-tax-in-item.png">
...
> Lưu ý: Khi thêm các mặt hàng trong [Hóa đơn mua hàng](../buying/purchase_invoice.md), ưu tiên đầu tiên sẽ được dành cho 'Ngày hóa đơn nhà cung cấp' thay vì 'Ngày hạch toán' để lấy Mẫu Thuế theo Mặt hàng hợp lệ.

### 2.7 Thuế mặt hàng dựa trên Giá ròng

![Item Tax Net Range](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/item-tax-net-range.png)

- Đối với nhiều loại thuế suất dựa trên khoảng giá ròng, hệ thống sẽ đối chiếu giá trị của mặt hàng với các khoảng được thiết lập để áp dụng mức thuế tương ứng.