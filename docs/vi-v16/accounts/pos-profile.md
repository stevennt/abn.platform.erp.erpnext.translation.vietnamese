...
1. Thiết lập các phương thức thanh toán trong bảng, mặc định sẽ là tiền mặt nếu không có gì được thiết lập ở đây. Chỉ những phương thức được thiết lập ở đây mới có sẵn khi sử dụng POS. Sau khi thêm các phương thức thanh toán, hãy đặt một trong số chúng làm phương thức thanh toán mặc định bằng cách tích vào ô kiểm.
 ...
 ![Payment Method in POS Profile](https://docs.erpnext.com/docs/v16/assets/img/accounts/payment-method-in-pos.png)

1. Thiết lập số tiền mặc định cho các phương thức thanh toán (khuyến nghị: 0).
1. Lưu.

 ![POS Profile](https://docs.erpnext.com/docs/v16/assets/img/accounts/pos-profile.png)
...
![POS User](https://docs.erpnext.com/docs/v16/assets/img/accounts/pos-profile-default.png)
...
![Filters in POS Profile](https://docs.erpnext.com/docs/v16/assets/img/accounts/filters-in-pos-profile.png)

### 2.3 Cài đặt in

![POS Print Settings](https://docs.erpnext.com/docs/v16/assets/img/accounts/pos-profile-in-print-settings.png)
