...
1. Đi đến danh sách Invoice Discounting, nhấn vào **New** (Mới).
...
Nếu khoản vay không được hoàn trả vào cuối thời hạn vay, hệ thống sẽ tự động tạo một Bút toán thông qua một công việc lập lịch (scheduled job) để chuyển giá trị từ 'Accounts Receivable Discounted Account' (Tài khoản phải thu đã chiết khấu) sang 'Accounts Receivable Unpaid Account' (Tài khoản phải thu chưa thanh toán). Điều này giúp việc quản lý dòng tiền và đối soát báo cáo tài chính cuối kỳ được chính xác và tự động.
