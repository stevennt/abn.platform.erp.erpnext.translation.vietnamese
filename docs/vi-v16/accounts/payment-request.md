...
![Payment Request From Sales Order](https://docs.erpnext.com/docs/v16/assets/img/accounts/payment-request-from-sales-order.png)
...
![Payment Request From Sales Invoice](https://docs.erpnext.com/docs/v16/assets/img/accounts/payment-request-from-sales-invoice.png)
...
![Payment Request Details](https://docs.erpnext.com/docs/v16/assets/img/accounts/payment-request-details.png)
...
![Payment Request Details](https://docs.erpnext.com/docs/v16/assets/img/accounts/payment-request-recipient-details.png)
...
<img class="screenshot" alt="Payment Request" src="https://docs.erpnext.com/docs/v16/assets/img/accounts/pr-email.png">
