...
<img class="screenshot" alt="Material Request" src="https://docs.erpnext.com/docs/v16/assets/img/buying/material-request-flowchart.png">
...
1. Bạn có thể lấy Mặt hàng từ một Định mức nguyên vật liệu, Đơn bán hàng hoặc Gói sản phẩm.
  ![MR fetch from](https://docs.erpnext.com/docs/v16/assets/img/stock/mr-fetch-from.png)
...
<img class="screenshot" alt="Material Request" src="https://docs.erpnext.com/docs/v16/assets/img/stock/material-request.png">
