...
* **Hệ thống Giữ hàng (Stock Reservation System):** Cho phép giữ mặt hàng trong kho cho các Đơn bán hàng (SO) hoặc lệnh sản xuất, giúp quản lý tồn kho khả dụng chính xác hơn.
* **Báo cáo Truy xuất nguồn gốc Lô/Số Serial (Serial/Batch Traceability Report):** Theo dõi chi tiết lịch sử của từng lô hàng hoặc số serial từ khi nhập kho đến khi xuất kho.
* **Chi phí cập bến cho Phiếu kho (Landed Cost cho Stock Entry):** Cho phép phân bổ các chi phí mua hàng (thuế, vận chuyển, phí hải quan) trực tiếp vào giá trị của mặt hàng khi thực hiện Phiếu kho.
* **Kế toán tồn kho theo cấp độ mặt hàng (Item-Level Stock Accounting):** Cung cấp khả năng kiểm soát kế toán chi tiết hơn cho từng mặt hàng cụ thể.
* **Xem trước Sổ cái (Ledger Preview):** Cho phép xem nhanh các bút toán liên quan ngay tại giao dịch kho.
...
**Nhà cung cấp (Supplier):** Arcu Vel Quam Fabricators
...
<table class="table table-bordered">
    <thead>
        <tr>
            ...
            <th>Giá trị định giá (Valuation Amount)</th>
        </tr>
    </thead>
    <tbody>
        <tr>
...
<p><strong>Thuế và phí (Taxes):</strong>
</p>
<table class="table table-bordered">
    <thead>
        <tr>
            <th>Tài khoản (Account)</th>
...
<img class="screenshot" alt="Perpetual Inventory" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/perpetual-receipt-sl-1.png">

**Sổ cái**

<img class="screenshot" alt="Perpetual Inventory" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/perpetual-receipt-gl-2.png">

Khi số dư tồn kho tăng lên thông qua Phiếu nhập hàng, các tài khoản "Store" sẽ được ghi nợ và một tài khoản tạm thời "Stock Received But Not Billed" sẽ được ghi có, để duy trì hệ thống kế toán bút toán kép. Đồng thời, một khoản chi phí âm sẽ được ghi vào tài khoản có danh mục là "Valuation" hoặc "Total and Valuation" trong bảng thuế và phí cho số tiền được cộng thêm nhằm mục đích tính giá (Landed Cost), để tránh việc ghi nhận chi phí hai lần.
...
<img class="screenshot" alt="Perpetual Inventory" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/perpetual-pinv-gl-3.png">
...
**Khách hàng (Customer):** Utah Automation Services
