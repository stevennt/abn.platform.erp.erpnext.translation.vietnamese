...
![Stock Settings](https://docs.erpnext.com/docs/v16/assets/img/stock/stock-settings-1.png)

Theo mặc định, Tên Mặt hàng được đặt theo Mã Mặt hàng đã nhập. Nếu bạn muốn các Mặt hàng được đặt tên theo một [Chuỗi đặt tên](naming-series.md) nhất định, hãy chọn tùy chọn 'Naming Series'.
...
![Stock Settings](https://docs.erpnext.com/docs/v16/assets/img/stock/stock-settings-def.png)
...
![Stock Settings](https://docs.erpnext.com/docs/v16/assets/img/stock/stock-settings-2.png)
...
![Stock Settings](https://docs.erpnext.com/docs/v16/assets/img/stock/stock-settings-3.png)
...
<img class="screenshot" alt="Delivery Note Material Transfer" src="https://docs.erpnext.com/docs/v16/assets/img/stock/inter-warehouse.png">
...
## 12. Các tính năng mới trong v16

### 12.1 Hệ thống Giữ hàng (Stock Reservation System)
Cho phép doanh nghiệp giữ trước một lượng tồn kho cho các Đơn bán hàng (SO) hoặc các yêu cầu cụ thể, giúp đảm bảo khả năng cung ứng và lập kế hoạch sản xuất/mua hàng chính xác hơn.

### 12.2 Báo cáo Truy xuất nguồn gốc Lô hàng/Số Serial (Serial/Batch Traceability Report)
Cung cấp khả năng theo dõi toàn diện lịch sử của một Mặt hàng dựa trên Số serial hoặc Lô hàng (Batch). Bạn có thể xem nhanh các giao dịch liên quan từ khi nhập kho (PR) cho đến khi xuất kho (DN) để phục vụ kiểm tra chất lượng (QI) hoặc thu hồi sản phẩm.

### 12.3 Tính giá thành cập bến cho Phiếu kho (Landed Cost cho Stock Entry)
Cho phép phân bổ các chi phí phát sinh thêm (như phí vận chuyển, thuế nhập khẩu, phí bốc xếp) trực tiếp vào giá trị của Mặt hàng khi thực hiện các giao dịch Phiếu kho (SE). Điều này giúp giá trị tồn kho phản ánh chính xác chi phí thực tế.

### 12.4 Kế toán tồn kho theo cấp độ Mặt hàng (Item-Level Stock Accounting)
Nâng cao khả năng kiểm soát tài chính bằng cách cho phép theo dõi chi tiết các bút toán (JE) liên quan đến giá trị tồn kho cho từng Mặt hàng cụ thể, giúp việc đối soát giữa kho và kế toán trở nên chính xác tuyệt đối.

### 12.5 Xem trước Sổ cái (Ledger Preview)
Tính năng cho phép người dùng xem nhanh các bút toán (JE) liên quan trực tiếp từ các giao dịch kho (như Phiếu nhập hàng, Phiếu giao hàng, Phiếu kho) mà không cần phải chuyển sang phân hệ Kế toán, giúp tăng tốc độ kiểm tra dữ liệu.