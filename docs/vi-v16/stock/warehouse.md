...
![Warehouse](https://docs.erpnext.com/docs/v16/assets/img/stock/warehouse.png)
...
<img class="screenshot" alt="Warehouse" src="https://docs.erpnext.com/docs/v16/assets/img/stock/warehouse-tree.png">
