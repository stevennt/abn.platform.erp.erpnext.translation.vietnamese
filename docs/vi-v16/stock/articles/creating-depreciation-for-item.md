...
<img alt="reorder level" class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/articles/fixed-asset-dep-1.gif">
...
<img alt="reorder level" class="screenshot" src="https://docs.erpnext.com/docs/v16/assets/img/articles/fixed-asset-dep-2.png">
