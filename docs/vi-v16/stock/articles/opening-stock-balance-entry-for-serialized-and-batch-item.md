...
Đối với các mặt hàng có quản lý Số serial và Lô hàng, việc nhập số dư tồn kho đầu kỳ được thực hiện thông qua Phiếu kho. [Nhấp vào đây để tìm hiểu cách quản lý tồn kho theo số serial trong ERPNext](serial-no.html).
