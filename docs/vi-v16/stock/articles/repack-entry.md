...
3. Với phiên bản v16, hệ thống hỗ trợ mạnh mẽ hơn về **Truy xuất nguồn gốc Lô hàng/Số sê-ri (Serial/Batch Traceability)** và **Kế toán tồn kho theo từng mặt hàng (Item-Level Stock Accounting)**, giúp việc đóng gói lại chính xác hơn về giá trị và định danh.
...
Hệ thống v16 sẽ tự động cập nhật:
