...
<img class="screenshot" alt="Price List" src="https://docs.erpnext.com/docs/v16/assets/img/stock/price-list.png">
...
### Các tính năng mới trong v16 liên quan đến Quản lý Giá và Kho

Trong phiên bản v16, việc quản lý giá kết hợp chặt chẽ hơn với các tính năng quản lý kho nâng cao:

* **Hệ thống Giữ hàng (Stock Reservation System)**: Giúp đảm bảo các mặt hàng đã được định giá trong [Đơn bán hàng](so.md) sẽ được giữ lại trong kho, tránh việc bán quá số lượng thực tế.
* **Giá vốn hàng bán theo từng Mặt hàng (Item-Level Stock Accounting)**: Cho phép theo dõi giá trị tồn kho và giá vốn chính xác hơn dựa trên các biến động giá từ Bảng giá Mua.
* **Chi phí cập bến cho Phiếu kho (Landed Cost cho Stock Entry)**: Tự động cập nhật các chi phí mua hàng (vận chuyển, thuế...) vào giá trị của Mặt hàng trong kho, giúp phản ánh đúng giá trị thực tế của hàng hóa.
