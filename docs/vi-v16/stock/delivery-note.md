...
![Delivery Note flow](https://docs.erpnext.com/docs/v16/assets/img/stock/delivery-note-flow.png)
...
1. Lưu và Xác nhận.
    ...
    <img class="screenshot" alt="Delivery Note" src="https://docs.erpnext.com/docs/v16/assets/img/stock/delivery-note.png">
