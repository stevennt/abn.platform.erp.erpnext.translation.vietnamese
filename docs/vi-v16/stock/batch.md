...
* Bật 'Has Batch No' trong danh mục Mặt hàng
    ![Batch No Enabled](https://docs.erpnext.com/docs/v16/assets/img/stock/batch-no-enabled.png)
...
<img class="screenshot" alt="Item Setup for Batches" src="https://docs.erpnext.com/docs/v16/assets/img/stock/item_setup_for_batch.png">
...
<img class="screenshot" alt="Batch View" src="https://docs.erpnext.com/docs/v16/assets/img/stock/batch_view.png">
...
* Bạn cũng có thể chia nhỏ lô hàng bằng cách nhấn vào nút **Split**. Việc này sẽ tạo ra một Lô hàng mới dựa trên Lô hàng này và số lượng sẽ được chia giữa các lô.
    ...
    ![Split Batch](https://docs.erpnext.com/docs/v16/assets/img/stock/batch_split.png)
