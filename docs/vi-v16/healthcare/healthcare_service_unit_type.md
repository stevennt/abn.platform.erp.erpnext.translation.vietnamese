...
<img class="screenshot" alt="ERPNext Healthcare" src="../assets/img/healthcare/healthcare_service_unit_type_1.png">

Tuy nhiên, các phòng Tư vấn sẽ chỉ cho phép Hẹn lịch mà không có sự trùng lặp:

<img class="screenshot" alt="ERPNext Healthcare" src="../assets/img/healthcare/healthcare_service_unit_type_2.png">
...
<img class="screenshot" alt="ERPNext Healthcare" src="../assets/img/healthcare/healthcare_service_unit_type.png">
...
<img class="screenshot" alt="ERPNext Healthcare" src="../assets/img/healthcare/healthcare_service_unit_type_3.png">

## 2. Các chủ đề liên quan
1. [Healthcare Service Unit](../healthcare/healthcare_service_unit)
