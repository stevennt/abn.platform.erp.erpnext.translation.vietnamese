...
<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v16/assets/img/healthcare/therapy-session.png">
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v16/assets/img/healthcare/therapy-session-from-appointment.png">

Tham khảo [Kế hoạch trị liệu](../healthcare/therapy_plan) để hiểu về cách tạo các Phiên trị liệu từ Kế hoạch trị liệu.
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v16/assets/img/healthcare/therapy-invoicing.png">

## 3. Các chủ đề liên quan
1. [Loại trị liệu](../healthcare/therapy_type)
