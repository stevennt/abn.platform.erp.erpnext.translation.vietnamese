...
* [Inpatient Record](/docs/v16/user/manual/en/healthcare/inpatient_record)
...
Trạng thái của IPMO được quản lý bởi tổng số các mục đơn thuốc đã hoàn thành. Các mục đơn thuốc được đánh dấu là đã hoàn thành khi một [Inpatient Medication Entry](/docs/v16/user/manual/en/healthcare/inpatient_medication_entry) được tạo cho mục đơn thuốc đó.
...
1. [Inpatient Medication Entry](/docs/v16/user/manual/en/healthcare/inpatient_medication_entry)
