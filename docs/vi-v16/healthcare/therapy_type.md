...
Để tạo một Loại trị liệu, hãy đi tới:
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/therapy-type.png">

## 2. Các tính năng

### 2.1 Thêm bài tập theo Bộ phận cơ thể

Nhiều khi, bạn có thể cần chỉ định các bài tập đặc thù cho các bộ phận cơ thể bị ảnh hưởng của Bệnh nhân. Bạn có thể dễ dàng thêm các Bộ phận cơ thể này vào trường _Therapy For_ (Trị liệu cho) và nhấp vào *Add Exercises* (Thêm bài tập) để thêm các Loại bài tập cho các bộ phận cơ thể đó. Để làm được điều này, bạn sẽ phải liên kết Loại bài tập với Bộ phận cơ thể trong tài liệu Loại trị liệu.

Ví dụ:

- Bài tập "Wall Pushups" (Chống đẩy với tường) dành cho Tay, Cơ và Khớp.

<img class="screenshot" alt="ERPNext Healthcare" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/exercise-1.png">

- Bài tập "Sit to Stand" (Ngồi đứng) dành cho Chân và Cơ lõi.

<img class="screenshot" alt="ERPNext Healthcare" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/exercise-2.png">

- Bài tập "Thera-band Upper Body" (Dây kháng lực thân trên) dành cho Cơ, Khớp, Lưng, Chân.

<img class="screenshot" alt="ERPNext Healthcare" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/exercise-3.png">
...
<img class="screenshot" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/add-exercises.gif">
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/therapy-disabled.png">
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/therapy-change-item-code.png">
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/therapy-appointment.png">

## 3. Các chủ đề liên quan
1. [Loại bài tập](../healthcare/exercise_type)
1. [Kế hoạch trị liệu](../healthcare/therapy_plan)
1. [Buổi trị liệu](../healthcare/therapy_session)
1. [Lịch hẹn bệnh nhân](../healthcare/patient_appointment)
1. [Gặp gỡ bệnh nhân](../healthcare/patient_encounter)
