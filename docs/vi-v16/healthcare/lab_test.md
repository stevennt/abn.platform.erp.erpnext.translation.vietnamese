...
2. Chọn [Mẫu xét nghiệm Lab](/docs/v16/user/manual/vi/healthcare/lab_test_template). Khoa Y tế sẽ tự động được lấy từ mẫu.
...
7. Bạn có thể thay đổi dữ liệu đã cấu hình trước theo yêu cầu của mình. Thêm nhận xét nếu có, trong phần Ghi chú.
    ...
    ![Lab Test](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/lab-test.png)
...
Ví dụ, Xét nghiệm theo nhóm:
    ![Lab Result](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/lab_test_2.png)

Xét nghiệm mô tả:
    ![Lab Result](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/lab-result.png)

Các thành phần mà mục _Cho phép để trống_ không được tích sẽ báo lỗi xác thực nếu để trống khi Xác nhận.

    ![Lab Result](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/result-mandatory.png)
...
![Lab Test Multiple](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/lab_test_3.png)
...
![Lab Test](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/patient-encounter-lab-tests-1.png)

Các xét nghiệm được chỉ định trong phần Khám bệnh của Cuộc gặp bệnh nhân đó sẽ được lấy ra.

![Lab Test](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/patient-encounter-lab-tests.png)

![Lab Test](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/patient-encounter-lab-tests-2.png)
...
ERPNext Healthcare cũng cho phép tạo các Xét nghiệm Lab tự động khi bất kỳ xét nghiệm lab nào được lập hóa đơn (thông qua Hóa đơn bán hàng). Để cấu hình điều này, hãy bật tùy chọn _Tạo (các) Xét nghiệm Lab khi Xác nhận Hóa đơn bán hàng_ trong [Cài đặt Healthcare](/docs/v16/user/manual/vi/healthcare/healthcare_settings).
...
![Sensitivity](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/sensitivity.png)
...
![Format Test Result](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/format-result-value.png)

![Formatted Result](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/formatted-result.png)

### 2.7 Thông báo SMS Phòng xét nghiệm

Bạn có thể cấu hình các tin nhắn để gửi thông báo SMS cho bệnh nhân bất cứ khi nào kết quả xét nghiệm lab đã sẵn sàng trong [Cài đặt Healthcare](/docs/v16/user/manual/vi/healthcare/healthcare_settings). Để làm điều này, trước tiên bạn phải thiết lập [Cài đặt SMS](/docs/v16/user/manual/vi/setting-up/sms-setting).

## 3. Các chủ đề liên quan

1. [Xét nghiệm Lab](/docs/v16/user/manual/vi/healthcare/lab_test)
1. [Thu thập mẫu](/docs/v16/user/manual/vi/healthcare/sample_collection)
