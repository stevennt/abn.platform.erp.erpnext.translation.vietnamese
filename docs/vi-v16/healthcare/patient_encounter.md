...
<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v16/assets/img/healthcare/patient_encounter_1.png">
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v16/assets/img/healthcare/encounter_4.png">

### 2.2 Thuốc

Bạn có thể kê đơn thuốc trong phần Medication bằng cách chọn các mã thuốc (Mặt hàng) và liều lượng phù hợp. Nếu bạn không quản lý Tồn kho và các Mặt hàng chưa được cấu hình, bạn có thể chỉ cần nhập tên Thuốc và hàm lượng trong trường Strength để được in ra. Bạn có thể tùy chọn thêm nhận xét trong mục bảng Thuốc và chọn Dạng bào chế (Viên nén, Siro).

<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v16/assets/img/healthcare/encounter_medication.png">

Nếu bạn có duy trì tồn kho, Kho thuốc có thể được quản lý bằng cách sử dụng Phân hệ Tồn kho:

<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v16/assets/img/healthcare/healthcare-inventory.png">
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v16/assets/img/healthcare/encounter_investigation.png">

Các Xét nghiệm có thể được cấu hình để tự động tạo khi Xác nhận Hóa đơn bán hàng bằng cách tích vào _Create Lab Test(s) on Sales Invoice Submission_ trong [Healthcare Settings](../user/manual/en/healthcare/healthcare_settings).
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v16/assets/img/healthcare/encounter_procedures.png">
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v16/assets/img/healthcare/therapy-encounter.jpg">
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v16/assets/img/healthcare/prescription.png">
...
1. [Lịch hẹn Bệnh nhân](../user/manual/en/healthcare/patient_appointment)
1. [Mẫu Thủ thuật Lâm sàng](../user/manual/en/healthcare/clinical_procedure_template)
