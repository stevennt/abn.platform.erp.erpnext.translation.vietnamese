...
Bạn có thể cấu hình tất cả các loại DocType và các trường nào sẽ là một phần của Hồ sơ y tế của Bệnh nhân và Lịch sử Bệnh nhân bằng cách sử dụng [Patient History Settings](/docs/v16/user/manual/en/healthcare/patient_history_settings).
...
1. [Patient History Settings](/docs/v16/user/manual/en/healthcare/patient_history_settings)
