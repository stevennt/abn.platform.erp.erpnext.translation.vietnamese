...
5. **Hồ sơ Giảng viên được tạo bởi**: Bạn có thể chọn cách bạn muốn Hồ sơ Giảng viên được tạo trong hệ thống ERPNext của mình, cho dù đó là theo Họ và tên, theo Chuỗi đặt tên, hoặc theo Mã nhân viên.
 ...
 ![Education Settings](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/education/education-seetings-1.png)
