...
7. Lưu. 'Tổng số ngày nghỉ' sẽ được tính toán và thiết lập trong tài liệu sau khi loại trừ các ngày lễ nằm trong [Danh sách ngày lễ](/docs/v13/user/manual/en/human-resources/holiday-list) mặc định của bạn.

    ![Student Leave Application](https://docs.erpnext.com/docs/v13/assets/img/education/student-leave-application.png)
...
![Student Attendance](https://docs.erpnext.com/docs/v13/assets/img/education/leave-attendance-record.png)
...
1. [Chấm công Học sinh](/docs/v13/user/manual/en/education/student-attendance).
