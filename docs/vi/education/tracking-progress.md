...
Nếu 'Allow Self Enroll' được bật cho một chương trình cụ thể, một bản ghi sẽ được tạo tự động thay mặt cho học viên. Mỗi học viên sẽ chỉ có một bản ghi đăng ký chương trình cho mỗi chương trình. Bạn có thể tìm hiểu thêm về đăng ký chương trình [tại đây]({{ docs_base_url }}/user/manual/en/education/program-enrollment)
