...
Lưu ý: Lịch trình thanh toán có thể được hiển thị trong Chế độ xem in bằng cách sử dụng [Print Format Builder](/docs/v13/user/manual/en/setting-up/print/print-format-builder).
