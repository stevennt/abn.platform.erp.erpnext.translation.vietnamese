...
> Lưu ý: Từ phiên bản 13 trở đi, chúng tôi đã giới thiệu sổ cái bất biến (immutable ledger), điều này thay đổi cách thức hủy các bút toán kế toán trong ERPNext. [Tìm hiểu thêm tại đây](/docs/v13/user/manual/en/accounts/articles/immutable-ledger-in-erpnext).
...
1. Loại bút toán (Entry Type) mặc định sẽ là 'Journal Entry'. Đây là loại bút toán đa mục đích. Truy cập [mục 3](/docs/v13/user/manual/en/accounts/journal-entry#3-journal-entry-types) để biết thêm về các loại bút toán.
1. Bạn có thể thay đổi Ngày hạch toán (Posting Date).
1. Mở rộng bảng, chọn một Tài khoản mà số tiền sẽ được ghi nợ.
1. Các chi tiết trên cũng có thể được thêm từ [Mẫu Bút toán](/docs/v13/user/manual/en/accounts/journal-entry-template) với trường 'From Template'.
...
**Sổ tài chính (Finance Book)**: Bạn có thể hạch toán bút toán này vào một [Sổ tài chính](/docs/v13/user/manual/en/accounts/finance-book) cụ thể. Nếu để trống trường này, Bút toán này sẽ hiển thị trong tất cả các Sổ tài chính.
...
* **Chiều kích kế toán (Accounting Dimensions)**: Một Dự án hoặc Trung tâm chi phí có thể được liên kết tại đây để theo dõi chi phí riêng biệt. Để biết thêm, [truy cập trang này](/docs/v13/user/manual/en/accounts/accounting-dimensions).
  ![Accounting Dimension](/docs/v13/assets/img/accounts/journal-entry-accounting-dimension.png)

* **Số tài khoản ngân hàng (Bank Account No)**: Nếu bạn đã thêm một [Tài khoản ngân hàng](/docs/v13/user/manual/en/accounts/bank-account), số liên kết với tài khoản ngân hàng đó sẽ được lấy ra.
...
Dưới đây là các chứng từ có thể được chọn trong Bút toán dưới phần Loại tham chiếu:
  ...
  * [Hóa đơn bán hàng](/docs/v13/user/manual/en/accounts/sales-invoice)
  * [Hóa đơn mua hàng](/docs/v13/user/manual/en/accounts/purchase-invoice)
  ...
  * [Yêu cầu thanh toán chi phí](/docs/v13/user/manual/en/human-resources/expense-claim)
  * [Tài sản](/docs/v13/user/manual/en/asset/asset)
  * [Khoản vay](/docs/v13/user/manual/en/loan-management/loan)
  * [Bút toán lương](/docs/v13/user/manual/en/human-resources/payroll-entry)
  * [Tạm ứng nhân viên](/docs/v13/user/manual/en/human-resources/employee-advance)
  * [Đánh giá lại tỷ giá hối đoái](/docs/v13/user/manual/en/accounts/exchange-rate-revaluation)
  * [Chiết khấu hóa đơn](/docs/v13/user/manual/en/accounts/invoice_discounting)

* **Là tạm ứng (Is Advance)**: Nếu đây là một khoản thanh toán tạm ứng bởi Khách hàng, hãy đặt tùy chọn này thành 'Yes'. Điều này hữu ích khi bạn đã liên kết một biểu mẫu 'Loại tham chiếu' với Bút toán này. Việc chọn “Yes” sẽ liên kết Bút toán này với giao dịch được chọn trong trường 'Reference Name'. Để biết thêm, hãy truy cập trang [Bút toán thanh toán tạm ứng](/docs/v13/user/manual/en/accounts/advance-payment-entry).
