...
1. Chọn Tài khoản mà bạn muốn thiết lập làm Tài khoản nội bộ cho giao dịch, và đánh dấu vào ô 'Tài khoản nội bộ giữa các công ty' (Inter Company Account). Tài khoản này hiện có thể được sử dụng cho các giao dịch Bút toán nội bộ giữa các công ty. Bạn nên tạo một tài khoản mới cho các giao dịch nội bộ giữa các công ty.
    ...
    ![Ledger For Intercompany Transactions](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/ledger-for-intercompany-transactions.png)
...
* Ít nhất hai [Công ty](../setting-up/company-setup.md)
...
1. Sau khi Xác nhận Bút toán, bạn sẽ thấy một nút ở góc trên bên phải, **Tạo Bút toán nội bộ giữa các công ty** (Make Inter Company Journal Entry).
   ...
   ![Inter Company Journal Entry](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/inter-company-journal-entry.png)

1. Nhấp vào nút. Bây giờ, bạn sẽ được yêu cầu chọn Công ty mà bạn muốn tạo Bút toán liên kết.

    ![Company Master](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/select-company-in-inter-company-journal-entry.png)
...
1. Sau khi chọn Công ty, bạn sẽ được chuyển hướng đến một Bút toán khác nơi các trường liên quan sẽ được ánh xạ, ví dụ: Công ty, Loại chứng từ, Tham chiếu Bút toán nội bộ giữa các công ty, v.v.
    ...
    ![Auto Generated Inter Company Journal Entry](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/auto-generated-intercompany-journal-entry.png)
