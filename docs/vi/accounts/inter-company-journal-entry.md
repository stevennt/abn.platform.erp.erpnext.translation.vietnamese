...
* Ít nhất hai [Công ty](/docs/v13/user/manual/en/setting-up/company-setup)
* Thiết lập các tài khoản nội bộ giữa các công ty trong [Hệ thống tài khoản](/docs/v13/user/manual/en/accounts/chart-of-accounts)
...
1. [Hóa đơn nội bộ giữa các công ty](/docs/v13/user/manual/en/accounts/inter-company-invoices)
