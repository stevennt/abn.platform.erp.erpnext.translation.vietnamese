...
![SO Flow](https://docs.erpnext.com/docs/v13/assets/img/accounts/so-flow.png)
...
1. Lưu và Xác nhận.
 ![New Sales Invoice](https://docs.erpnext.com/docs/v13/assets/img/accounts/new-sales-invoice.png)
...
![POS and Credit Note Options](https://docs.erpnext.com/docs/v13/assets/img/accounts/pos-and-credit-note-in-sales-invoice.png)
...
![Chi tiết Đơn mua hàng](https://docs.erpnext.com/docs/v13/assets/img/accounts/purchase-order-details-in-invoice.png)
...
* **Có:** Thuế (các khoản nợ phải trả cho chính phủ)
 ...
 ![SI Ledger](https://docs.erpnext.com/docs/v13/assets/img/accounts/ledger-updates-on-sales-invoice-submission.png)
