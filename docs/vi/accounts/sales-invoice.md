...
![SO Flow](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/so-flow.png)
...
1. Lưu và Xác nhận.
 ![New Sales Invoice](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/new-sales-invoice.png)
...
![POS and Credit Note Options](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/pos-and-credit-note-in-sales-invoice.png)

Dành cho Ấn Độ:
**e-Way Bill No**: Theo quy định của GST, đơn vị vận chuyển cần mang theo e-Way Bill. Để biết cách tạo e-Way Bill, [hãy truy cập trang này](https://docs.erpnext.com/docs/v13/user/manual/en/regional/india/auto-generate-e-way-bill-JSON).
...
* **Hạn thanh toán (Due Date)**: Ngày mà khoản thanh toán đến hạn (nếu bạn bán hàng trả chậm). Hạn mức tín dụng có thể được thiết lập từ danh mục [Khách hàng](https://docs.erpnext.com/docs/v13/user/manual/en/CRM/customer#24-credit-limit-and-payment-terms).
...
![Chi tiết Đơn mua hàng](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/purchase-order-details-in-invoice.png)

### 3.4 Địa chỉ và Liên hệ

* **Địa chỉ Khách hàng:** Đây là Địa chỉ thanh toán của Khách hàng.
* **Người liên hệ**: Nếu Khách hàng là một công ty, người cần liên hệ sẽ được lấy từ biểu mẫu [Khách hàng](https://docs.erpnext.com/docs/v13/user/manual/en/CRM/customer) nếu đã được thiết lập.
...
* **Chi tiết kế toán**: Các tài khoản Thu nhập và Chi phí có thể được thay đổi tại đây nếu bạn muốn. Nếu Mặt hàng này là một [Tài sản](https://docs.erpnext.com/docs/v13/user/manual/en/asset/asset), nó có thể được liên kết tại đây. Điều này hữu ích khi bạn [bán một Tài sản](https://docs.erpnext.com/docs/v13/user/manual/en/asset/selling-an-asset).
...
* **Có:** Thuế (các khoản nợ phải trả cho chính phủ)
 ...
 ![SI Ledger](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/ledger-updates-on-sales-invoice-submission.png)
