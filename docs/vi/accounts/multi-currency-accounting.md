...
![Set Currency in Account](https://docs.erpnext.com/docs/v13/assets/img/accounts/set-default-currency-in-ledger.png)
...
![Update Currency in Ledger](https://docs.erpnext.com/docs/v13/assets/img/accounts/update-currency-in-ledger.png)
...
![Billing Currency in Customer](https://docs.erpnext.com/docs/v13/assets/img/accounts/customer-billing-currency.png)
...
![Multi-currency in Payment Entry](https://docs.erpnext.com/docs/v13/assets/img/accounts/multi-currency-in-payment-entry.png)
...
![Multi-currency in Journal Entry](https://docs.erpnext.com/docs/v13/assets/img/accounts/multi-currency-journal-entry.png)
...
![Company and Transaction Currency in Journal ENtry](https://docs.erpnext.com/docs/v13/assets/img/accounts/company-and-transaction-currency-in-journal-entry.png)
...
![Multi-currency in General Ledger](https://docs.erpnext.com/docs/v13/assets/img/accounts/multi-currency-in-general-ledger.png)
