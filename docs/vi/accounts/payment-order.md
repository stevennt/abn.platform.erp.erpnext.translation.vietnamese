...
1. Nhấn vào nút **Lấy từ** và chọn Yêu cầu thanh toán. Áp dụng bộ lọc nếu cần và chọn các Yêu cầu thanh toán.
 ![Payment Order Fetch](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/payment-order-fetch.png)
1. Các Yêu cầu thanh toán sẽ được lấy vào Đơn thanh toán.
 ![Payment Order Fetch](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/payment-order.png)
1. Lưu và Xác nhận Đơn thanh toán. Bây giờ, bạn sẽ thấy một nút để thực hiện các Bút toán thanh toán hàng loạt.
 ![Payment Order Fetch](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/payment-order-submit.png)
