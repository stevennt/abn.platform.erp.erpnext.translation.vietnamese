...
Nếu một số Mặt hàng của bạn có mức thuế suất khác với mức thuế tiêu chuẩn được chỉ định trong bảng Thuế và Phí, bạn có thể tạo một Mẫu Thuế theo Mặt hàng và gán nó cho một [Mặt hàng](/docs/v13/user/manual/en/stock/item) hoặc [Nhóm mặt hàng](/docs/v13/user/manual/en/stock/item-group). Mức thuế được chỉ định trong Mẫu Thuế theo Mặt hàng sẽ được ưu tiên hơn mức thuế tiêu chuẩn được chỉ định trong bảng Thuế và Phí.
...
1. Bật 'Automatically add Taxes and Charges from Item Tax Template' trong [Cài đặt tài khoản](/docs/v13/user/manual/en/accounts/accounts-settings)
...
> Lưu ý: Khuyến nghị không sử dụng Mẫu Thuế bán hàng/mua hàng được chọn ở đây trong [Quy tắc thuế](/docs/v13/user/manual/en/accounts/tax-rule), vì nó có thể gây xung đột. Nếu bạn muốn sử dụng cùng mức thuế cho Quy tắc thuế và Mẫu Thuế theo Mặt hàng, hãy sử dụng một tên khác cho các Mẫu Thuế bán hàng/mua hàng.
