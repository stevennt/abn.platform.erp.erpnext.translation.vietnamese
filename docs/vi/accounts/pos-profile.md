...
1. Chọn một [Naming Series](../setting-up/settings/naming-series.md).
...
1. Thiết lập các phương thức thanh toán trong bảng, mặc định sẽ là tiền mặt nếu không có gì được thiết lập ở đây. Chỉ những phương thức được thiết lập ở đây mới có sẵn khi sử dụng POS. Sau khi thêm các phương thức thanh toán, hãy đặt một trong số chúng làm phương thức thanh toán mặc định bằng cách tích vào ô kiểm.
 ...
 ![Payment Method in POS Profile](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/payment-method-in-pos.png)

1. Thiết lập số tiền mặc định cho các phương thức thanh toán (khuyến nghị: 0).
1. Lưu.

 ![POS Profile](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/pos-profile.png)
...
* **Campaign**: Một [Campaign](../CRM/campaign.md) bán hàng có thể được liên kết tại đây để theo dõi tổng doanh số theo chiến dịch đó.
...
![POS User](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/pos-profile-default.png)
...
![Filters in POS Profile](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/filters-in-pos-profile.png)

### 2.3 Cài đặt in

![POS Print Settings](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/pos-profile-in-print-settings.png)

#### Mẫu in cho Trực tuyến
Bạn có thể thiết lập một Mẫu in để quyết định bố cục của tài liệu được in sẽ trông như thế nào. Để biết thêm, hãy truy cập trang [Print Format](../setting-up/print/print-format.md).

#### Tiêu đề thư (Letterhead)
Bạn có thể in Hóa đơn bán hàng POS trên tiêu đề thư của Công ty bạn. Tìm hiểu thêm [tại đây](../setting-up/print/letter-head.md).


#### Tiêu đề in
Tiêu đề Hóa đơn bán hàng POS cũng có thể được thay đổi khi in tài liệu. Ví dụ, tiêu đề có thể là 'Invoice' hoặc 'Bill'. Bạn có thể làm điều này bằng cách chọn **Print Heading**. Để tạo Tiêu đề in mới, hãy đi tới: Home > Settings > Printing > Print Heading. Tìm hiểu thêm [tại đây](../setting-up/print/print-headings.md).

#### Điều khoản và Điều kiện
Có thể có các điều khoản và điều kiện nhất định đối với Mặt hàng bạn đang bán, những điều này có thể được áp dụng tại đây. Để biết về cách thêm Điều khoản và Điều kiện, [nhấn vào đây](../setting-up/print/terms-and-conditions.md).

### 2.4 Cài đặt POS Ngoại tuyến
ERPNext là một công cụ trực tuyến chạy bằng internet. Tuy nhiên, bạn có thể sử dụng tính năng POS trong ERPNext khi ngoại tuyến. Để làm như vậy, trước tiên hãy bật 'Use POS in Offline Mode' trong Cài đặt POS.

Khi trực tuyến, cửa sổ POS sẽ hiển thị 'Online', nếu không, hệ thống POS đang được sử dụng ngoại tuyến.

Sau đó, các mục sau có thể được cấu hình trong Hồ sơ POS:

* [Territory](../selling/territory.md)
* [Print Format](../setting-up/print/print-format.md)
* [Customer Group](../CRM/customer-group.md)

![POS Offline](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/pos-setting/pos-profil