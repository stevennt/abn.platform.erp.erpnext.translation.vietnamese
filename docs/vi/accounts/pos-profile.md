...
1. Chọn một [Naming Series](https://docs.erpnext.com/docs/v13/user/manual/en/setting-up/settings/naming-series).
...
* **Campaign**: Một [Campaign](https://docs.erpnext.com/docs/v13/user/manual/en/CRM/campaign) bán hàng có thể được liên kết tại đây để theo dõi tổng doanh số theo chiến dịch đó.
...
Bạn có thể in Hóa đơn bán hàng POS trên tiêu đề thư của Công ty bạn. Tìm hiểu thêm [tại đây](https://docs.erpnext.com/docs/v13/user/manual/en/setting-up/print/letter-head).
...
Có thể có các điều khoản và điều kiện nhất định đối với Mặt hàng bạn đang bán, những điều này có thể được áp dụng tại đây. Để biết về cách thêm Điều khoản và Điều kiện, [nhấn vào đây](https://docs.erpnext.com/docs/v13/user/manual/en/setting-up/print/terms-and-conditions).
