...
1. Chọn một [Naming Series](/docs/v13/user/manual/en/setting-up/settings/naming-series).
...
* **Campaign**: Một [Campaign](/docs/v13/user/manual/en/CRM/campaign) bán hàng có thể được liên kết tại đây để theo dõi tổng doanh số theo chiến dịch đó.
...
* **Ignore Pricing Rule**: Bất kỳ [Pricing Rule](/docs/v13/user/manual/en/accounts/pricing-rule) nào đang hoạt động sẽ bị bỏ qua đối với Hồ sơ POS này.
...
> Lưu ý: Nếu bạn chỉ định một Người dùng cụ thể, cài đặt POS sẽ chỉ được áp dụng cho Người dùng đó. Nếu tùy chọn Người dùng được để trống, cài đặt sẽ được áp dụng cho tất cả người dùng. Để hiểu cách POS hoạt động, hãy truy cập trang [Point of Sale](/docs/v13/user/manual/en/accounts/point-of-sales).
...
Bạn có thể thiết lập một Mẫu in để quyết định bố cục của tài liệu được in sẽ trông như thế nào. Để biết thêm, hãy truy cập trang [Print Format](/docs/v13/user/manual/en/setting-up/print/print-format).

#### Tiêu đề thư (Letterhead)
Bạn có thể in Hóa đơn bán hàng POS trên tiêu đề thư của Công ty bạn. Tìm hiểu thêm [tại đây](/docs/v13/user/manual/en/setting-up/print/letter-head).


#### Tiêu đề in
Tiêu đề Hóa đơn bán hàng POS cũng có thể được thay đổi khi in tài liệu. Ví dụ, tiêu đề có thể là 'Invoice' hoặc 'Bill'. Bạn có thể làm điều này bằng cách chọn **Print Heading**. Để tạo Tiêu đề in mới, hãy đi tới: Home > Settings > Printing > Print Heading. Tìm hiểu thêm [tại đây](/docs/v13/user/manual/en/setting-up/print/print-headings).

#### Điều khoản và Điều kiện
Có thể có các điều khoản và điều kiện nhất định đối với Mặt hàng bạn đang bán, những điều này có thể được áp dụng tại đây. Để biết về cách thêm Điều khoản và Điều kiện, [nhấn vào đây](/docs/v13/user/manual/en/setting-up/print/terms-and-conditions).
...
![POS Offline](/docs/v13/assets/img/pos-setting/pos-profil