...
3. Thiết lập các bộ lọc Sổ cái cho các bản đối chiếu sẽ được gửi cho khách hàng.
    ...
    ![New Process Statement of Accounts](https://docs.erpnext.com/docs/v13/assets/img/accounts/process-statement-of-accounts.png)
...
4. Trong phần "Khách hàng", bạn có tùy chọn để chọn khách hàng trong bảng con và lấy email chính cũng như email thanh toán của họ.
    ...
    ![Customer](https://docs.erpnext.com/docs/v13/assets/img/accounts/psoa-customers.png)
...
5. Trong phần "Tùy chọn in", bạn có thể chọn 2 thứ:
    ...
    ![Print Preference](https://docs.erpnext.com/docs/v13/assets/img/accounts/psoa-print.png)

6. Phần "Cài đặt Email" cho phép bạn cấu hình cách bạn muốn gửi email. Có hai mục con trong phần này:

    ![Email Settings](https://docs.erpnext.com/docs/v13/assets/img/accounts/psoa-auto-email.png)
...
![Send Email and Download](https://docs.erpnext.com/docs/v13/assets/img/accounts/psoa-buttons.png)
