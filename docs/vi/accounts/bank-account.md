...
![Bank Account](https://docs.erpnext.com/docs/v13/assets/img/accounts/bank-account.png)
...
**Last Integration Date (Ngày tích hợp cuối cùng)**: Nếu ngân hàng của bạn hỗ trợ [Tích hợp Plaid](https://docs.erpnext.com/docs/v13/user/manual/en/erpnext_integration/plaid_integration), việc thiết lập một ngày tại đây sẽ thực hiện đồng bộ hóa vào ngày đã chọn. Việc này sẽ tạo ra các bút toán Giao dịch Ngân hàng.
