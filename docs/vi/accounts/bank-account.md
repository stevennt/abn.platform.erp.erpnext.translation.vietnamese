...
Bạn có thể thêm Tài khoản Ngân hàng trong ERPNext cho Công ty, Nhà cung cấp, Khách hàng hoặc bất kỳ bên nào khác mà các giao dịch được thực hiện. Sau đó, Tài khoản Ngân hàng có thể được chọn trong [Bút toán thanh toán](/docs/v13/user/manual/en/accounts/payment-entry) dưới dạng [Phương thức thanh toán](/docs/v13/user/manual/en/accounts/mode-of-payment).
...
* [Ngân hàng](/docs/v13/user/manual/en/accounts/bank)

## 2. Cách tạo Tài khoản Ngân hàng
1. Nhập Tên tài khoản.
1. Liên kết tài khoản Sổ cái được thiết lập trong 'Tài khoản Ngân hàng' trong [Hệ thống tài khoản](/docs/v13/user/manual/en/accounts/chart-of-accounts).
...
**Last Integration Date (Ngày tích hợp cuối cùng)**: Nếu ngân hàng của bạn hỗ trợ [Tích hợp Plaid](/docs/v13/user/manual/en/erpnext_integration/plaid_integration), việc thiết lập một ngày tại đây sẽ thực hiện đồng bộ hóa vào ngày đã chọn. Việc này sẽ tạo ra các bút toán Giao dịch Ngân hàng.
