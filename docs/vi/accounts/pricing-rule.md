...
Quy tắc định giá có phần tương tự như [Quy tắc thuế](/docs/v13/user/manual/en/accounts/tax-rule).
...
1. Thiết lập mức chiết khấu/giá cần áp dụng. Để biết thêm, [hãy đi tới phần này](/docs/v13/user/manual/en/accounts/pricing-rule#35-price-discount-scheme).
1. Lưu.
...
* [Nhóm khách hàng](/docs/v13/user/manual/en/CRM/customer-group)
