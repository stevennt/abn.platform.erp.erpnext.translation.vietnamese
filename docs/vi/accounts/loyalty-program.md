...
* Khi Xác nhận, 2 **Bút toán điểm khách hàng thân thiết** sẽ được tạo. Một cho phần quy đổi, sẽ là một giá trị âm và một cho hóa đơn hiện tại.
 ![Loyalty Point](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/loyalty-point-entry-redeem.png)
