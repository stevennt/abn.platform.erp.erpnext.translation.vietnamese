...
1. Để áp dụng cho tất cả Khách hàng theo mặc định, hãy tích vào 'Auto Opt In (For all customers)'. Nếu không, chương trình cần được chỉ định từ [Customer master](/docs/v13/user/manual/en/accounts/loyalty-program#22-loyalty-points-in-customer).
1. Trong bảng, nhập:
