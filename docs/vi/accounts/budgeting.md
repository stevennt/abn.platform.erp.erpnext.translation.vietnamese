...
1. Trong bảng tài khoản, chọn tài khoản thu nhập/chi phí mà bạn muốn thiết lập ngân sách. Ví dụ, hãy thiết lập ngân sách cho chi phí điện thoại trong năm.
 ![Budget](https://docs.erpnext.com/docs/v13/assets/img/accounts/budget.png)
...
![Monthly Distribution](https://docs.erpnext.com/docs/v13/assets/img/accounts/monthly-budget-distribution.png)

### 2.2 Hành động kiểm soát (Cảnh báo)

Các hành động kiểm soát có thể được kích hoạt khi:

* Một [Material Request](../stock/material-request.md) đang được xác nhận
* Một [Purchase Order](../buying/purchase-order.md) đang được xác nhận
...
![Control Actions](https://docs.erpnext.com/docs/v13/assets/img/accounts/control-actions.png)
...
![Budget Warning](https://docs.erpnext.com/docs/v13/assets/img/accounts/budget-warning.png)
...
![Budget Variance Report](https://docs.erpnext.com/docs/v13/assets/img/accounts/budget-variance-report.png)
