...
> Lưu ý: Không có vai trò nào có thể xác nhận các giao dịch được xác định trong Kỳ kế toán, ngay cả Vai trò được thiết lập trong 'Role Allowed to Set Frozen Accounts & Edit Frozen Entries' trong [Account Settings](/docs/v13/user/manual/en/accounts/accounts-settings).
...
* [Phiếu khóa kỳ](/docs/v13/user/manual/en/accounts/period-closing-voucher)
