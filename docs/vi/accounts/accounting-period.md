...
![Accounting Period Child Table](https://docs.erpnext.com/docs/v13/assets/img/accounts/accounting-period-closed.png)
...
4. Lưu và Xác nhận.
    ![Accounting Period](https://docs.erpnext.com/docs/v13/assets/img/accounts/accounting-period.png)
...
![Accounting Period](https://docs.erpnext.com/docs/v13/assets/img/accounts/accounting-period-closed-for-transaction.png)
