...
Kiểm tra [tại đây](/docs/v13/user/manual/en/stock/perpetual-inventory) để tìm hiểu về việc hạch toán chung được thực hiện cho các chi phí được phân loại là Valuation.
