...
Một Trung tâm chi phí hoạt động giống như một [Accounting Dimension](/docs/v13/user/manual/en/accounts/accounting-dimensions) giúp bạn theo dõi chi phí dựa trên các khu vực cụ thể.
...
Và các giao dịch khác có thể được sử dụng để lập ngân sách. Bạn cũng có thể sử dụng Trung tâm chi phí để [Budgeting](/docs/v13/user/manual/en/accounts/budgeting).
