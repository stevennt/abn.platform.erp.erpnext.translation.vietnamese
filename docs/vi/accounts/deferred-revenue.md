...
![Item With Deferred Revenue](https://docs.erpnext.com/docs/v13/assets/img/accounts/deferred-item.png)
...
![Invoice With Deferred Revenue](https://docs.erpnext.com/docs/v13/assets/img/accounts/deferred-invoice.gif)
...
![Deferred Revenue GL](https://docs.erpnext.com/docs/v13/assets/img/accounts/deferred-revenue-gl.png)
