...
### 2.4 Email yêu cầu
Đây là một ví dụ về email yêu cầu. URL sẽ được tạo tự động nếu bạn đã thiết lập tích hợp thanh toán tương ứng. Để biết thêm về các tích hợp, hãy [truy cập trang này](https://docs.erpnext.com/docs/v13/user/manual/en/erpnext_integration).
