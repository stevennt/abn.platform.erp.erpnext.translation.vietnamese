...
![Currency](https://docs.erpnext.com/docs/v13/assets/img/accounts/currency.png)

## Các chủ đề liên quan
1. [Exchange Rate Revaluation](exchange-rate-revaluation.md)
1. [Multi Currency Accounting](multi-currency-accounting.md)
1. [Currency Exchange](currency-exchange.md)
