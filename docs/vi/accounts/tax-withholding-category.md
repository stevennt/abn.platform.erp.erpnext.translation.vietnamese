...
1. Lưu.
 ...
 ![Tax withholding Category](https://docs.erpnext.com/docs/v13/assets/img/accounts/tax-withholding-category.png)
...
Sau khi Lưu, nó có thể được gán cho một Nhà cung cấp:
 ...
 ![Tax withholding Category in Supplier](https://docs.erpnext.com/docs/v13/assets/img/accounts/tax-withholding-category-in-supplier.png)
...
![Tax Withholding Category in Purchase Invoice](https://docs.erpnext.com/docs/v13/assets/img/accounts/tax-withholding-category-in-purchase-invoice.png)

1. Hãy tạo một hóa đơn trị giá 90.000. Việc Lưu hóa đơn sẽ tự động tính toán thuế và thêm nó vào bảng thuế.

 ![Tax Withholding Category in Purchase Invoice](https://docs.erpnext.com/docs/v13/assets/img/accounts/withheld-tax-calculation-in-purchase-invoice.png)

1. Để thấy hiệu quả của Ngưỡng lũy kế, hãy tạo một hóa đơn trị giá 10.000 và Xác nhận nó.

  ![Tax Withholding Category Cumulative Threshhold](https://docs.erpnext.com/docs/v13/assets/img/accounts/tax-withholding-category-cumulative-threshold.png)
...
![Tax Withholding Category For TCS](https://docs.erpnext.com/docs/v13/assets/img/accounts/tax-withholding-category-for-tcs.png)
...
1. Nếu một **Khách hàng** dự kiến vượt ngưỡng doanh số 50 Lakh trong Năm tài chính hiện tại, thì chúng ta có thể thiết lập Danh mục Khấu trừ Thuế tại nguồn của khách hàng đó thành TCS - Section 20C(1H) để tự động tính toán TCS trên việc bán hàng hóa đối với các hóa đơn của khách hàng.
 ...
 ![TCS in Customer](https://docs.erpnext.com/docs/v13/assets/img/accounts/tcs-eligible-customer.png)
...
1. Hãy tạo một hóa đơn trị giá 50 Lakhs cho khách hàng đủ điều kiện. Việc Lưu hóa đơn sẽ tự động tính toán thuế và thêm nó vào bảng thuế.
 ...
 ![TCS Calculation in Sales Invoice](https://docs.erpnext.com/docs/v13/assets/img/accounts/tcs-invoice.png)
