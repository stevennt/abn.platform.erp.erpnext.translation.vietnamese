...
1. [Đơn bán hàng](/docs/v13/user/manual/en/selling/sales-order) (Thanh toán trước)
1. [Đơn mua hàng](/docs/v13/user/manual/en/buying/purchase-order) (Thanh toán trước)
...
1. [Công ty](/docs/v13/user/manual/en/setting-up/company-setup) (để có các tài khoản mặc định)
...
1. Tài khoản nhận thanh toán (Account Paid To) và Tài khoản chi thanh toán (Account Paid From) sẽ được lấy theo thiết lập trong [mẫu Công ty](/docs/v13/user/manual/en/setting-up/company-setup).
...
Một Bút toán thanh toán được tạo thủ công sẽ không có đơn hàng/hóa đơn nào được liên kết. Các khoản thanh toán thực hiện theo cách này sẽ được ghi nhận vào tài khoản của Khách hàng/Nhà cung cấp và có thể được đối chiếu sau bằng [Công cụ đối chiếu thanh toán](/docs/v13/user/manual/en/accounts/payment-reconciliation).
...
> **Mẹo**: Trong danh mục [Phương thức thanh toán](/docs/v13/user/manual/en/accounts/mode-of-payment), Tài khoản mặc định có thể được thiết lập. Tài khoản thanh toán mặc định này sẽ được lấy vào các Bút toán thanh toán.
...
* **Tài khoản ngân hàng Công ty (Company Bank Account)**: [Tài khoản ngân hàng](/docs/v13/user/manual/en/accounts/bank-account) của Công ty bạn.
* **Tài khoản ngân hàng Đối tác (Party Bank Account)**: [Tài khoản ngân hàng](/docs/v13/user/manual/en/accounts/bank-account) của Đối tác.
...
* **Tài khoản chi thanh toán (Account Paid From)**: [Tài khoản](/docs/v13/user/manual/en/accounts/chart-of-accounts) mà số tiền sẽ bị trừ đi khi Thanh toán được Xác nhận.
* **Tài khoản nhận thanh toán (Account Paid To)**: [Tài khoản CoA](/docs/v13/user/manual/en/accounts/chart-of-accounts) mà số tiền sẽ được cộng vào khi Bút toán thanh toán được Xác nhận.

* **Tiền tệ tài khoản (Account Currency)**: Tiền tệ của các tài khoản này sẽ được lấy theo thiết lập trong [Tài khoản](/docs/v13/user/manual/en/accounts/chart-of-accounts) và không thể chỉnh sửa tại đây. Để biết thêm về các giao dịch bằng nhiều loại tiền tệ, hãy [truy cập trang này](/docs/v13/user/manual/en/accounts/articles/managing-transactions-in-multiple-currency).
