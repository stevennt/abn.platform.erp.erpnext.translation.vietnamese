...
Trong Bán hàng:
![Payment Sales](https://docs.erpnext.com/docs/v13/assets/img/accounts/pe-sales.png)

Trong Mua hàng:
![Payment Purchase](https://docs.erpnext.com/docs/v13/assets/img/accounts/pe-purchase.png)
...
![Payment Entry from Sales Invoice](https://docs.erpnext.com/docs/v13/assets/img/accounts/payment-entry-button-in-sales-invoice.png)
...
1. Lưu và Xác nhận.
 ![Payment Entry from SO](https://docs.erpnext.com/docs/v13/assets/img/accounts/payment-entry-from-invoice.gif)
...
![Payment Party](https://docs.erpnext.com/docs/v13/assets/img/accounts/payment-from-to.png)
...
![Payment Accounts](https://docs.erpnext.com/docs/v13/assets/img/accounts/payment-accounts.png)
