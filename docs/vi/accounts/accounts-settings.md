...
![Account Settings](https://docs.erpnext.com/docs/v13/assets/img/accounts/account-settings.png)
...
![Account Settings](https://docs.erpnext.com/docs/v13/assets/img/accounts/print-accounts-settings.png)
