...
![Journal Entry Template](/docs/v13/assets/img/accounts/journal-entry-template.png)
  ...
  2. Thêm các chi tiết sau:
      ...
      * **Entry Type**: Bạn có thể chọn từ [các loại bút toán có sẵn trong Bút toán](/docs/v13/user/manual/en/accounts/journal-entry#3-journal-entry-types) tại đây. Giá trị mặc định là [Bút toán](/docs/v13/user/manual/en/accounts/journal-entry#31-journal-entry).
        * Có 3 'Entry Type' đặc biệt ở đây:
          * [Opening Entry](/docs/v13/user/manual/en/accounts/journal-entry#311-opening-entry): Loại này sẽ lấy tất cả các tài khoản và tải chúng vào bảng "Accounting Entries". Để tìm hiểu thêm, hãy truy cập trang [Opening Balance](/docs/v13/user/manual/en/accounts/opening-balance).
          * [Bank Entry](/docs/v13/user/manual/en/accounts/journal-entry#33-bank-entry): Loại này sẽ lấy và tải Tài khoản Ngân hàng mặc định nếu đã được thiết lập.
          * [Cash Entry](/docs/v13/user/manual/en/accounts/journal-entry#34-cash-entry): Loại này sẽ lấy và tải Tài khoản Tiền mặt mặc định nếu đã được thiết lập.
  ...
  3. Lưu và đi đến [Journal Entry](/docs/v13/user/manual/en/accounts/journal-entry#1-how-to-create-a-journal-entry) và nhấn vào mới.
