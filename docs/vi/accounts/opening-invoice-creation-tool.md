...
3. Đánh dấu vào ô "Create Missing Party" sẽ tự động tạo khách hàng hoặc nhà cung cấp nếu chưa có dựa trên tên được cung cấp trong cột Đối tác (Party).
    ...
    <img class="screenshot" alt="Opening Invoice Creation Tool" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/setup/opening-invoice-creation-tool.png">
