...
> Để biết thêm chi tiết về Tài sản, [vui lòng truy cập trang này](/docs/v13/user/manual/en/asset/asset).

Tạo bản ghi Tài sản cho từng tài sản mà công ty bạn sở hữu mà chưa khấu hao hết.

Để tạo một Tài sản mới:

1. Tạo một [Mặt hàng](/docs/v13/user/manual/en/stock/item) với tùy chọn 'Is fixed Asset' được bật.
