...
Bạn có thể xác định [Mẫu Thuế](/docs/v13/user/manual/en/setting-up/setting-up-taxes.html) nào phải được áp dụng cho giao dịch Bán hàng / Mua hàng bằng cách sử dụng Quy tắc Thuế. Điều này được quyết định bởi các yếu tố khác nhau như Khách hàng, Nhóm khách hàng, Nhà cung cấp, Nhóm nhà cung cấp, Mặt hàng, Nhóm mặt hàng hoặc sự kết hợp của các yếu tố này.
...
1. [Mẫu Thuế và Phí Bán hàng](/docs/v13/user/manual/en/selling/sales-taxes-and-charges-template)
...
Bạn có thể liệt kê các Mặt hàng trực tuyến bằng mô-đun Website. Việc chọn 'Use for Shopping Cart' sẽ sử dụng Quy tắc Thuế này cho cả các giao dịch trong Giỏ hàng. Để biết thêm, hãy truy cập trang [Giỏ hàng](/docs/v13/user/manual/en/website/shopping-cart).

> Lưu ý: Khuyến nghị không sử dụng Mẫu Bán hàng/Mua hàng đã chọn ở đây trong [Mẫu Thuế Mặt hàng](/docs/v13/user/manual/en/accounts/item-tax-template), vì nó có thể gây xung đột. Nếu bạn muốn sử dụng cùng mức thuế cho Quy tắc Thuế và Mẫu Thuế Mặt hàng, hãy sử dụng một tên khác cho các Mẫu Thuế Bán hàng/Mua hàng.
...
Việc thiết lập Danh mục Thuế cho phép áp dụng nhiều Quy tắc Thuế vào một giao dịch dựa trên các yếu tố khác nhau. Để biết thêm, hãy truy cập trang [Danh mục Thuế](/docs/v13/user/manual/en/accounts/tax-category).
...
1. [Quy tắc định giá](/docs/v13/user/manual/en/accounts/pricing-rule)
1. [Mẫu Thuế Mặt hàng](/docs/v13/user/manual/en/accounts/item-tax-template)
1. [Danh mục Thuế](/docs/v13/user/manual/en/accounts/tax-category)
