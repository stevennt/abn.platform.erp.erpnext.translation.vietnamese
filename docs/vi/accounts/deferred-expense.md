...
![Item With Deferred Expense](https://docs.erpnext.com/docs/v13/assets/img/accounts/deferred-item-expense.png)
...
![Invoice With Deferred Expense](https://docs.erpnext.com/docs/v13/assets/img/accounts/deferred-purchase-invoice.gif)
