...
1. Thao tác này sẽ tự động lấy tỷ giá hối đoái mới nếu chưa được thiết lập trong DocType Currency Exchange cho loại tiền tệ đó, nếu không nó sẽ lấy 'Exchange Rate' được thiết lập trong DocType [Currency Exchange](/docs/v13/user/manual/en/accounts/currency-exchange).
