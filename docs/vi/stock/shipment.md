...
* Công ty và [Địa chỉ](../CRM/address.md) của Khách hàng đã được thiết lập Mã bưu điện, Địa chỉ Email và Số điện thoại.
* [Liên hệ](../CRM/contact.md) của Khách hàng.
...
1. Đi tới danh sách Shipment, nhấn vào New.
 ...
 <img class="screenshot" alt="Unsaved Shipment" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/stock/unsaved-shipment.png">
...
1. Lưu và Xác nhận.
 ...
 <img class="screenshot" alt="Submitted Shipment" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/stock/shipment-submitted.png">
...
1. Nhấp vào **Create** > **Shipment** trong Phiếu giao hàng.
 ...
 <img class="screenshot" alt="Submitted Shipment" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/stock/shipment-from-delivery-note.png">
...
Để tự động lấy các kích thước kiện hàng thường xuyên sử dụng, một Mẫu kiện hàng (Parcel Template) có thể được tạo và thiết lập trong trường **Parcel Template**. Sau khi thêm mẫu, hãy nhấp vào nút **Add template**.
 ...
 <img class="screenshot" alt="Submitted Shipment" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/stock/shipment-parcel.png">
...
Bạn cũng có thể tự động hóa việc so sánh giá cước, tạo nhãn, theo dõi, v.v. bằng cách sử dụng [Tích hợp vận chuyển](../erpnext_integration/erpnext_shipping.md) của chúng tôi.
