...
* Công ty và [Địa chỉ](/docs/v13/user/manual/en/CRM/address) của Khách hàng đã được thiết lập Mã bưu điện, Địa chỉ Email và Số điện thoại.
* [Liên hệ](/docs/v13/user/manual/en/CRM/contact) của Khách hàng.
...
Bạn cũng có thể tự động hóa việc so sánh giá cước, tạo nhãn, theo dõi, v.v. bằng cách sử dụng [Tích hợp vận chuyển](/docs/v13/user/manual/en/erpnext_integration/erpnext_shipping) của chúng tôi.

### 4. Các chủ đề liên quan
1. [Phiếu giao hàng](/docs/v13/user/manual/en/stock/delivery-note)
1. [Phiếu đóng gói](/docs/v13/user/manual/en/stock/packing-slip)