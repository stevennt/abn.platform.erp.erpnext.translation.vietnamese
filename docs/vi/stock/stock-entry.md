...
1. Lưu và Xác nhận.
    ...
    <img class="screenshot" alt="Stock Entry" src="https://docs.erpnext.com/docs/v13/assets/img/stock/stock-entry.png">
...
![Stock Entry Type](https://docs.erpnext.com/docs/v13/assets/img/stock/stock-entry-type.png)
...
<img class="screenshot" alt="Stock Entry Additional Costs" src="https://docs.erpnext.com/docs/v13/assets/img/stock/additional-costs-table.png">
...
<img class="screenshot" alt="Stock Entry Item Valuation Rate" src="https://docs.erpnext.com/docs/v13/assets/img/stock/stock-entry-item-valuation-rate.png">
