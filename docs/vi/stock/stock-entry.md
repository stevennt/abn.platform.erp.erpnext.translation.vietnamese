...
* **Chuyển vật tư để sản xuất (Material Transfer for Manufacturing)**: Nếu nguyên vật liệu được chuyển để sản xuất. Việc chuyển hàng có thể thực hiện dựa trên một [Lệnh sản xuất](/docs/v13/user/manual/en/manufacturing/work-order) hoặc một [Thẻ công việc](/docs/v13/user/manual/en/manufacturing/job-card). Để biết thêm, hãy truy cập trang [Định mức nguyên vật liệu](/docs/v13/user/manual/en/manufacturing/bill-of-materials).
* **Tiêu hao vật tư để sản xuất (Material Consumption for Manufacture)**: Có thể có nhiều phiếu kho tiêu hao cho một Lệnh sản xuất. [Tham khảo liên kết này để biết thêm chi tiết](/docs/v13/user/manual/en/manufacturing/articles/material_consumption)
...
* **Gửi cho bên gia công (Send to Subcontractor)**: Nếu Vật tư được xuất cho một hoạt động gia công ngoài. Phiếu này được lập từ một Đơn mua hàng. Để biết thêm, hãy truy cập trang [gia công](/docs/v13/user/manual/en/manufacturing/subcontracting).

Để biết thêm chi tiết về các loại mục đích phiếu kho, [hãy truy cập trang này](/docs/v13/user/manual/en/stock/articles/stock-entry-purpose).
...
Phiếu kho cho mục đích Sản xuất thường được tạo từ một [Lệnh sản xuất](/docs/v13/user/manual/en/manufacturing/work-order). Để tạo Phiếu kho thủ công cho các mục đích khác, hãy làm theo các bước sau:
...
* **Yêu cầu kiểm tra (Inspection Required)**: Nếu cần thực hiện [Kiểm tra chất lượng](/docs/v13/user/manual/en/stock/quality-inspection) đối với các Mặt hàng trước khi Xác nhận Phiếu kho.
...
Bạn có thể gắn thẻ các giao dịch khác nhau dựa trên các chiều khác nhau. Theo mặc định, [Dự án](/docs/v13/user/manual/en/projects/project) có thể được coi là một chiều vì đây là một thực hành phổ biến để theo dõi chi phí của các dự án khác nhau. Để biết thêm về Chiều kế toán, [hãy truy cập trang này](/docs/v13/user/manual/en/accounts/accounting-dimensions).

### 3.4 Cài đặt in

#### Tiêu đề thư (Letterhead)
Bạn có thể in Phiếu nhập hàng trên tiêu đề thư của công ty mình. Tìm hiểu thêm [tại đây](/docs/v13/user/manual/en/setting-up/print/letter-head).
