...
1. Lưu và Xác nhận.
    ...
    <img class="screenshot" alt="Stock Entry" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/stock/stock-entry.png">
...
![Stock Entry Type](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/stock/stock-entry-type.png)
...
<img class="screenshot" alt="Stock Entry Additional Costs" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/stock/additional-costs-table.png">
...
<img class="screenshot" alt="Stock Entry Item Valuation Rate" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/stock/stock-entry-item-valuation-rate.png">

### 3.3 Chiều kế toán (Accounting Dimensions)
Bạn có thể gắn thẻ các giao dịch khác nhau dựa trên các chiều khác nhau. Theo mặc định, [Dự án](../projects/project.md) có thể được coi là một chiều vì đây là một thực hành phổ biến để theo dõi chi phí của các dự án khác nhau. Để biết thêm về Chiều kế toán, [hãy truy cập trang này](../accounts/accounting-dimensions.md).

### 3.4 Cài đặt in

#### Tiêu đề thư (Letterhead)
Bạn có thể in Phiếu nhập hàng trên tiêu đề thư của công ty mình. Tìm hiểu thêm [tại đây](../setting-up/print/letter-head.md).
