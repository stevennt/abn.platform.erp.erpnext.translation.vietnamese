...
Theo mặc định, Tên Mặt hàng được đặt theo Mã Mặt hàng đã nhập. Nếu bạn muốn các Mặt hàng được đặt tên theo một [Chuỗi đặt tên](/docs/v13/user/manual/en/setting-up/settings/naming-series) nhất định, hãy chọn tùy chọn 'Naming Series'.


## 2. Các giá trị mặc định

### 2.1 Nhóm mặt hàng mặc định
Đây sẽ là Nhóm mặt hàng mặc định được gán cho một mặt hàng mới được tạo. Các Nhóm mặt hàng rất hữu ích để phân loại và thiết lập các thuộc tính cho toàn bộ nhóm. Để biết thêm, hãy truy cập trang [Nhóm mặt hàng](/docs/v13/user/manual/en/stock/item-group).
...
### 2.4 Kho lưu mẫu
Đây là Kho nơi lưu trữ các mẫu lưu. Để biết thêm, hãy truy cập [trang này](/docs/v13/user/manual/en/stock/retain-sample-stock).
...
Một [Yêu cầu vật tư](/docs/v13/user/manual/en/stock/material-request) sẽ được tạo tự động khi kho đạt đến mức đặt hàng lại được xác định trong [biểu mẫu Mặt hàng](/docs/v13/user/manual/en/stock/item#34-automatic-reordering).
