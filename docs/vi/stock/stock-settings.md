...
![Stock Settings](https://docs.erpnext.com/docs/v13/assets/img/stock/stock-settings-1.png)
...
Thiết lập Kho mặc định nơi thực hiện các giao dịch kho. Giá trị này sẽ được lấy vào mục Kho mặc định trong danh mục Mặt hàng:
    ![Stock Settings](https://docs.erpnext.com/docs/v13/assets/img/stock/stock-settings-def.png)
...
![Stock Settings](https://docs.erpnext.com/docs/v13/assets/img/stock/stock-settings-2.png)
...
![Stock Settings](https://docs.erpnext.com/docs/v13/assets/img/stock/stock-settings-3.png)
...
<img class="screenshot" alt="Delivery Note Material Transfer" src="https://docs.erpnext.com/docs/v13/assets/img/stock/inter-warehouse.png">
