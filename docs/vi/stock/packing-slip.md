...
* Nếu đây là Mặt hàng theo Lô hàng, bạn sẽ phải chọn Số lô.
...
### 2.3 Tiêu đề thư
Bạn có thể in Phiếu đóng gói trên tiêu đề thư của công ty mình. Tìm hiểu thêm [tại đây](/docs/v13/user/manual/en/setting-up/print/letter-head).


### 2. Các chủ đề liên quan
1. [Kiểm tra chất lượng](/docs/v13/user/manual/en/stock/quality-inspection)
