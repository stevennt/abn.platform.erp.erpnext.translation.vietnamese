...
![Delivery Note flow](https://docs.erpnext.com/docs/v13/assets/img/stock/delivery-note-flow.png)
...
1. Lưu và Xác nhận.
    ...
    <img class="screenshot" alt="Delivery Note" src="https://docs.erpnext.com/docs/v13/assets/img/stock/delivery-note.png">
...
[Contacts](https://docs.erpnext.com/docs/v13/user/manual/en/CRM/contact) và [Addresses](https://docs.erpnext.com/docs/v13/user/manual/en/CRM/address) được lưu trữ riêng biệt để bạn có thể đính kèm nhiều Liên hệ hoặc Địa chỉ cho khách hàng.
