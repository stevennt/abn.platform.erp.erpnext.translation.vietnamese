...
![Delivery Note flow](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/stock/delivery-note-flow.png)
...
> Lưu ý: Từ phiên bản 13 trở đi, chúng tôi đã giới thiệu sổ cái bất biến (immutable ledger), điều này thay đổi các quy tắc về việc hủy các phiếu kho và ghi sổ các giao dịch kho lùi ngày trong ERPNext. [Tìm hiểu thêm tại đây](../accounts/articles/immutable-ledger-in-erpnext.md).
...
1. Lưu và Xác nhận.
    ...
    <img class="screenshot" alt="Delivery Note" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/stock/delivery-note.png">
...
[Contacts](../CRM/contact.md) và [Addresses](../CRM/address.md) được lưu trữ riêng biệt để bạn có thể đính kèm nhiều Liên hệ hoặc Địa chỉ cho khách hàng.
...
* **Batch No và Serial No**: Nếu Mặt hàng của bạn được quản lý theo số lô hoặc số serial, bạn sẽ phải nhập [Số serial](