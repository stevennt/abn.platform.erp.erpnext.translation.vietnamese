...
Truy cập trang [Bảng giá](/docs/v13/user/manual/en/stock/price-lists) để biết thêm chi tiết.
...
1. [Áp dụng Chiết khấu](/docs/v13/user/manual/en/selling/articles/applying-discount)