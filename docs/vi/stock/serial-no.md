...
* Bật 'Has Serial No' trong danh mục Mặt hàng
    ![Serial No Enabled](https://docs.erpnext.com/docs/v13/assets/img/stock/serial-no-enabled.png)
...
![Serial No Created](https://docs.erpnext.com/docs/v13/assets/img/stock/serial-no-created.png)
...
<img class="screenshot" alt="Serial Number" src="https://docs.erpnext.com/docs/v13/assets/img/stock/serial-no.png">
