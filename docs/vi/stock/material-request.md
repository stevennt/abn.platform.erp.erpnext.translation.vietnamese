...
* **Khách hàng cung cấp**: Nếu vật tư được yêu cầu sẽ do Khách hàng cung cấp. Để biết thêm về điều này, hãy truy cập trang [Mặt hàng do Khách hàng cung cấp](/docs/v13/user/manual/en/manufacturing/articles/customer-provided-items).
...
* Từ một [Đơn bán hàng](/docs/v13/user/manual/en/selling/sales-order).
* Khi Số lượng dự kiến của một Mặt hàng trong Kho đạt đến một mức nhất định.
* Từ [Kế hoạch sản xuất](/docs/v13/user/manual/en/manufacturing/production-plan) để lập kế hoạch cho các hoạt động sản xuất của bạn.

Nếu các Mặt hàng của bạn là hàng tồn kho, bạn cũng phải nêu rõ Kho nơi bạn mong muốn các Mặt hàng này được giao đến. Điều này giúp theo dõi [Số lượng dự kiến](/docs/v13/user/manual/en/stock/projected-quantity) cho Mặt hàng này.
...
## 2. Các tính năng
### 2.1 Bảng Mặt hàng
* **Mã vạch**: Bạn có thể theo dõi các Mặt hàng bằng [mã vạch](/docs/v13/user/manual/en/stock/articles/track-items-using-barcode).

* Mã Mặt hàng, tên, mô tả, Hình ảnh và Nhà sản xuất sẽ được lấy từ danh mục Mặt hàng.

* **Quét mã vạch**: Bạn có thể thêm các Mặt hàng vào bảng Mặt hàng bằng cách quét mã vạch của chúng nếu bạn có máy quét mã vạch. Đọc tài liệu về [theo dõi mặt hàng bằng mã vạch](/docs/v13/user/manual/en/stock/articles/track-items-using-barcode) để biết thêm chi tiết.

* Đơn vị tính, Hệ số chuyển đổi và Số tiền sẽ được tự động lấy. Bạn có thể thay đổi Kho nơi vật tư đang được yêu cầu.

* Các chi tiết kế toán như Tài khoản chi phí và Chiều kích thước kế toán có thể được thiết lập cho các Mặt hàng.
...
Đọc [tài liệu về Tiêu đề thư](/docs/v13/user/manual/en/setting-up/print/letter-head) để tìm hiểu thêm.

#### Tiêu đề in
Tiêu đề Phiếu nhập hàng cũng có thể được thay đổi khi in tài liệu. Bạn có thể thực hiện việc này bằng cách chọn **Tiêu đề in**. Để tạo Tiêu đề in mới, hãy đi đến: Trang chủ > Thiết lập > In ấn > Tiêu đề in. Tìm hiểu thêm [tại đây](/docs/v13/user/manual/en/setting-up/print/print-headings).
...
* [Yêu cầu báo giá](/docs/v13/user/manual/en/buying/request-for-quotation)
* [Đơn mua hàng](/docs/v13/user/manual/en/buying/purchase-order)
* [Báo giá của Nhà cung cấp](/docs/v13/user/manual/en/buying/supplier-quotation)
...
Yêu cầu vật tư có thể được tạo tự động bằng cách bật thiết lập trong [Thiết lập kho](/docs/v13/user/manual/en/stock/stock-settings#9-automatic-material-request) và thiết lập mức độ trong [biểu mẫu Mặt hàng](/docs/v13/user/manual/en/s