...
Mã vạch có thể được ghi lại trong Mặt hàng để quét nhanh và thêm chúng vào các giao dịch. Trong bảng Mã vạch, bạn có thể thêm [mã vạch để quét](articles/track-items-using-barcode.md) của một Mặt hàng. Có hai loại mã vạch trong ERPNext:
...
* **Hạn sử dụng (ngày)**: Dành cho sản phẩm theo [Lô hàng](batch.md). Số ngày mà sau đó lô sản phẩm sẽ không còn sử dụng được nữa. Ví dụ: thuốc.
...
* **Phương pháp tính giá**: Chọn Phương pháp tính giá là FIFO hoặc Bình quân gia quyền. Đọc [Phương pháp tính giá Mặt hàng](articles/item-valuation-fifo-and-moving-average.md) để biết thêm chi tiết.

### 3.4 Tự động đặt hàng lại
Khi tồn kho của một mặt hàng giảm xuống dưới một số lượng nhất định, bạn có thể thiết lập đặt hàng lại tự động trong phần 'Tự động đặt hàng lại'. Tính năng này phải được bật trong [Cài đặt kho](stock-settings.md#9-automatic-material-request). Việc này sẽ tạo một [Yêu cầu vật tư](material-request.md) cho Mặt hàng. Người dùng có vai trò Quản lý mua hàng và Quản lý kho sẽ được **thông báo** khi Yêu cầu vật tư được tạo.
...
1. [Giá trị tồn kho Mặt hàng theo FIFO và Bình quân gia quyền di động](articles/item-valuation-fifo-and-moving-average.md)
1. [Các giao dịch Giá trị tồn kho Mặt hàng](articles/item-valuation-transactions.md)
1. [Duy trì trường Tồn kho bị khóa trong Danh mục Mặt hàng](articles/maintain-stock-field-frozen-in-item-master.md)
...
1. [Tạo Khấu hao cho Mặt hàng](articles/creating-depreciation-for-item.md)
