...
Một Chuyến giao hàng có thể được tạo từ [Phiếu giao hàng](/docs/v13/user/manual/en/stock/delivery-note) bằng cách nhấp vào 'Create > Delivery Trip'.
...
1. [Quy tắc vận chuyển](/docs/v13/user/manual/en/selling/shipping-rule)