...
<img alt="Material Transfer" class="screenshot" src="https://docs.erpnext.com/docs/v13/assets/img/articles/barcode-item-master.png">
...
<img alt="Material Transfer" class="screenshot" src="https://docs.erpnext.com/docs/v13/assets/img/articles/barcode-item-selection.gif">
...
![Item Barcode using Smartphone](https://docs.erpnext.com/docs/v13/assets/img/articles/item-barcode-phone.gif)