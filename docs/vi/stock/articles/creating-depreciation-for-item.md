...
**Trả lời:** Bạn có thể hạch toán bút toán khấu hao tài sản cho mặt hàng tài sản cố định thông qua Phiếu Đối chiếu tồn kho [/docs/v13/user/manual/en/stock/opening-stock.html].
