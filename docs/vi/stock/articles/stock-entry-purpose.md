...
Giao dịch gia công bao gồm việc công ty chuyển các mặt hàng nguyên vật liệu sang kho của bên gia công. Việc này cũng yêu cầu phải thêm một kho cho bên gia công. Phiếu Gia công sẽ chuyển kho từ kho của công ty sang kho của bên gia công. [Xem trang này để biết thêm về Gia công](https://docs.erpnext.com/docs/v13/user/manual/en/manufacturing/subcontracting.html).
