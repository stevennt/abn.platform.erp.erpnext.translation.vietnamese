...
1. Lưu và Xác nhận.
    ...
    <img class="screenshot" alt="Landed Cost Voucher" src="https://docs.erpnext.com/docs/v13/assets/img/stock/landed-cost-voucher.png">
...
<img class="screenshot" alt="Landed Cost Voucher" src="https://docs.erpnext.com/docs/v13/assets/img/stock/landed-cost-distribution.png">
