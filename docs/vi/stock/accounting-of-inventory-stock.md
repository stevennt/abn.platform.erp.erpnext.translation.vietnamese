...
Giá trị của hàng tồn kho hiện có được coi là Tài sản ngắn hạn trong [Hệ thống tài khoản](/docs/v13/user/manual/en/accounts/chart-of-accounts) của công ty. Để lập Bảng cân đối kế toán, bạn nên thực hiện các bút toán kế toán cho các tài sản đó. Thông thường có hai phương pháp kế toán hàng tồn kho khác nhau.

## 1. Kiểm kê thường xuyên (Auto/Perpetual Inventory)

Trong quy trình này, đối với mỗi giao dịch kho, hệ thống sẽ ghi các bút toán kế toán liên quan để đồng bộ số dư kho và số dư kế toán. Đây là thiết lập mặc định trong ERPNext cho các tài khoản mới. Theo mặc định, Kiểm kê thường xuyên được bật trong [Công ty](/docs/v13/user/manual/en/setting-up/company-setup#23-stock-settings).
...
Đọc [tài liệu về Kiểm kê thường xuyên](/docs/v13/user/manual/en/stock/perpetual-inventory) để kiểm tra các bút toán kế toán cho một giao dịch kho cụ thể.
...
Nếu bạn là người dùng hiện tại đang sử dụng Kiểm kê định kỳ và muốn sử dụng Kiểm kê thường xuyên, bạn cần thực hiện [một vài bước](/docs/v13/user/manual/en/stock/articles/migrate-to-perpetual-inventory) để chuyển đổi.

### 3. Các chủ đề liên quan
1. [Kiểm kê thường xuyên](/docs/v13/user/manual/en/stock/perpetual-inventory)
1. [Chuyển đổi sang Kiểm kê thường xuyên](/docs/v13/user/manual/en/stock/articles/migrate-to-perpetual-inventory)