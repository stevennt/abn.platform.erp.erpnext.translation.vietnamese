...
* **Bật Tiêu chí Kiểm tra chất lượng trong danh mục Mặt hàng**. Khi bật một trong hai ô đánh dấu, việc **Xác nhận** chứng từ giao/nhận kho sẽ chỉ được cho phép sau khi việc Kiểm tra chất lượng đối với chứng từ đó đã được thực hiện:
    ![Enable Quality Inspection](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/stock/quality-inspection-pre-requisite.png)
* (Tùy chọn) **Tạo Mẫu Kiểm tra chất lượng**. Bạn có thể thêm các thông số kiểm tra và tiêu chí chấp nhận vào mẫu, các thông tin này có thể dễ dàng được lấy vào bất kỳ bản Kiểm tra chất lượng nào. Sau khi Lưu mẫu, bạn có thể thiết lập mẫu này trong danh mục Mặt hàng (như hiển thị ở trên).
    ![Quality Inspection Template](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/stock/quality-inspection-template.png)
...
<img class="screenshot" alt="Quality Inspection" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/stock/quality-inspection-1.png">
...
<img class="screenshot" alt="Numeric Quality Check" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/stock/quality-inspection-numeric-reading.png">
...
<img class="screenshot" alt="Non-numeric Quality Check" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/stock/quality-inspection-non-numeric-reading.png">
...
<img class="screenshot" alt="Acceptance Criteria Formula" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/stock/acceptance-criteria-formula.png">
