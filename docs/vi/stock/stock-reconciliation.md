...
1. Lưu và Xác nhận.
    ...
    ![Opening Stock](https://docs.erpnext.com/docs/v13/assets/img/stock/opening_stock.png)
...
1. Lưu và Xác nhận.
    ...
    ![Stock Reconciliation](https://docs.erpnext.com/docs/v13/assets/img/stock/stock_recon.png)
...
1. Tải xuống Mẫu (Template)
  ...
  <img class="screenshot" alt="Stock Reconciliation" src="https://docs.erpnext.com/docs/v13/assets/img/stock/stock-recon-1.png">
...
2. Nhập dữ liệu vào mẫu CSV.
  ...
  <img class="screenshot" alt="Stock Reconciliation" src="https://docs.erpnext.com/docs/v13/assets/img/stock/stock-reco-data.png">


3. Tải tệp CSV có chứa dữ liệu lên bằng cách nhấn vào nút 'Upload'.

  <img class="screenshot" alt="Stock Reconciliation" src="https://docs.erpnext.com/docs/v13/assets/img/stock/stock-recon-2.png">


4. Xem lại, Lưu và Xác nhận.

  <img class="screenshot" alt="Stock Reconciliation" src="https://docs.erpnext.com/docs/v13/assets/img/stock/stock-reco-upload.gif">

5. Kiểm tra Báo cáo Sổ cái kho (Stock Ledger Report) để xem số dư tồn kho đã được cập nhật.

  <img class="screenshot" alt="Stock Reconciliation" src="https://docs.erpnext.com/docs/v13/assets/img/stock/stock-reco-ledger.png">
...
<img class="screenshot" alt="Stock Reconciliation Items Button" src="https://docs.erpnext.com/docs/v13/assets/img/stock/stock_reconciliation_items_button.gif">
