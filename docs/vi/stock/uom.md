...
Trong UoM có một tùy chọn 'Must be Whole Number' (Phải là số nguyên). Nếu tùy chọn này được chọn, bạn không thể sử dụng các số phân số trong UoM này. Để biết thêm về phân số và UoM, hãy xem [trang này](/docs/v13/user/manual/en/stock/articles/managing-fractions-in-uom).
