...
4. Tại mục Calculate Based On, bạn cũng có thể thay đổi cơ sở tính toán mà Quy tắc vận chuyển sẽ được áp dụng như tổng ròng số lượng hoặc tổng ròng trọng lượng, mặc định là "Fixed".
5. Lưu.

    <img class="screenshot" alt="Shipping Rule" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/selling/shipping-rule.png">
