...
Nếu bạn muốn áp dụng chiết khấu (dưới dạng Phần trăm) thường xuyên cho một số lượng nhất định, bạn nên sử dụng "Quy tắc định giá". Hãy đọc tài liệu [Pricing Rule](/docs/v13/user/manual/en/accounts/pricing-rule) để tìm hiểu thêm.
