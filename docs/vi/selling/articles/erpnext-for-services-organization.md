...
![Service Item](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/selling/service-item.png)
...
ERPNext là một hệ thống được kiểm soát bằng quyền hạn. Người dùng truy cập hệ thống dựa trên các quyền được gán cho họ. Vì vậy, nếu người dùng không được gán Vai trò liên quan đến phân hệ Kho và Sản xuất, nó sẽ bị ẩn khỏi Người dùng đó. [Nhấp vào đây để tìm hiểu thêm về quản lý quyền hạn.](../../setting-up/users-and-permissions.html.md).
