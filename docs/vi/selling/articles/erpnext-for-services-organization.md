...
[Để tìm hiểu thêm về Thiết lập Tính năng, hãy nhấp vào đây.](/docs/v13/user/manual/en/customize-erpnext/hiding-modules-and-features).

####Quyền hạn

ERPNext là một hệ thống được kiểm soát bằng quyền hạn. Người dùng truy cập hệ thống dựa trên các quyền được gán cho họ. Vì vậy, nếu người dùng không được gán Vai trò liên quan đến phân hệ Kho và Sản xuất, nó sẽ bị ẩn khỏi Người dùng đó. [Nhấp vào đây để tìm hiểu thêm về quản lý quyền hạn.](/docs/v13/user/manual/en/setting-up/users-and-permissions.html).
