...
1. Lưu.
    ...
    ![Brand](https://docs.erpnext.com/docs/v13/assets/img/selling/brand.png)

Giờ đây Thương hiệu này có thể được liên kết với các Mặt hàng khác nhau.

![Brand in Item](https://docs.erpnext.com/docs/v13/assets/img/selling/brand-in-item.png)

## 2. Các tính năng
### 2.1 Thiết lập mặc định cho các Mặt hàng thuộc Thương hiệu này

![Brand Defaults](https://docs.erpnext.com/docs/v13/assets/img/selling/brand-defaults.png)
