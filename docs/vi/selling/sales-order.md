...
1. Với Loại đơn hàng (Order Type), bạn có thể thiết lập đó là Đơn bán hàng, Đơn bảo trì, hoặc từ [Giỏ hàng](/docs/v13/user/manual/en/website/shopping-cart) trực tuyến của trang web. Theo mặc định, giá trị này được đặt là "Sales".
...
Để cho phép các Quy tắc định giá theo từng Khách hàng, từng Mặt hàng ("Khách hàng A" trả 1,00 $ cho "Mặt hàng 1" nhưng "Khách hàng B" trả 1,25 $ cho "Mặt hàng 1"), có một hộp kiểm gọi là 'Allow User to Edit Price List Rate in Transaction' trong [Cài đặt bán hàng](/docs/v13/user/manual/en/selling/selling-settings). Điều này cho phép lưu giá mặt hàng cụ thể cho từng khách hàng khi bạn thay đổi giá trong Đơn bán hàng.

## 3. Các tính năng

### 3.1 Tiền tệ và Bảng giá
Bạn có thể thiết lập tiền tệ mà báo giá/đơn bán hàng sẽ được gửi đi. Nếu bạn thiết lập một Bảng giá, thì giá mặt hàng sẽ được lấy từ bảng đó. Việc tích vào 'Ignore Pricing Rule' sẽ bỏ qua các [Quy tắc định giá](/docs/v13/user/manual/en/accounts/pricing-rule) đã được thiết lập trong Accounts > Pricing Rule.
...
* **Ngày giao hàng cho từng mặt hàng**: Nếu có nhiều mặt hàng và nếu bạn nhập ngày giao hàng ở dòng đầu tiên, ngày đó cũng sẽ được sao chép sang các dòng khác nếu chúng đang để trống. Bạn sẽ phải thiết lập các ngày này nếu không thiết lập chung ở phía trên của Đơn bán hàng.
    ...
    Bạn cũng có thể thêm Mặt hàng vào bảng Mặt hàng bằng cách quét mã vạch nếu bạn có máy quét mã vạch. Đọc tài liệu về [theo dõi mặt hàng bằng mã vạch](/docs/v13/user/manual/en/stock/articles/track-items-using-barcode) để biết thêm.
...
* **Lập kế hoạch**: Đọc về [Số lượng dự kiến](/docs/v13/user/manual/en/stock/projected-quantity) để biết về các trường trong phần lập kế hoạch.

Các trường khác trong bảng mặt hàng tương tự như đã được giải thích trong [Báo giá](/docs/v13/user/manual/en/selling/quotation#23-the-items-table).

### 3.3 Phiếu đóng gói

Mục này được liên kết với [Gói sản phẩm](/docs/v13/user/manual/en/selling/product-bundle) và chỉ xuất hiện khi giao dịch có liên quan đến một gói sản phẩm.
...
### 3.4 Thuế và Phí
Để thêm thuế vào Báo giá, bạn có thể chọn một [Mẫu thuế và phí bán hàng](/docs/v13/user/manual/en/selling/sales-taxes-and-charges-template) hoặc thêm thuế theo cách thủ công trong bảng Thuế và phí bán hàng.

Tổng thuế và phí sẽ được hiển thị bên dưới bảng. Nhấp vào Tax Breakup sẽ hiển thị tất cả các thành phần...