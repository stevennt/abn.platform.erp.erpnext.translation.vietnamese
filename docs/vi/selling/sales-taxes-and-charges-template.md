...
Để biết về việc thiết lập thuế, hãy truy cập [trang này](/docs/v13/user/manual/en/setting-up/setting-up-taxes).
...
* **Consider Tax or Charge for (Xét Thuế hoặc Phí cho)**: Total (Tổng) - cho tổng của tất cả các mặt hàng. Valuation (Giá trị) - cho từng mặt hàng. Valuation and total (Giá trị và tổng) - áp dụng thuế/phí cho cả hai. [Xem bài viết này](/docs/v13/user/manual/en/accounts/articles/what-is-the-differences-of-total-and-valuation-in-tax-and-charges) để biết sự khác biệt.
