...
<img class="screenshot" alt="Make Loan Security Unpledge" src="https://docs.erpnext.com/docs/v13/assets/img/loan-management/loan-security-unpledge-flow.png">
...
<img class="screenshot" alt="Loan Application" src="https://docs.erpnext.com/docs/v13/assets/img/loan-management/loan-security-unpledge.png">
...
<img class="screenshot" alt="Loan Application" src="https://docs.erpnext.com/docs/v13/assets/img/loan-management/create-loan-security-unpledge.png">
