...
<img class="screenshot" alt="Make Loan Application" src="https://docs.erpnext.com/docs/v13/assets/img/loan-management/loan-application-flow.png">

Để truy cập danh sách Đơn vay vốn, hãy đi tới:
> Home > Loan Management > Loan > Loan Application


<img class="screenshot" alt="Loan Application" src="https://docs.erpnext.com/docs/v13/assets/img/loan-management/loan-application.png">
...
Một [Cam kết tài sản đảm bảo khoản vay](/docs/v13/user/manual/en/loan-management/loan-security-pledge) dựa trên các tài sản đảm bảo được đề xuất có thể được tạo trực tiếp từ Đơn vay vốn thông qua nút **Create** ở góc trên bên phải. Cam kết tài sản đảm bảo khoản vay này sau đó có thể được thế chấp cho một khoản vay như một Cam kết tài sản đảm bảo khoản vay ban đầu.

<img class="screenshot" alt="Loan Application" src="https://docs.erpnext.com/docs/v13/assets/img/loan-management/create-loan-security-pledge.png">
