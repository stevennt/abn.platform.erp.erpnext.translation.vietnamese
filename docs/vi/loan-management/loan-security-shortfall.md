...
<img class="screenshot" alt="Loan Security Shortfall" src="https://docs.erpnext.com/docs/v13/assets/img/loan-management/loan-security-shortfall-flow.png">
...
<img class="screenshot" alt="Loan Application" src="https://docs.erpnext.com/docs/v13/assets/img/loan-management/loan-security-shortfall.png">
