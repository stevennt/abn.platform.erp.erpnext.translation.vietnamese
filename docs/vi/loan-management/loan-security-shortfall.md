...
<img class="screenshot" alt="Loan Application" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/loan-management/loan-security-shortfall.png">


Một bản ghi Thiếu hụt Tài sản đảm bảo Khoản vay bao gồm các chi tiết về:

  * **Loan**: Khoản vay mà có sự thiếu hụt về tỷ lệ giá trị khoản vay trên tài sản đảm bảo.
