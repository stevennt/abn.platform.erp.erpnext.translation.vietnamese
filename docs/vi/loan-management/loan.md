...
1. Nếu loại người đăng ký là Nhân viên, hãy tích vào "Trả từ Lương" nếu khoản vay sẽ được hoàn trả từ lương.
  ...
  <img class="screenshot" alt="Make Loan" src="https://docs.erpnext.com/docs/v13/assets/img/loan-management/loan-details.png">
...
1. Nhập Loại khoản vay. Tất cả các tài khoản khoản vay, phương thức thanh toán và các chi tiết khoản vay khác như khoản vay có kỳ hạn hay khoản vay theo yêu cầu sẽ được tự động lấy từ danh mục Loại khoản vay. Nếu là khoản vay có kỳ hạn, lịch trình trả nợ sẽ được tự động tạo sau khi Lưu chứng từ khoản vay.
  ...
  <img class="screenshot" alt="Make Loan" src="https://docs.erpnext.com/docs/v13/assets/img/loan-management/loan-accounts.png">

  <img class="screenshot" alt="Make Loan" src="https://docs.erpnext.com/docs/v13/assets/img/loan-management/loan-repayment-schedule.png">
...
<img class="screenshot" alt="Loan Application" src="https://docs.erpnext.com/docs/v13/assets/img/loan-management/create-loan.png">
...
<img class="screenshot" alt="Create Loan Disbursement" src="https://docs.erpnext.com/docs/v13/assets/img/loan-management/create-loan-disbursement.png">
...
<img class="screenshot" alt="Salary Slip Loan" src="https://docs.erpnext.com/docs/v13/assets/img/loan-management/salary-slip-loan.png">
