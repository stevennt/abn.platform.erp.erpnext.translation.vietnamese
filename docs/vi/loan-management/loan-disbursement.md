...
<img class="screenshot" alt="Make Loan Disbursement" src="https://docs.erpnext.com/docs/v13/assets/img/loan-management/loan-disbursement-flow.png">

Để truy cập danh sách Giải ngân khoản vay, hãy đi tới:
> Home > Loan Management > Disbursement and Repayment > Loan Disbursement


<img class="screenshot" alt="Loan Disbursement" src="https://docs.erpnext.com/docs/v13/assets/img/loan-management/loan-disbursement.png">
