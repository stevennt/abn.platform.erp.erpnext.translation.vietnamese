...
<img class="screenshot" alt="Loan Application" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/loan-management/process-loan-interest-accrual.png">

## 1. Điều kiện tiên quyết
Trước khi tạo Quy trình tính lãi vay dồn tích, trước tiên bạn phải tạo:

* [Khoản vay (Loan)](loan.md)
