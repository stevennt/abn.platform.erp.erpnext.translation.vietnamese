...
<img class="screenshot" alt="Make Loan Security Pledge" src="https://docs.erpnext.com/docs/v13/assets/img/loan-management/loan-security-pledge-flow.png">

Để truy cập danh sách Tài sản thế chấp khoản vay, hãy đi tới:
> Home > Loan Management > Loan > Loan Security Pledge


<img class="screenshot" alt="Loan Application" src="https://docs.erpnext.com/docs/v13/assets/img/loan-management/loan-security-pledge.png">
...
2. Hoặc bạn cũng có thể tạo Tài sản thế chấp khoản vay từ [Loan Security Shortfall](/docs/v13/user/manual/en/loan-management/loan-security-shortfall) trong trường hợp thiếu hụt giá trị tài sản thế chấp khoản vay bằng cách nhấn vào nút **Add Loan Security** ở góc trên bên phải

	<img class="screenshot" alt="Loan Application" src="https://docs.erpnext.com/docs/v13/assets/img/loan-management/shortfall-security.png">
