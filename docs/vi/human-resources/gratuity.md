...
Trong ERPNext, bạn có thể quản lý các Khoản thanh toán Trợ cấp thôi việc của nhân viên dựa trên các [Quy tắc trợ cấp thôi việc](/docs/v13/user/manual/en/human-resources/gratuity) khác nhau tùy theo từng khu vực.
...
1. [Quy tắc trợ cấp thôi việc](/docs/v13/user/manual/en/human-resources/gratuity)
...
<img class="screenshot" alt="Gratuity" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/gratuity.png">
...
<img class="screenshot" alt="payment conf via salary slip" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/payment-conf-via-salary-slip.png">
...
<img class="screenshot" alt="gratuity payment via salary slip" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/gratuity-payment-via-salary-slip.png">
...
<img class="screenshot" alt="payment conf via payment entry" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/payment-conf-via-payment-entry.png">
...
<img class="screenshot" alt="gratuity payment via payment entry" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/gratuity-payment-via-payment-entry.png">