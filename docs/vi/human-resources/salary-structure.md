...
* [Thành phần lương](salary-component.md)
...
Để tạo Khoản thu nhập và Khoản khấu trừ, hãy chọn Thành phần lương trong cột Thành phần. Nhập Công thức/Điều kiện nếu chưa được chỉ định trước đó khi tạo [Thành phần lương](salary-component.md). Ngoài ra, bạn cũng có thể nhập một số tiền xác định trước trong cột Số tiền.
...
Trong phần này, [Phương thức thanh toán](../accounts/mode-of-payment.md) và [Tài khoản thanh toán](../accounts/chart-of-accounts.md) được sử dụng để trả lương có thể được chỉ định.
...
Trong trường hợp Nhân viên có các ngày nghỉ có thể quy đổi thành tiền, bạn có thể xác định số tiền quy đổi ngày nghỉ mỗi ngày trong trường này cho Định mức lương cụ thể này. Dựa trên 'Thành phần thu nhập' được thiết lập trong [Loại nghỉ phép](leave-type.md) được quy đổi và số tiền mỗi ngày, giá trị cho Thành phần lương sẽ được tính toán tương ứng trong Phiếu lương.


### 2.5 Phúc lợi tối đa (Số tiền)

Trong trường này, Số tiền Phúc lợi tối đa cho Định mức lương có thể được chỉ định. Nếu trường này được điền, hãy đảm bảo Định mức lương có một [Thành phần lương](salary-component.md) với mục "Is Flexible Benefits" được chọn, mà theo đó số tiền này sẽ được chi trả.



Sau khi tất cả thông tin được lưu và xác nhận, bạn có thể gán Định mức lương cho một Nhân viên thông qua nút **Assign Salary Structure** hoặc bằng cách tạo một [Phân bổ Định mức lương](salary-structure-assignment.md) mới thông qua trang tổng quan.

Bạn cũng có thể gán Định mức lương đã tạo cho nhiều nhân viên dựa trên [Cấp bậc nhân viên](employee-grade.md), [Phòng ban](department.md), [Chức danh](designation.md), v.v. thông qua nút 'Assign to Employees'.
Ngoài ra, Phiếu lương cũng có thể được tạo trực tiếp thông qua trang tổng quan.

## 3. Các chủ đề liên quan

1. [Thành phần lương](salary-component.md)
1. [Phân bổ Định mức lương](salary-structure-assignment.md)
1. [Nhập bảng lương](payroll-entry.md)