...
<img class="screenshot" alt="Salary Structure" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/salary-structure.png">
...
1. Lưu và Xác nhận.
 ...
 <img class="screenshot" alt="Create Salary Slip based on Timesheets" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/salary-structure-for-salary-based-on-timesheets.png">
