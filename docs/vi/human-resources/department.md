...
<img class="screenshot" alt="Department Tree" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/department-tree.png">
...
* [Công ty](/docs/v13/user/manual/en/setting-up/company-setup)
* [Danh sách chặn nghỉ phép](/docs/v13/user/manual/en/human-resources/leave-block-list)
...
1. Lưu.
    ...
    <img class="screenshot" alt="Department" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/department.png">
...
<img class="screenshot" alt="Leave and Expense Approver" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/leave-and-expense.png">
...
1. [Loại hình nhân viên](/docs/v13/user/manual/en/human-resources/employment-type)
1. [Cấp bậc nhân viên](/docs/v13/user/manual/en/human-resources/employee-grade)
1. [Chi nhánh nhân viên](/docs/v13/user/manual/en/human-resources/branch)
1. [Chức danh nhân viên](/docs/v13/user/manual/en/human-resources/designation)