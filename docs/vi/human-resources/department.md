...
<img class="screenshot" alt="Department Tree" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/human-resources/department-tree.png">
...
* [Công ty](../setting-up/company-setup.md)
* [Danh sách chặn nghỉ phép](leave-block-list.md)
...
1. Lưu.
    ...
    <img class="screenshot" alt="Department" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/human-resources/department.png">
...
<img class="screenshot" alt="Leave and Expense Approver" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/human-resources/leave-and-expense.png">
...
1. [Loại hình nhân viên](employment-type.md)
1. [Cấp bậc nhân viên](employee-grade.md)
1. [Chi nhánh nhân viên](branch.md)
1. [Chức danh nhân viên](designation.md)