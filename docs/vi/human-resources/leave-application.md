...
1. Một bảng về Số ngày nghỉ được phân bổ (Allocated Leaves) sẽ được hiển thị. Dựa trên số ngày nghỉ đã sử dụng, số ngày nghỉ còn lại sẽ được hiển thị cho mỗi Loại nghỉ phép.
     ...
     <img class="screenshot" alt="Leave Application" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/human-resources/leave-app.png">
...
1. Nhập Lý do nghỉ phép (Reason for Leave).
    ...
    <img class="screenshot" alt="Leave Application" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/human-resources/leave-app1.png">
...
1. Bạn cũng có thể liên kết Phiếu lương (Salary Slip) của Nhân viên trong Đơn xin nghỉ phép để lưu hồ sơ.
    ...
    <img class="screenshot" alt="Leave Application" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/human-resources/leave-app3.png">
...
* **Cấp độ Phòng ban:** Người phê duyệt nghỉ phép cho mỗi phòng ban có thể được cấu hình trong danh mục [Department](department.md). Có thể thiết lập nhiều Người phê duyệt nghỉ phép trong một Phòng ban. Người phê duyệt nghỉ phép đầu tiên trong danh sách sẽ được coi là Người phê duyệt mặc định.
    ...
    <img class="screenshot" alt="Leave Application - Leave Approvers" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/human-resources/leave-app4.png">
