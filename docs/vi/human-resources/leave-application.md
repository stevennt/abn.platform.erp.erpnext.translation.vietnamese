...
1. Một bảng về Số ngày nghỉ được phân bổ (Allocated Leaves) sẽ được hiển thị. Dựa trên số ngày nghỉ đã sử dụng, số ngày nghỉ còn lại sẽ được hiển thị cho mỗi Loại nghỉ phép.
     ...
     <img class="screenshot" alt="Leave Application" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/leave-app.png">
...
1. Nhập Lý do nghỉ phép (Reason for Leave).
    ...
    <img class="screenshot" alt="Leave Application" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/leave-app1.png">
...
1. Bạn cũng có thể liên kết Phiếu lương (Salary Slip) của Nhân viên trong Đơn xin nghỉ phép để lưu hồ sơ.
    ...
    <img class="screenshot" alt="Leave Application" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/leave-app3.png">
...
Người phê duyệt nghỉ phép cũng có thể được thiết lập theo từng Nhân viên trong danh mục nhân viên.
 ...
 <img class="screenshot" alt="Leave Application - Leave Approvers" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/employee-level-approvers.png">
...
>* Nhân viên không thể đăng ký nghỉ phép vào những ngày đã được thêm vào [Leave Block List](/docs/v13/user/manual/en/human-resources/leave-block-list).

Để hiểu cách ERPNext cho phép bạn cấu hình nghỉ phép cho nhân viên, hãy kiểm tra [Leaves](/docs/v13/user/manual/en/human-resources/leave-management-intro/).
