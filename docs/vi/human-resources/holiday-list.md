...
3. Chọn Ngày bắt đầu và Ngày kết thúc cho Danh sách ngày lễ.
    ...
    <img class="screenshot" alt="Holiday List" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/holiday-list-1.png">
...
<img class="screenshot" alt="Holiday List" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/holiday-list-2.gif">
...
<img class="screenshot" alt="Holiday List" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/holiday-list-3.png">
...
<img class="screenshot" alt="Holiday List" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/default-holiday-list-company.png">
...
<img class="screenshot" alt="Holiday List" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/holiday-list-workstation.png">

Các ngày trong Danh sách ngày lễ được gắn trong danh mục [Workstation](/docs/v13/user/manual/en/manufacturing/workstation) sẽ được coi là những ngày mà Trạm làm việc sẽ đóng cửa.
