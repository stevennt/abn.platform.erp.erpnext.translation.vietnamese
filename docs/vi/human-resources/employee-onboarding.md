...
Khi Xác nhận Tiếp nhận Nhân viên, một [Project](/docs/v13/user/manual/en/projects/project) sẽ được tạo. Trong Dự án, các [Tasks](/docs/v13/user/manual/en/projects/tasks) cũng sẽ được tạo cho mỗi Hoạt động.
