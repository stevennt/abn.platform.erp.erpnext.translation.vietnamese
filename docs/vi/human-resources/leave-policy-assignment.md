...
1. Chọn Employee và Leave Policy.
1. Chọn Assignment dựa trên các tùy chọn sau nếu cần:
...
<img class="screenshot" alt="Leave Policy Assignment"
    src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/human-resources/leave-policy-assignment.png">
...
<img class="screenshot" alt="Leave Allocations"
    src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/human-resources/granted-leaves.png">
...
1. Một hộp thoại sẽ xuất hiện, hãy Chọn Employee. Bạn có thể lọc nhân viên dựa trên Công ty (Company) và Phòng ban (Department) hoặc bạn cũng có thể sử dụng các bộ lọc tiêu chuẩn bằng cách nhấn vào Add Filters.
1. Chọn Leave Policy và các ngày Effective From, Effective To.
1. Nhấn vào Assign.

<img class="screenshot" alt="Bulk Leave Policy Assignment" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/human-resources/bulk-leave-policy-assignment.png">
