...
> **Lưu ý:** Bật tùy chọn 'Applies to Company' nếu bạn muốn Danh sách chặn nghỉ phép được áp dụng cho toàn bộ Công ty. Nếu không được chọn, danh sách sẽ phải được thêm vào từng [Department](/docs/v13/user/manual/en/human-resources/department) nơi cần áp dụng.
