...
1. Chọn Employee và Salary Structure.
1. Chọn From Date (Ngày bắt đầu) mà Cấu trúc Lương cụ thể này sẽ được áp dụng.
...
Bạn cũng có thể phân bổ Cấu trúc Lương cho (các) Nhân viên trực tiếp thông qua tài liệu Salary Structure. Để phân bổ Cấu trúc Lương cho một nhân viên duy nhất, hãy nhấp vào nút 'Assign Salary Structure' trong tài liệu Salary Structure.

<img class="screenshot" alt="Salary Structure Assignment" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/human-resources/assign-sal1.png">

Nếu bạn muốn phân bổ hàng loạt Cấu trúc Lương cho nhiều nhân viên, bạn có thể thực hiện thông qua nút 'Assign to Employees'.

<img class="screenshot" alt="Salary Structure Assignment" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/human-resources/assign-sal2.png">
...
<img class="screenshot" alt="Salary Structure Assignment" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/human-resources/assign-sal3.png">

Sau khi hoàn tất, hãy nhấp vào nút 'Assign' để thực hiện phân bổ Cấu trúc Lương tương ứng.
