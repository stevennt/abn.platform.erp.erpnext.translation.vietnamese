...
1. Lưu và Xác nhận.
    ...
    <img class="screenshot" alt="Attendance" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/attendance.png">
...
Bạn có thể dễ dàng thiết lập chấm công cho Nhân viên bằng cách sử dụng [Employee Attendance Tool](/docs/v13/user/manual/en/human-resources/employee-attendance-tool).

Bạn cũng có thể tải lên dữ liệu chấm công hàng loạt bằng cách sử dụng [Upload Attendance](/docs/v13/user/manual/en/human-resources/upload-attendance).
...
1. Nhấn vào nút **Mark Attendance** và nhấn **Yes**.
    ...
    <img class="screenshot" alt="Attendance" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/marking_unmarked_attendance.gif">
