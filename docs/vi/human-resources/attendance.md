...
* [Shift Type](shift-management.md)
...
1. Lưu và Xác nhận.
    ...
    <img class="screenshot" alt="Attendance" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/human-resources/attendance.png">
...
Bạn có thể dễ dàng thiết lập chấm công cho Nhân viên bằng cách sử dụng [Employee Attendance Tool](employee-attendance-tool.md).

Bạn cũng có thể tải lên dữ liệu chấm công hàng loạt bằng cách sử dụng [Upload Attendance](upload-attendance.md).
...
1. Nhấn vào nút **Mark Attendance** và nhấn **Yes**.
    ...
    <img class="screenshot" alt="Attendance" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/human-resources/marking_unmarked_attendance.gif">
...
1. [Attendance Request](attendance-request.md)


Ngoài ra, bạn cũng có thể thiết lập việc đánh dấu chấm công tự động dựa trên nhật ký check-in/check-out từ các Thiết bị Sinh trắc học/RFID (hoặc bất kỳ cơ chế tương tự nào khác tạo ra nhật ký VÀO/RA của nhân viên). Vui lòng tham khảo tính năng [Auto Attendance](auto-attendance.md) để biết thêm thông tin.
