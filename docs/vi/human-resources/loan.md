...
* [Đơn xin vay vốn](/docs/v13/user/manual/en/human-resources/loan-application)
* [Hệ thống tài khoản](/docs/v13/user/manual/en/accounts/chart-of-accounts)
...
Ngoài ra, bạn có thể tạo bản ghi Khoản vay trực tiếp từ [Đơn xin vay vốn](/docs/v13/user/manual/en/human-resources/loan-application)
...
1. [Bút toán bảng lương](/docs/v13/user/manual/en/human-resources/payroll-entry)