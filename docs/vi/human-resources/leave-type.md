...
* **Allow Negative Balance (Cho phép số dư âm):** Nếu được chọn, hệ thống sẽ luôn cho phép đăng ký và phê duyệt [Leave Applications](/docs/v13/user/manual/en/human-resources/leave-application) cho Loại nghỉ phép, ngay cả khi không còn số dư ngày nghỉ.
...
> **Lưu ý:** Khi Xác nhận [Leave Encashment](/docs/v13/user/manual/en/human-resources/leave-encashment) cho một Nhân viên, ERPNext sẽ tự động tạo một [Additional Salary](/docs/v13/user/manual/en/human-resources/additional-salary) (Lương bổ sung) để được cộng vào Phiếu lương của Nhân viên khi xử lý bảng lương tiếp theo.
...
<img class="screenshot" alt="Earned Leave"
        src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/human-resources/earned-leave.png">
