...
1. Lưu và Xác nhận.
    ...
    <img class="screenshot" alt="Employee Tax Exemption Declaration" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/employee-tax-exemption-declaration.png">
...
Bạn có thể cấu hình Employee Tax Exemption Category bằng cách đi đến, **Employee Tax and Benefits > Employee Tax Exemption Category**
 ...
 <img class="screenshot" alt="Employee Tax Exemption Category" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/employee-tax-exemption-sub-category1.png">
...
Bạn có thể cấu hình Employee Tax Exemption Category bằng cách đi đến, **Employee Tax and Benefits > Employee Tax Exemption Sub-Category**
 ...
 <img class="screenshot" alt="Employee Tax Exemption Category" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/employee-tax-exemption-category1.png">
...
<img class="screenshot" alt="Employee Tax Exemption Declaration" src="https://docs.erpnext.com/docs/v13/assets/img/human-resources/hra-exemption.png">
