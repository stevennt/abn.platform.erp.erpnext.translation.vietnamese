...
Trước khi bạn bắt đầu triển khai, hãy làm quen với các thuật ngữ được sử dụng và một số khái niệm cơ bản trong ERPNext.
...
Một danh sách các Mặt hàng kèm theo số lượng để vận chuyển. Phiếu giao hàng sẽ làm giảm tồn kho của các Mặt hàng tại Kho nơi bạn xuất hàng. Phiếu giao hàng thường được lập dựa trên Đơn bán hàng.

> Stock > Delivery Note

#### Phiếu nhập hàng

Một ghi chú xác nhận rằng một bộ Mặt hàng cụ thể đã được nhận từ Nhà cung cấp, thường là dựa trên một Đơn mua hàng.