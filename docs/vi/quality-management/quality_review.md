...
Nếu bạn đã thiết lập tần suất xem xét trong [Mục tiêu Chất lượng](docs/user/manual/en/quality-management/quality_goal) của mình, thì Đánh giá Chất lượng sẽ được tự động tạo và trạng thái của nó sẽ được đặt thành "Mở". Sau đó, quản lý chất lượng có thể kiểm tra các đánh giá đang mở và hoàn tất việc kiểm tra.
