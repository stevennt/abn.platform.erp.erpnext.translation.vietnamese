...
![GSTIN in Customer](https://docs.erpnext.com/docs/v13/assets/img/regional/india/gstin-customer.gif)
...
![GST in Company](https://docs.erpnext.com/docs/v13/assets/img/regional/india/gstin-company.gif)
...
![GST in Address Template](https://docs.erpnext.com/docs/v13/assets/img/regional/india/address-template-gstin.png)
...
![HSN in Item](https://docs.erpnext.com/docs/v13/assets/img/regional/india/hsn-item.gif)
...
![GST Ledgers](https://docs.erpnext.com/docs/v13/assets/img/regional/india/gst-ledger.png)
...
![GST Settings](https://docs.erpnext.com/docs/v13/assets/img/regional/india/gst-settings.png)
...
![GST Tax Template](https://docs.erpnext.com/docs/v13/assets/img/regional/india/gst-tax-template.png)
...
![GST Invoice](https://docs.erpnext.com/docs/v13/assets/img/regional/india/gst-invoice.gif)
...
![Sample GST Tax Invoice](https://docs.erpnext.com/docs/v13/assets/img/regional/india/sample-gst-tax-invoice.png)
...
![Reversal of Input Tax Credit](https://docs.erpnext.com/docs/v13/assets/img/regional/india/reversal-of-itc.png)
...
![GST Reverse Charge Settings](https://docs.erpnext.com/docs/v13/assets/img/regional/india/gst-reverse-charge-setting.png)
...
![Reverse Charge](https://docs.erpnext.com/docs/v13/assets/img/regional/india/reverse-charge-add.png)
...
![Reverse Charge](https://docs.erpnext.com/docs/v13/assets/img/regional/india/reverse-charge-deduct.png)
...
![Reverse Charge Tax Category](https://docs.erpnext.com/docs/v13/assets/img/regional/india/reverse-charge-tax-category.png)

* Cập nhật danh mục thuế trong các danh mục Nhà cung cấp liên quan.

![Supplier Tax Category](https://docs.erpnext.com/docs/v13/assets/img/regional/india/supplier-tax-category.png)

* Tạo Mẫu Thuế và Phí Mua hàng (Purchase Taxes and Charges template) cho thuế suất đảo ngược.

![Reverse Charge Template](https://docs.erpnext.com/docs/v13/assets/img/regional/india/reverse-charge-template.png)
