...
- [Cài đặt DATEV](/docs/v13/user/manual/en/regional/germany/datev-settings)
...
![DATEV Export Filters](https://docs.erpnext.com/docs/v13/assets/img/regional/germany/datev-export-filters.png)

## Menu

Từ menu, bạn có thể mở [Cài đặt DATEV](/docs/v13/user/manual/en/regional/germany/datev-settings) hoặc tải xuống tệp xuất. Tệp xuất là một tệp nén ZIP chứa dữ liệu giao dịch từ bản xem trước cũng như dữ liệu danh mục (**Khách hàng**, **Nhà cung cấp**, **Tài khoản**).

![DATEV Export Menu](https://docs.erpnext.com/docs/v13/assets/img/regional/germany/datev-export-menu.png)
