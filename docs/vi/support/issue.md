...
![Issue](https://docs.erpnext.com/docs/v13/assets/img/support/issue.png)
...
![SLA](https://docs.erpnext.com/docs/v13/assets/img/support/new-issue.gif)
...
![Response Details](https://docs.erpnext.com/docs/v13/assets/img/support/response.png)
...
![Resolution](https://docs.erpnext.com/docs/v13/assets/img/support/resolution.png)
...
### 4.1 Thêm bình luận
Sau khi Vấn đề được đăng ký, người dùng thuộc đội ngũ hỗ trợ có thể thêm bình luận cho vấn đề. Trường này có thể chỉnh sửa. Các bình luận trong Vấn đề là để thảo luận nội bộ và sẽ không hiển thị cho Khách hàng.

### 4.2 Email mới
Người dùng có thể soạn một email gửi cho người đã tạo Vấn đề. Tất cả các email (cả nhận được cũng như đã gửi) có thể được xem trong một luồng trong Vấn đề.
