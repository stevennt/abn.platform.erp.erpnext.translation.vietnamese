...
![SO Maintenance Schedule](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/support/so-maintenance-schedule.png)
...
1. Xác nhận.
    ...
    ![Maintenance Schedule](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/support/maintenance-schedule-1.png)
...
1. [Yêu cầu bảo hành](/docs/v13/user/manual/en/support/warranty-claim)
1. [Lần thăm khám bảo trì](/docs/v13/user/manual/en/support/maintenance-visit)
