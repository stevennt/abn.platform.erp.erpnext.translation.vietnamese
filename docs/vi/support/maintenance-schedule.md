...
![SO Maintenance Schedule](https://docs.erpnext.com/docs/v13/assets/img/support/so-maintenance-schedule.png)
...
1. Xác nhận.
    ...
    ![Maintenance Schedule](https://docs.erpnext.com/docs/v13/assets/img/support/maintenance-schedule-1.png)
