...
<img class="screenshot" alt="SMS Setting 2" src="https://docs.erpnext.com/docs/v13/assets/img/setup/sms-settings2.jpg">
...
<img class="screenshot" alt="SMS Setting" src="https://docs.erpnext.com/docs/v13/assets/img/setup/sms-settings1.png">
