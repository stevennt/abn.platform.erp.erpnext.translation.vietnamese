...
Đọc thêm về [sự khác biệt giữa người dùng hệ thống và người dùng website](../articles/difference-between-system-user-and-website-user.md).
...
Với tùy chọn này, bạn có thể theo dõi các tài liệu khác nhau trong hệ thống và nhận thông báo email khi chúng được cập nhật. Tìm hiểu thêm [tại đây](../email/document-follow.md).
...
* **Chữ ký Email**: Thêm chữ ký email tại đây sẽ thiết lập nó làm mặc định cho tất cả các email gửi đi của người dùng. Điều này khác với chân trang được thiết lập từ [Thông tin chính của Công ty](../company-setup.md).

### 2.6 Hộp thư Email

Đăng ký người dùng vào các danh sách gửi thư khác nhau của công ty bạn từ phần này. Thêm một dòng mới và chọn danh sách gửi thư để chỉ định người dùng này. Ví dụ, danh sách gửi thư có thể là tuyển dụng, hỗ trợ, bán hàng, v.v. Để biết thêm về Hộp thư Email, [nhấn vào đây](../email/email-inbox.md).
