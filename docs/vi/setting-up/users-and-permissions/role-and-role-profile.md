...
![Permissions for new Role](https://docs.erpnext.com/docs/v13/assets/img/users-and-permissions/role-permissions.png)
...
1. Lưu.
    ...
    ![Role Profile](https://docs.erpnext.com/docs/v13/assets/img/users-and-permissions/role-profile.png)
