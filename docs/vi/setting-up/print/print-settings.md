...
Bạn có thể bật in thô và in tới nhiều loại máy in nhiệt được hỗ trợ. Đọc [In thô](/docs/v13/user/manual/en/setting-up/print/raw-printing) để biết thêm chi tiết.
...
1. [Dịch tùy chỉnh](/docs/v13/user/manual/en/setting-up/print/custom-translations)