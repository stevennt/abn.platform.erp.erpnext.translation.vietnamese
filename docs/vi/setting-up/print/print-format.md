...
* Sử dụng [Print Format Builder](/docs/v13/user/manual/en/setting-up/print/print-format-builder) để tạo các mẫu in bằng giao diện người dùng (UI)
...
1. Module áp dụng sẽ được tự động lựa chọn.
  ...
  ![Print Format menu](https://docs.erpnext.com/docs/v13/assets/img/setup/print/print-format-menu.png)
...
Để thiết kế Mẫu in bằng Jinja/JS tùy chỉnh, hãy nhấp vào Custom Format. Nếu bạn chọn tùy chọn này, sẽ có một ô đánh dấu cho việc in thô (raw printing). Để biết thêm về in thô, [nhấp vào đây](/docs/v13/user/manual/en/setting-up/print/raw-printing).
...
![Print Format Customize](https://docs.erpnext.com/docs/v13/assets/img/setup/print/print-format-customize1.png)

Để biết thêm, hãy truy cập trang [Customize Print Format](/docs/v13/user/manual/en/customize-erpnext/print-format).

Trong bảng các trường (fields table), mở rộng dòng 'Item Code', cuộn xuống và đánh dấu vào ô 'Print Hide'.
![Print Format Print Hide](https://docs.erpnext.com/docs/v13/assets/img/setup/print/print-format-customize2.png)
...
![Selecting a Print Format](https://docs.erpnext.com/docs/v13/assets/img/setup/print/print-format-selection.png)
