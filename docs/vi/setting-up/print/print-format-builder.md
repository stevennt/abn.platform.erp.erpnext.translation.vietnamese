...
1. Chọn Mẫu in cần chỉnh sửa.
    ![Select doctype for editing Print Format](https://docs.erpnext.com/docs/v13/assets/img/setup/print/print-format-builder-edit.png)

1. Nhấp vào nút Edit, bạn sẽ được đưa đến giao diện người dùng của Print Format Builder.
    ![Print Format builder screen](https://docs.erpnext.com/docs/v13/assets/img/setup/print/print-format-builder-screen.png)
...
1. Mở tài liệu mà bạn muốn tạo Mẫu in. Nhấp vào biểu tượng Máy in, hoặc đi tới Menu > Print và nhấp vào nút Customize... Lưu ý: Bạn phải có quyền System Manager để thực hiện việc này.
  ...
  <img class="screenshot" alt="Send Email" src="https://docs.erpnext.com/docs/v13/assets/img/setup/print/print-format-builder-1.gif">
