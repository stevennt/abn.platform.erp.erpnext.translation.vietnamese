...
<img class="screenshot" alt="Sample Cheque" src="https://docs.erpnext.com/docs/v13/assets/img/setup/print/sample-cheque.jpg">
...
<img class="screenshot" alt="Sample Cheque" src="https://docs.erpnext.com/docs/v13/assets/img/setup/print/cheque-1.png">
...
<img class="screenshot" alt="Sample Cheque" src="https://docs.erpnext.com/docs/v13/assets/img/setup/print/cheque-2.png">
...
<img class="screenshot" alt="Sample Cheque" src="https://docs.erpnext.com/docs/v13/assets/img/setup/print/cheque-3.gif">

### 2. Các chủ đề liên quan
1. [Mẫu địa chỉ](/docs/v13/user/manual/en/setting-up/print/address-template)
