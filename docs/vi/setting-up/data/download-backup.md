...
Nhấp vào Tải bản sao lưu tệp tin sẽ gửi một email kèm theo các liên kết để tải bản sao lưu cho cả tệp riêng tư và tệp công khai. [Email](/docs/v13/user/manual/en/setting-up/email) phải được cấu hình để tính năng này hoạt động.
