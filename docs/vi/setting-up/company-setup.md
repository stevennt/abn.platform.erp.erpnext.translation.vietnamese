...
![Company Master](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/company-master.png)
...
<img class="screenshot" alt="Company Tree" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/company-tree.png">
...
Đối với mỗi Công ty, master cho Hệ thống tài khoản được duy trì riêng biệt. Điều này cho phép bạn duy trì kế toán riêng biệt cho từng công ty theo các yêu cầu pháp lý. Bạn cũng có thể nhập hệ thống tài khoản bằng cách sử dụng [Charts Of Accounts Importer](chart-of-accounts-importer.md).
...
<img class="screenshot" alt="Company Chart of Accounts" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/new-company-coa-based-on.png">
...
Thiết lập con số mục tiêu doanh số hàng tháng bằng tiền tệ của công ty, ví dụ: $10,000. Tổng doanh số hàng tháng sẽ hiển thị sau khi các giao dịch được thực hiện. Để biết thêm [nhấp vào đây](setting-company-sales-goal.md).

### 2.2 Cài đặt Tài khoản
Một số tài khoản sau đây sẽ được thiết lập mặc định khi bạn tạo một công ty mới, những tài khoản khác có thể được tạo thêm. Các tài khoản có thể được xem trong [Hệ thống tài khoản](../accounts/chart-of-accounts.md). Các giá trị này có thể được thay đổi sau nếu cần.
...
### 2.3 Cài đặt Kho
Tính năng Kiểm kê thường xuyên sẽ dẫn đến các giao dịch Kho tác động đến sổ sách kế toán của công ty. Tìm hiểu thêm [tại đây](../stock/perpetual-inventory.md). Tính năng này được bật theo mặc định.
...
* Expenses Included In Valuation (Chi phí bao gồm trong giá trị tính giá)
    ...
    ![Stock Settings in Company](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/accounts/company-stock-settings.png)

### 2.4 Cài đặt Khấu hao Tài sản cố định
Để quản lý tài sản cố định trong một công ty, cần có các tài khoản sau. Hầu hết chúng sẽ được tạo mặc định. Chúng có thể được xem trong [Hệ thống tài khoản](../accounts/chart-of-accounts.md).
