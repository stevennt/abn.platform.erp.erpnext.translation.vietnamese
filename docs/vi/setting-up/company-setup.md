...
![Company Master](https://docs.erpnext.com/docs/v13/assets/img/accounts/company-master.png)
...
<img class="screenshot" alt="Company Tree" src="https://docs.erpnext.com/docs/v13/assets/img/accounts/company-tree.png">
...
<img class="screenshot" alt="Company Chart of Accounts" src="https://docs.erpnext.com/docs/v13/assets/img/accounts/new-company-coa-based-on.png">
...
* Expenses Included In Valuation (Chi phí bao gồm trong giá trị tính giá)
    ...
    ![Stock Settings in Company](https://docs.erpnext.com/docs/v13/assets/img/accounts/company-stock-settings.png)
