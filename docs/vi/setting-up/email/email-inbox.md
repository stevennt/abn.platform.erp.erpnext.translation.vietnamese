...
<img class="screenshot" alt="Email Service" src="https://docs.erpnext.com/docs/v13/assets/img/setup/email/email-service.png">
...
<img class="screenshot" alt="Email Password" src="https://docs.erpnext.com/docs/v13/assets/img/setup/email/email-password.png">
...
<img class="screenshot" alt="Email User Link" src="https://docs.erpnext.com/docs/v13/assets/img/setup/email/email-user-link.png">
...
<img class="screenshot" alt="Email Folders" src="https://docs.erpnext.com/docs/v13/assets/img/setup/email/email-folders.png">
...
<img class="screenshot" alt="Email Actions" src="https://docs.erpnext.com/docs/v13/assets/img/setup/email/email-actions.png">
...
<img class="screenshot" alt="Make from Email" src="https://docs.erpnext.com/docs/v13/assets/img/setup/email/make-from-email.png">
