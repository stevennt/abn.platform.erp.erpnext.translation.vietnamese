...
<img class="screenshot" alt="Email Template" src="https://docs.erpnext.com/docs/v13/assets/img/setup/email/email-template-example.png">
...
Bạn có thể thiết lập Mẫu Email Mặc định cho mỗi loại tài liệu thông qua [Tùy chỉnh Biểu mẫu](/docs/v13/user/manual/en/customize-erpnext/customize-form).

### 1.2 Cách lấy tên trường (fieldnames)
Các tên trường mà bạn có thể sử dụng trong mẫu email của mình là các trường trong tài liệu mà bạn đang gửi email. Bạn có thể tìm thấy các trường của bất kỳ tài liệu nào thông qua [Tùy chỉnh Biểu mẫu](/docs/v13/user/manual/en/customize-erpnext/customize-form) và chọn loại tài liệu (ví dụ: Đơn bán hàng)
