...
<img class="screenshot" alt="Send Email" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/setup/email/send-email.gif">

**Lưu ý:** Bạn phải thiết lập các [Tài khoản Email](email-account.md) gửi đi để thực hiện việc này.
...
![Email Queue](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/setup/email/email-queue.png)
...
* **Email Template**: Bạn có thể tạo các mẫu thiết lập sẵn để gửi các phản hồi tiêu chuẩn. Các Mẫu Email đã có sẵn trong hệ thống cho Thông báo gửi hàng, Thông báo trạng thái nghỉ phép và Thông báo phê duyệt nghỉ phép. Bạn có thể thiết lập Mẫu Email mặc định thông qua [Tùy chỉnh biểu mẫu](../../customize-erpnext/customize-form.md).
...
![Email Print Options](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/setup/email/email-print-options.png)

* **Select Print Format**: Mẫu in của tài liệu. Tìm hiểu thêm về Mẫu in [tại đây](../print/print-format.md).
