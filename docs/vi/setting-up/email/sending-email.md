...
* **Email Template**: Bạn có thể tạo các mẫu thiết lập sẵn để gửi các phản hồi tiêu chuẩn. Các Mẫu Email đã có sẵn trong hệ thống cho Thông báo gửi hàng, Thông báo trạng thái nghỉ phép và Thông báo phê duyệt nghỉ phép. Bạn có thể thiết lập Mẫu Email mặc định thông qua [Tùy chỉnh biểu mẫu](/docs/v13/user/manual/en/customize-erpnext/customize-form).
