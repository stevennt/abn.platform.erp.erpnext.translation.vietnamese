...
Vui lòng tham khảo liên kết sau để thiết lập Chấm công tự động: [Thiết lập Chấm công tự động](/docs/v13/user/manual/en/human-resources/auto-attendance#steps-to-setup-auto-attendance)
...
1. Sử dụng Công cụ Nhập dữ liệu (Data Import Tool) của ERPNext:
    ...
    - Vui lòng tham khảo [Tài liệu hướng dẫn về Công cụ Nhập dữ liệu của ERPNext](/docs/v13/user/manual/en/setting-up/data/data-import) để biết thêm về cách thực hiện việc này.
