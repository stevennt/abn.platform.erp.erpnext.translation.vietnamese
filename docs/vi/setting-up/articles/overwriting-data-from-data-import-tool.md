...
<img alt="Download Template" class="screenshot" src="https://docs.erpnext.com/docs/v13/assets/img/articles/overwrite-1.gif">
...
<img alt="Update Values" class="screenshot" src="https://docs.erpnext.com/docs/v13/assets/img/articles/overwrite-2.png">
...
<img alt="Browse template" class="screenshot" src="https://docs.erpnext.com/docs/v13/assets/img/articles/overwrite-3.gif">

## Bước 4: Tải lên

Sau khi nhấp vào Import, Nhóm mặt hàng sẽ được ghi đè.

<img alt="Upload" class="screenshot" src="https://docs.erpnext.com/docs/v13/assets/img/articles/overwrite-4.png">
