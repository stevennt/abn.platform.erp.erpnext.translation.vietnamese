...
Cấp độ Quyền (viết tắt của Permission Level) cho một trường có thể được xác định trong [Customize Form](/docs/v13/user/manual/en/customize-erpnext/customize-form.html).

<img alt="Perm Level Field" class="screenshot" src="https://docs.erpnext.com/docs/v13/assets/img/articles/perm-level-1.gif">
...
<img alt="Perm Level Rule" class="screenshot" src="https://docs.erpnext.com/docs/v13/assets/img/articles/perm-level-2.png">
...
<img alt="Perm Level Rule 2" class="screenshot" src="https://docs.erpnext.com/docs/v13/assets/img/articles/perm-level-3.png">
