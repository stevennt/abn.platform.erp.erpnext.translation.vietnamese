...
* Chuẩn bị dữ liệu nguồn trong Excel hoặc trình soạn thảo văn bản với mỗi cột được phân tách bằng một dấu tab.
 ...
 ![Copy Pasting](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/using-erpnext/using-copy-paste-1.png)
...
* Kéo chuột để chọn các bản ghi, sau đó nhấp vào nút menu sao chép hoặc nhấn Ctrl + C (Cmd + C) để:
 ...
 ![Copy Pasting](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/using-erpnext/using-copy-paste-4.png)
...
* Đặt con trỏ vào trường nhập liệu mục tiêu của bảng con, và dán dữ liệu vào. Khác với tính năng nhập liệu thông qua tải tệp lên, tính năng sao chép & dán này sẽ tự động kích hoạt các sự kiện thay đổi trường (field change events).
 ...
 ![Copy Pasting](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/using-erpnext/using-copy-paste-3.gif)
