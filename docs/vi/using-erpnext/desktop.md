...
![New Desktop](https://docs.erpnext.com/docs/v13/assets/img/using-erpnext/desktop/desktop.png)
...
![Desktop Dropdown](https://docs.erpnext.com/docs/v13/assets/img/using-erpnext/desktop/desktop-dropdown.png)

Bạn cũng có thể sắp xếp lại thứ tự cũng như hiển thị hoặc ẩn các thẻ module này.

![Drag and Drop](https://docs.erpnext.com/docs/v13/assets/img/using-erpnext/desktop/drag-and-drop.gif)
...
![Accounts Module](https://docs.erpnext.com/docs/v13/assets/img/using-erpnext/desktop/accounts-module-page.png)
...
![Muted Link in Module Page](https://docs.erpnext.com/docs/v13/assets/img/using-erpnext/desktop/module-link-hover.png)
...
![Color Indicators](https://docs.erpnext.com/docs/v13/assets/img/using-erpnext/desktop/color-indicator.png)
