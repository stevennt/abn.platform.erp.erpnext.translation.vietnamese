...
![Access Log](https://docs.erpnext.com/docs/v13/assets/img/using-erpnext/using-access-log-3.png)
...
![Access Log](https://docs.erpnext.com/docs/v13/assets/img/using-erpnext/using-access-log-1.png)
...
![Access Log](https://docs.erpnext.com/docs/v13/assets/img/using-erpnext/using-access-log-2.png)

Các sự kiện như [In thô](/docs/v13/user/manual/en/setting-up/print/raw-printing) sẽ lưu thông tin cùng với mẫu đã chọn cho tài liệu đó.

![Access Log](https://docs.erpnext.com/docs/v13/assets/img/using-erpnext/using-acces-log-4.png)