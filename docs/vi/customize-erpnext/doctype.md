...
1. **Web View**
 ...
 Bạn có thể chọn xem mình có muốn có Chế độ xem Web (Web View) cho DocType này hay không. Việc có Chế độ xem Web cho một DocType sẽ cho phép người dùng website của bạn có quyền truy cập vào các Biểu mẫu. Hãy tìm hiểu thêm về [Người dùng Website](../setting-up/articles/difference-between-system-user-and-website-user.md).
...
1. **Is Child Table**: Bạn có thể xác định xem có muốn DocType mới là một Bảng con (Child Table) trong một DocType khác hay không. Xem [Child Table](articles/customizing-data-visibility-in-child-table.md) để biết thêm thông tin.
