...
![Tùy chọn Customize trong Chế độ xem danh sách](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/customize/customize-option-in-list-view.png)
...
1. **Change Label (Thay đổi Nhãn)**: Trường này được lấy thông qua Bản dịch tùy chỉnh (Custom Translation). Bạn có thể thay đổi tên của trường để phù hợp với ngành nghề/ngôn ngữ của mình. Ví dụ: nếu bạn là một doanh nghiệp dịch vụ và bạn muốn thay đổi Nhãn từ 'Customer' thành 'Consumer', điều đó có thể được thực hiện thông qua [Custom Translation](../setting-up/print/custom-translations.md) và thay đổi đó sẽ được phản ánh tại đây.
  ...
  ![Thay đổi Nhãn](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/customize/customize-customize-form-label.png)
...
1. **Image Field (Trường Hình ảnh)**: Bạn có thể chọn một trường "Attach Image" cho Trường Hình ảnh của mình. Đây sẽ là Hình ảnh đại diện cho DocType cụ thể đó. Ví dụ: 'Trường Hình ảnh' cho một Nhân viên có thể là ảnh chân dung hoặc ảnh chụp thẻ ID của họ; điều này có thể được cấu hình tại đây.
  ...
  ![Trường Hình ảnh trong DocType](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/customize/customize-form-image-field.png)
...
1. **Sort Field (Trường sắp xếp)**: Các bản ghi trong Danh sách của bất kỳ DocType nào được tạo dựa trên Trường mà bạn thiết lập tại Trường sắp xếp ở đây. Ví dụ: đối với Mặt hàng (Items), nếu bạn muốn danh sách của mình được tạo theo Tên mặt hàng, bạn có thể cấu hình điều đó tại đây.
  ...
  ![Trường sắp xếp](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/customize/customize-sort-field.png)
...
* **Track Changes (Theo dõi thay đổi)**: Việc tích vào hộp này sẽ đảm bảo rằng bất kỳ thay đổi nào do bất kỳ người dùng nào thực hiện đối với DocType này sẽ được theo dõi và hiển thị.
  ...
  ![Theo dõi thay đổi](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/customize/customize-track-changes.png)
