...
![Authorization Rule](https://docs.erpnext.com/docs/v13/assets/img/customize/authorization-rule.png)
...
![Authorization Rule](https://docs.erpnext.com/docs/v13/assets/img/customize/new-authorization-rule.png)

Nếu Nhân viên bán hàng cố gắng xác nhận Đơn bán hàng có giá trị cao hơn 10.000, họ sẽ nhận được thông báo lỗi.

![Authorization Rule Validation Message](https://docs.erpnext.com/docs/v13/assets/img/customize/authorization-rule-validation-message.png)

> Nếu bạn muốn hạn chế Nhân viên bán hàng xác nhận các Đơn bán hàng, thay vì tạo Quy tắc Ủy quyền, bạn nên xóa quyền xác nhận của Nhân viên bán hàng trong [Role Permission Manager](/docs/v13/user/manual/en/setting-up/users-and-permissions/role-based-permissions).
