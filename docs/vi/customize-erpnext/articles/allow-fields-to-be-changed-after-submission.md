...
![Allow on Submit](https://docs.erpnext.com/docs/v13/assets/img/customize/allow-on-submit-on-standard-field.gif)
...
![Allow on Submit on Custom Field](https://docs.erpnext.com/docs/v13/assets/img/customize/allow-on-submit-on-custom-field.gif)
