...
Trường Link được kết nối với một danh mục chính khác để lấy dữ liệu từ đó. Ví dụ, trong danh mục Báo giá, Khách hàng là một trường Link. Để biết thêm chi tiết, [nhấp vào đây](/docs/v13/user/manual/en/customize-erpnext/articles/creating-custom-link-field).

#### Dynamic Link

Trường Dynamic Link là trường có thể tìm kiếm và giữ giá trị của bất kỳ tài liệu/DocType nào. [Nhấp vào đây](/docs/v13/user/manual/en/customize-erpnext/articles/dynamic-link-fields) để tìm hiểu cách thức hoạt động của trường Dynamic Link.

#### Check

Trường này sẽ cho phép bạn có một ô đánh dấu (checkbox) tại đây.

![Check Field TYpe](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-check.png)

#### Select

Select sẽ là một trường danh sách thả xuống. Bạn có thể thêm nhiều kết quả trong trường Option, phân tách bằng dòng mới.

![Select Field Type](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-select.png)
...
![Table Field Type](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-table.png)

#### Attach

Trường Attach cho phép bạn duyệt tìm một tệp từ Trình quản lý tệp và đính kèm tệp đó vào đây.

![Attach Field Type](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-attach.png)
...
![Field Type Image](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-image.png)
...
![Field Type Text Editor](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-text-editor.png)

#### Date

Trường này sẽ cho phép bạn nhập Ngày vào trường này.

![Field Type Date](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-date.png)
...
![Field Type Date and Time](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-date-and-time.png)
...
![Field Type Barcode](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-barcode.png)

#### Button

Loại trường này sẽ là một nút hành động, chẳng hạn như Lưu, Xác nhận, v.v.

![Field Type Button](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-button.png)

#### Code

Nếu Loại trường được chọn là code, bạn sẽ có thể nhập một đoạn Mã vào trường.

![Field Type Code](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-code.png)

#### Color

Bạn sẽ có tùy chọn chỉ định màu sắc cho Biểu mẫu này.

![Field Type Colour](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-colour.png)
...
![Field Type Column Break](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-column-break.png)
...
![Field Type Currency](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-currency.png)
...
![Field Type Data](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-data.png)

#### Float

Trường Float mang giá trị số, lên đến chín chữ số thập phân. Độ chính xác cho trường float được thiết lập thông qua [Thiết lập độ chính xác](/docs/v13/user/manual/en/customize-erpnext/articles/set-precision)

> Setup > Settings > System Settings

Thiết lập này sẽ được áp dụng cho tất cả các trường float.

![Field Type Float](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-float.png)
...
Đọc [Trường Geolocation](/docs/v13/user/manual/en/customize-erpnext/articles/geolocation-field) để hiểu thêm.

![Field Type Geolocation](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-geolocation.png)

#### HTML

Bạn có thể chọn trường là trường HTML khi bạn muốn dữ liệu được nhập dưới định dạng HTML.

![Field Type HTML](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-html.png)
...
![Field Type Image](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-image2.png)

#### Int (Integer)

Trường integer giữ giá trị số, không có chữ số thập phân.

![Field Type Integer](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-integer.png)

#### Small Text

Trường Small Text chứa nội dung văn bản và có giới hạn ký tự nhiều hơn trường Data.

![Field Type Small Text](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-small-text.png)

#### Long Text

Bạn có thể xác định trường của mình là trường Long Text khi bạn muốn nhập dữ liệu với giới hạn ký tự không giới hạn.

![Field Type Long Text](https://docs.erpnext.com/docs/v13/assets/img/customize/field-type-long-text