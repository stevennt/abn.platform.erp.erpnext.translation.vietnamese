...
![Braintree Settings](https://docs.erpnext.com/docs/v13/assets/img/setup/integrations/braintree_account.png)
...
![Braintree COA](https://docs.erpnext.com/docs/v13/assets/img/setup/integrations/braintree_coa.png)
...
![Payment Gateway Account](https://docs.erpnext.com/docs/v13/assets/img/setup/integrations/payment_gateway_account_braintree.png)
