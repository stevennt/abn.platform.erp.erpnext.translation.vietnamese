...
<img class="screenshot" alt="Razorpay Settings" src="https://docs.erpnext.com/docs/v13/assets/img/setup/integrations/paytm_credentials.png">
...
<img class="screenshot" alt="Razorpay Settings" src="https://docs.erpnext.com/docs/v13/assets/img/setup/integrations/paytm_settings.png">
...
<img class="screenshot" alt="Stripe COA" src="https://docs.erpnext.com/docs/v13/assets/img/setup/integrations/paytm_coa.png">
...
<img class="screenshot" alt="Payment Gateway Account" src="https://docs.erpnext.com/docs/v13/assets/img/setup/integrations/payment_gateway_account_paytm.png">
