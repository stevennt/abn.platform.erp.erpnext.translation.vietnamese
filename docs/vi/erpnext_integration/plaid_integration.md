...
<img class="screenshot" alt="Enable Plaid" src="https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/plaid_enable.gif">
...
<img class="screenshot" alt="Link your bank account" src="https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/new_account_creation.gif">
...
<img class="screenshot" alt="Synchronize your bank account" src="https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/plaid_synchronization.gif">
