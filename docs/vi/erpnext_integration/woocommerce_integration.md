...
2. Nhấp vào tab "Advanced" sau đó nhấp vào liên kết REST API.
    ...
    ![Woocommerce API](https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/wc-add-key.png)

3. Nhấp vào nút "Add key". Cung cấp các chi tiết cần thiết và nhấp vào nút "Generate API key".

    ![Woocommerce API Key](https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/wc-generate-keys.png)
...
![Woocommerce Settings](https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/woocommerce-settings.png)
...
![Woocommerce Webhook](https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/wc-webhook.png)

Một ảnh GIF dưới đây để hiển thị toàn bộ quy trình:

![Woocommerce Set Up](https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/woocommerce-setup.gif)
...
![Woocommerce Set Up](https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/woocommerce-order.gif)
...
![Woocommerce Defaults](https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/wc-defaults.png)

## 3. Các chủ đề liên quan
1. [Đơn bán hàng](/docs/v13/user/manual/en/selling/sales-order)
2. [Mặt hàng](/docs/v13/user/manual/en/stock/item)
3. [Khách hàng](/docs/v13/user/manual/en/CRM/customer)
4. [Địa chỉ](/docs/v13/user/manual/en/CRM/address)