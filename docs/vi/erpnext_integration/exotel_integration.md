...
![Connect Applet](https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/exotel_integration/connect_applet.png)
![Call Popup Section](https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/exotel_integration/create_popup_section.png)
...
![After Conversation Ends Section](https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/exotel_integration/after_conversation_ends_section.png)

![After call ends section](https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/exotel_integration/passthru_end_call.png)
...
![No Response Section](https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/exotel_integration/no_response.png)

![After call ends section](https://docs.erpnext.com/docs/v13/assets/img/erpnext_integrations/exotel_integration/passthru_missed_call.png)
