...
<img class="screenshot" alt="LDAP Settings" src="https://docs.erpnext.com/docs/v13/assets/img/setup/integrations/ldap_settings.png">
...
<img class="screenshot" alt="LOGIN via LDAP" src="https://docs.erpnext.com/docs/v13/assets/img/setup/integrations/login_via_ldap.png">
...
<img class="screenshot" alt="LDAP Group Mappings" src="https://docs.erpnext.com/docs/v13/assets/img/setup/integrations/ldap_group_mappings.png">
