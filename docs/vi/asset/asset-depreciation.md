...
<img class="screenshot" alt="Asset" src="https://docs.erpnext.com/docs/v13/assets/img/asset/depreciation-entry.png">
...
<img class="screenshot" alt="Asset" src="https://docs.erpnext.com/docs/v13/assets/img/asset/depreciation-schedule.png">

## 4. Ví dụ
Để hiểu rõ hơn, giá trị thuần của tài sản vào các ngày khấu hao khác nhau được hiển thị trong một biểu đồ đường.

<img class="screenshot" alt="Asset" src="https://docs.erpnext.com/docs/v13/assets/img/asset/asset-submit.png">
