...
1. Bạn cũng có thể bật 'Auto Create Assets on Purchase' để tự động tạo tài sản. (Tùy chọn)
  ...
  <img class="screenshot" alt="Purchasing Asset" src="https://docs.erpnext.com/docs/v13/assets/img/asset/asset-auto-create.png">
...
<img class="screenshot" alt="Purchasing Asset" src="https://docs.erpnext.com/docs/v13/assets/img/asset/asset-auto-create-on-purchase.png">
...
<img class="screenshot" alt="Asset" src="https://docs.erpnext.com/docs/v13/assets/img/asset/asset-purchase-receipt-gl-entries.png">
