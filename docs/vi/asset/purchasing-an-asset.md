...
1. Bạn cũng có thể bật 'Auto Create Assets on Purchase' để tự động tạo tài sản. (Tùy chọn)
  ...
  <img class="screenshot" alt="Purchasing Asset" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/asset/asset-auto-create.png">

1. Sau đó, cần tuân thủ [quy trình mua hàng](../buying/purchase-order.md) để mua tài sản.
1. Nhập Vị trí tài sản (Asset Location) trong bảng Mặt hàng của [Phiếu nhập hàng](../stock/purchase-receipt.md) hoặc [Hóa đơn mua hàng](../accounts/purchase-invoice.md) mà bạn đang dùng để nhận mặt hàng.
...
<img class="screenshot" alt="Purchasing Asset" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/asset/asset-auto-create-on-purchase.png">
...
<img class="screenshot" alt="Asset" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/asset/asset-purchase-receipt-gl-entries.png">
