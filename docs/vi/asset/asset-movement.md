...
<img class="screenshot" alt="Asset Movement" src="https://docs.erpnext.com/docs/v13/assets/img/asset/asset-movement.png">
...
<img class="screenshot" alt="Move Multiple Assets" src="https://docs.erpnext.com/docs/v13/assets/img/asset/asset-movement-using-button.png">
...
<img class="screenshot" alt="Move Single Asset" src="https://docs.erpnext.com/docs/v13/assets/img/asset/asset-movement-using-transfer-asset-button.png">
