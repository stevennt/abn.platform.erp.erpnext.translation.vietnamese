...
* [Asset](/docs/v13/user/manual/en/asset/asset) với mục 'Maintenance Required' đã được chọn.

    <img class="screenshot" alt="Asset" src="https://docs.erpnext.com/docs/v13/assets/img/asset/maintenance-required.png">
...
<img class="screenshot" alt="Asset" src="https://docs.erpnext.com/docs/v13/assets/img/asset/asset-maintenance.png">
