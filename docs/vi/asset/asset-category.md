...
1. Tích chọn 'Enable Capital Work in Progress Accounting' nếu bạn muốn duy trì hồ sơ của các tài sản dưới một tài khoản bảng cân đối kế toán tạm thời thay vì tài khoản tài sản tương ứng. Để biết thêm, [truy cập trang này](/docs/v13/user/manual/en/asset/purchasing-an-asset).
1. Lưu.

    ![Asset Category](https://docs.erpnext.com/docs/v13/assets/img/asset/asset-category.png)
...
* **Depreciation Method**: Chọn phương pháp khấu hao mà bạn sẽ dùng để ghi nhận khấu hao của các tài sản trong nhóm này. Để biết thêm, [truy cập trang này](/docs/v13/user/manual/en/asset/asset-depreciation).
