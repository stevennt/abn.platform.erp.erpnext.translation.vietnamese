...
<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/patient_1.png">
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/patient-repo.png">
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/patient_personal_history.png">

#### 2.1.2 Ghi lại tiền sử y tế

Tùy chọn ghi lại Tiền sử y tế như Dị ứng, Thuốc, Tiền sử bệnh và Tiền sử phẫu thuật.

<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/patient_surgical_history.png">

#### 2.1.3 Ghi lại các yếu tố nguy cơ và hơn thế nữa

Ghi lại các Yếu tố nguy cơ như thói quen sử dụng thuốc lá và rượu, v.v.

<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/patient_risk_factors.png">
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/patient_link_customer.png">
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/patient_registration_fee.png">
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/patient_disabled.png">
