...
Chuyên gia y tế là các bác sĩ, điều dưỡng, hộ lý, kỹ thuật viên phòng xét nghiệm, v.v., những người đang phục vụ tại đơn vị bệnh viện theo những cách khác nhau. ERPNext Healthcare cho phép bạn tạo nhiều chuyên gia y tế và liên kết với một Người dùng (User) với các Vai trò (Roles) phù hợp. Bạn cũng có thể liên kết một Chuyên gia y tế với một [Nhân viên](../human-resources/employee.md) để theo dõi Bảng lương, Chấm công hoặc các hoạt động Quản lý nhân sự khác.

<img class="screenshot" alt="ERPNext Healthcare" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/practitioner_1.png">
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/practitioner.png">

## 2. Các tính năng

### 2.1 Theo dõi Bảng lương, Chấm công, Vai trò và Quyền hạn

Để theo dõi tất cả các hoạt động Quản lý nhân sự cho Chuyên gia y tế, bạn cần tạo và chọn [Nhân viên](../human-resources/employee.md) trong trường "Employee" trong hồ sơ chuyên gia. Điều này sẽ giúp chạy [Bảng lương](../human-resources/payroll-intro.md) và cũng giúp theo dõi sự sẵn sàng và việc chấm công để đặt lịch hẹn bằng cách thiết lập [Danh sách ngày nghỉ](../human-resources/holiday-list.md) và [Lịch làm việc của Chuyên gia](practitioner_schedule.md) phù hợp. Sau đó, bạn có thể tạo một Người dùng ERPNext được liên kết với tài liệu Nhân viên. Điều này sẽ giúp theo dõi các quyền hạn cho Chuyên gia y tế.

<img class="screenshot" alt="ERPNext Healthcare" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/practitioner-employee.png">
...
Bạn có thể chọn nhiều [Lịch làm việc của Chuyên gia](practitioner_schedule.md) cho mỗi chuyên gia và tùy chọn thiết lập một đơn vị dịch vụ nơi chuyên gia đó sẽ làm việc.
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/practitioner_charges.png">
...
1. [Người dùng và Quyền hạn](../setting-up/users-and-permissions)
2. [Nhân viên](../human-resources/employee.md)
3. [Lịch làm việc của Chuyên gia](practitioner_schedule.md)
