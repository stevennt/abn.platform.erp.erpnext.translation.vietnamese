...
<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/clinical_procedure_template.png">
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/clinical_procedure_item.png">
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/procedure_consumables.png">
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/invoice_separately.png">

### 2.4 Cấu hình Thu thập mẫu

Lưu ý rằng bạn cũng có thể bật "Sample Collection" cho một Thủ thuật Lâm sàng nếu phù hợp.

<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/sample_collection.png">
