...
![Single Result Format](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/single-result.png)
...
![Compound Result Format](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/compound-result.png)
...
![Descriptive Result Format](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/descriptive-result.png)
...
![Grouped Result Format](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/grouped-result.png)
...
![Lab Test Item](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/lab-test-item.png)
...
Bạn cũng có thể cấu hình Tiêu chuẩn Mã Y tế (Medical Code Standard) và Mã Y tế (Medical Code) cho các mẫu của mình trong phần Mã hóa Y tế.

![Medical Code](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/lab-test-medical-code.png)

### 2.4 Cấu hình Lấy mẫu

Bạn có thể cấu hình Mẫu cần được thu thập khi tạo Xét nghiệm. Chọn Mẫu Xét nghiệm, thiết lập Đơn vị tính (UOM) và số lượng cần thiết.

![Medical Code](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/lab-test-template-sample.png)

### 2.5 In Phiếu hướng dẫn (Worksheet Print)

Bạn có thể cấu hình các hướng dẫn cho Kỹ thuật viên Xét nghiệm tại đây. Những hướng dẫn này sẽ hiển thị trong định dạng "Lab Test Print" của DocType Xét nghiệm chỉ khi nó chưa được Xác nhận.

![Worksheet](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/healthcare/worksheet.png)

### 2.6 In Chú giải Kết quả (Result Legend Print)

> Biểu mẫu này đã được thay đổi trong Phiên bản 13

Bạn có thể cấu hình mẫu cần được thu thập khi tạo Xét nghiệm. Chọn Mẫu Xét nghiệm, thiết lập Đơn vị tính (UOM) và số lượng cần thiết. Chọn vị trí bạn muốn in chú giải này và cấu hình chú giải trong...