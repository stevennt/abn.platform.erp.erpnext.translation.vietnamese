...
* [Bệnh nhân (Patient)](/docs/v13/user/manual/en/healthcare/patient)
* [Hồ sơ nội trú (Inpatient Record)](/docs/v13/user/manual/en/healthcare/inpatient_record)
* [Đơn thuốc nội trú (Inpatient Medication Order)](/docs/v13/user/manual/en/healthcare/inpatient_medication_order)
...
4. Có nhiều bộ lọc khác nhau để lấy các Đơn thuốc nội trú đang chờ xử lý:
    ...
    <img class="screenshot" alt="Inpatient Medication Entry filters" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/ime-filters.png">
...
6. Tùy chọn, đánh dấu hoặc bỏ đánh dấu *Cập nhật tồn kho (Update Stock)*. Nếu được đánh dấu, hãy chỉ định Kho (Warehouse) nơi thuốc sẽ được xuất.
    ...
    <img class="screenshot" alt="Update Stock" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/ime-stock.png">

### 2.2 Khi Xác nhận Nhập thuốc nội trú

Các Đơn thuốc nội trú tương ứng sẽ được đánh dấu là đã hoàn thành.

<img class="screenshot" alt="Completed Inpatient Medication Order Entry" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/imoe-completed.png">
...
<img class="screenshot" alt="Stock Entry" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/ime-stock-entry.png">

<img class="screenshot" alt="Stock Entry Detail" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/ime-stock-entry-detail.png">
...
<img class="screenshot" alt="Drug Shortage Dialog" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/drug-shortage-dialog.gif">
...
<img class="screenshot" alt="Make Stock Entry for Drug Shortage" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/make-stock-entry.gif">

## 3. Các chủ đề liên quan

1. [Đơn thuốc nội trú (Inpatient Medication Order)](/docs/v13/user/manual/en/healthcare/inpatient_medication_order)
