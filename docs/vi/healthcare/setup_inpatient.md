...
Bạn có thể thiết lập cơ sở hạ tầng của mình (phòng bệnh, giường bệnh, v.v.) trong ERPNext bằng cách sử dụng tài liệu [Healthcare Service Unit](healthcare_service_unit.html.md).
