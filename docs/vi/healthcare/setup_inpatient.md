...
Bạn có thể thiết lập cơ sở hạ tầng của mình (phòng bệnh, giường bệnh, v.v.) trong ERPNext bằng cách sử dụng tài liệu [Healthcare Service Unit](/docs/v13/user/manual/en/healthcare/healthcare_service_unit.html).
