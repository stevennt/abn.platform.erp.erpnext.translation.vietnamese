...
6. Lưu và Xác nhận.
  ...
  ![Sample Collection](https://docs.erpnext.com/docs/v13/assets/img/healthcare/sample-collection.png)
...
![Sample Print](https://docs.erpnext.com/docs/v13/assets/img/healthcare/sample-print.png)
