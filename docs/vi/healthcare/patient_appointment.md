...
2. Chọn [Patient](/docs/v13/user/manual/en/healthcare/patient) mà bạn muốn thiết lập cuộc hẹn. Tên Bệnh nhân, Giới tính và Tuổi của Bệnh nhân sẽ được tự động lấy dữ liệu khi chọn Bệnh nhân. Nếu bệnh nhân là Bệnh nhân nội trú (Đã nhập viện), thì Hồ sơ nội trú cũng sẽ được tự động lấy cho họ.
3. Bạn có thể tùy chọn chọn [Service Unit](/docs/v13/user/manual/en/healthcare/healthcare_service_unit) nơi bạn muốn lên lịch hẹn. Nếu bạn đang đặt lịch hẹn cho một bệnh nhân nội trú, bạn cũng có thể chọn đơn vị dịch vụ nơi bệnh nhân đang nhập viện, bên cạnh các đơn vị dịch vụ đã được bật cấu hình _Allow Appointments_.
4. Nếu bạn cần đặt Hẹn khám cho Thủ thuật lâm sàng, hãy chọn một [Clinical Procedure Template](/docs/v13/user/manual/en/healthcare/clinical_procedure_template). Nếu bạn muốn chọn một Thủ thuật lâm sàng đã được chỉ định cho bệnh nhân trong lần Tiếp xúc bệnh nhân trước đó, hãy nhấp vào nút **Get Prescribed Clinical Procedures** để chọn từ danh sách các Thủ thuật lâm sàng đã được chỉ định cho Bệnh nhân đã chọn. Quy trình tương tự cũng được áp dụng để lấy các Loại trị liệu đã được chỉ định bằng cách sử dụng nút **Get Prescribed Therapies** hoặc chỉ cần chọn một [Therapy Type](/docs/v13/user/manual/en/healthcare/therapy_type).
...
6. Nếu bạn đã tích chọn "Automate Appointment Invoicing" trong [Healthcare Settings](/docs/v13/user/manual/en/healthcare/healthcare_settings), việc thiết lập các trường "Mode of Payment" và "Amount" trong Patient Appointment là bắt buộc.
