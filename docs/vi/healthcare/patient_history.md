...
Từ phiên bản 13 trở đi, bạn có thể cấu hình tất cả các loại DocType và các trường nào sẽ là một phần của Hồ sơ y tế của Bệnh nhân và Lịch sử Bệnh nhân bằng cách sử dụng [Patient History Settings](/docs/v13/user/manual/en/healthcare/patient_history_settings).
...
<img class="screenshot" alt="Patient History" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/patient-history-1.gif">
...
<img class="screenshot" alt="Patient Medical Record" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/medical_record_2.png">
