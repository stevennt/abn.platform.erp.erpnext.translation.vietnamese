...
<img class="screenshot" alt=Therapy Plan" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/therapy-plan.png">
...
<img class="screenshot" alt="Therapy Plan from Therapy Template" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/therapy-plan-from-template.gif">
...
<img class="screenshot" alt="Therapy Plan Template Invoice" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/therapy-plan-template-invoice.gif">
...
<img class="screenshot" alt="ERPNext Healthcare" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/create-therapy-session.png">
...
<img class="screenshot" alt="Sales Invoice from Therapy Plan" src="https://docs.erpnext.com/docs/v13/assets/img/healthcare/sales-invoice-from-therapy-plan.png">
