...
Quy trình ADT của Bệnh nhân cũng được quản lý trong Hồ sơ nội trú như được mô tả trong phần [Inpatient ADT](/docs/v13/user/manual/en/healthcare/inpatient_adt.html).
