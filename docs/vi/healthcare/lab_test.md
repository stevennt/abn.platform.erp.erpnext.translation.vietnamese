...
7. Bạn có thể thay đổi dữ liệu đã cấu hình trước theo yêu cầu của mình. Thêm nhận xét nếu có, trong phần Ghi chú.
    ...
    ![Lab Test](https://docs.erpnext.com/docs/v13/assets/img/healthcare/lab-test.png)
...
Ví dụ, Xét nghiệm theo nhóm:
    ![Lab Result](https://docs.erpnext.com/docs/v13/assets/img/healthcare/lab_test_2.png)

Xét nghiệm mô tả:
    ![Lab Result](https://docs.erpnext.com/docs/v13/assets/img/healthcare/lab-result.png)

Các thành phần mà mục _Cho phép để trống_ không được tích sẽ báo lỗi xác thực nếu để trống khi Xác nhận.

    ![Lab Result](https://docs.erpnext.com/docs/v13/assets/img/healthcare/result-mandatory.png)
...
![Lab Test Multiple](https://docs.erpnext.com/docs/v13/assets/img/healthcare/lab_test_3.png)
...
![Lab Test](https://docs.erpnext.com/docs/v13/assets/img/healthcare/patient-encounter-lab-tests-1.png)

Các xét nghiệm được chỉ định trong phần Khám bệnh của Cuộc gặp bệnh nhân đó sẽ được lấy ra.

![Lab Test](https://docs.erpnext.com/docs/v13/assets/img/healthcare/patient-encounter-lab-tests.png)

![Lab Test](https://docs.erpnext.com/docs/v13/assets/img/healthcare/patient-encounter-lab-tests-2.png)
...
![Lab Sample Collection](https://docs.erpnext.com/docs/v13/assets/img/healthcare/lab-sample-collection.png)
...
![Sensitivity](https://docs.erpnext.com/docs/v13/assets/img/healthcare/sensitivity.png)
...
![Format Test Result](https://docs.erpnext.com/docs/v13/assets/img/healthcare/format-result-value.png)

![Formatted Result](https://docs.erpnext.com/docs/v13/assets/img/healthcare/formatted-result.png)
