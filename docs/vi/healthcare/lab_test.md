...
2. Chọn [Mẫu xét nghiệm Lab](/docs/v13/user/manual/en/healthcare/lab_test_template). Khoa Y tế sẽ tự động được lấy từ mẫu.
...
Bạn có thể cấu hình các tin nhắn để gửi thông báo SMS cho bệnh nhân bất cứ khi nào kết quả xét nghiệm lab đã sẵn sàng trong [Cài đặt Healthcare](/docs/v13/user/manual/en/healthcare/healthcare_settings). Để làm điều này, trước tiên bạn phải thiết lập [Cài đặt SMS](/docs/v13/user/manual/en/setting-up/sms-setting).
