...
Lịch làm việc của Chuyên gia y tế sẽ giúp bạn cấu hình thời gian trống của các Chuyên gia y tế. Sau đó, bạn có thể chọn nhiều lịch làm việc áp dụng cho mỗi [Healthcare Practitioner](healthcare_practitioner.md).
...
1. [Healthcare Practitioner](healthcare_practitioner.md)
