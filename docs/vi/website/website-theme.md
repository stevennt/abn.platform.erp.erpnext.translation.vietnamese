...
![Select Website Theme in Website Settings](https://docs.erpnext.com/docs/v13/assets/img/website/website-theme.png)
...
Nếu bạn biết về [SCSS](https://sass-lang.com/guide) và [tùy chỉnh Bootstrap 4](https://getbootstrap.com/docs/v13/4.3/getting-started/theming/), bạn có thể tự viết mã SCSS tùy chỉnh.
...
![Included Theme Files](https://docs.erpnext.com/docs/v13/assets/img/website/website-theme-included-theme-files.gif)
