...
![Homepage](https://docs.erpnext.com/docs/v13/assets/img/website/homepage.png)
*Trang chủ*
...
![Website Homepage](https://docs.erpnext.com/docs/v13/assets/img/website/website-homepage.png)
*Trang chủ Website*
...
![Homepage Slideshow Setting](https://docs.erpnext.com/docs/v13/assets/img/website/homepage-slideshow-setting.png)
*Thiết lập Trình chiếu Trang chủ*

Bây giờ, hãy chọn một Slideshow hiện có hoặc tạo một cái mới như sau:

![Website Slideshow](https://docs.erpnext.com/docs/v13/assets/img/website/website-slideshow.png)
*Trình chiếu Website*
...
![Website Homepage with Slideshow](https://docs.erpnext.com/docs/v13/assets/img/website/website-homepage-slideshow.gif)
...
![Homepage Settings](https://docs.erpnext.com/docs/v13/assets/img/website/homepage-hero-custom.png)
*Cài đặt Trang chủ*
...
![New Hero Section](https://docs.erpnext.com/docs/v13/assets/img/website/hero-custom.png)
*Phần Hero mới*

Nó sẽ trông giống như thế này:
![Homepage Hero Custom](https://docs.erpnext.com/docs/v13/assets/img/website/website-homepage-custom.png)
...
![Homepage Products Table](https://docs.erpnext.com/docs/v13/assets/img/website/homepage-featured-products.png)
*Bảng Sản phẩm của Trang chủ*

Nó sẽ trông giống như thế này:
![Featured Products on Homepage](https://docs.erpnext.com/docs/v13/assets/img/website/website-featured-products.png)
...
![New Homepage Section](https://docs.erpnext.com/docs/v13/assets/img/website/new-homepage-section.png)
*Phần Trang chủ mới*

Thêm chi tiết cho mỗi thẻ như Tiêu đề, Phụ đề, Hình ảnh, Nội dung và Đường dẫn trong bảng Section Cards.

Nó sẽ trông giống như thế này:
![Homepage Section](https://docs.erpnext.com/docs/v13/assets/img/website/homepage-section.png)
*Phần Trang chủ*
...
1. Thiết lập Home Page làm `route` cho Web Page của bạn.
   ![](https://docs.erpnext.com/docs/v13/assets/img/website/custom-homepage.png)
