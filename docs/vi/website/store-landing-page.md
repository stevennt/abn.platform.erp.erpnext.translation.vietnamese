...
![Store Landing Page](https://docs.erpnext.com/docs/v13/assets/img/website/store-landing-page.png)
...
1. Chọn một Mẫu Web (Web Template).
	...
	![Store Web Templates](https://docs.erpnext.com/docs/v13/assets/img/website/store-web-templates.png)
...
1. Thêm Giá trị.
	...
	- **Hero Slider (Trình trượt chính):**
		...
		![Store Hero Slider](https://docs.erpnext.com/docs/v13/assets/img/website/store-hero-slider.png)
	...
	- **Product Category Cards (Thẻ Nhóm mặt hàng):**
		...
		![Store Product Category Cards](https://docs.erpnext.com/docs/v13/assets/img/website/store-product-category.png)
	...
	- **Item Card Group (Nhóm thẻ Mặt hàng):**
		...
		![Store Item Card Group](https://docs.erpnext.com/docs/v13/assets/img/website/store-item-card-group.png)
...
1. Xuất bản Trang Web của bạn.
	...
	![Store Page Published](https://docs.erpnext.com/docs/v13/assets/img/website/store-page-published.png)
