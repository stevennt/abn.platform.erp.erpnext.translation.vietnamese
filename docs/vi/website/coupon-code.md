...
1. Tính năng Mã Coupon cần được kích hoạt từ Cài đặt Giỏ hàng:
	...
	<img class="screenshot" alt="Shopping Cart Settings to enable Coupon Code" src="https://docs.erpnext.com/docs/v13/assets/img/selling/coupon-code-shoppingcart-settings.png">
...
4. Chọn [Pricing Rule](/docs/v13/user/manual/en/accounts/pricing-rule) có bật cờ **coupon code based**.

5. Nhấn Lưu

	<img class="screenshot" alt="Coupon Code Doctype" src="https://docs.erpnext.com/docs/v13/assets/img/selling/coupon-code.png">
...
4. **Coupon Code Description** - có thể được sử dụng khi tạo Mẫu email để thông báo cho khách hàng tiềm năng về mã coupon và thông tin chương trình
	...
	<img class="screenshot" alt="Pricing Rule Coupon Code Based" src="https://docs.erpnext.com/docs/v13/assets/img/selling/coupon-code-pricing-rule.png">
...
2. Áp dụng mã một cách rõ ràng, bằng cách điền mã và nhấn nút "Apply Coupon Code" như hiển thị dưới đây trong trang giỏ hàng
	...
	<img class="screenshot" alt="Shopping Cart Apply CouponCode" src="https://docs.erpnext.com/docs/v13/assets/img/selling/coupon-code-pricing-rule.png">
