...
![Website Setting Home](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/articles/Selection_021.png)

#### **Bước 4: Lưu Biểu mẫu Cài đặt Website.**

Sau khi thiết lập Trang chủ, hãy nhấn nút `Save` từ trang cài đặt website và làm mới (refresh) hệ thống từ menu Help. Bằng cách này, bạn có thể thiết lập bất kỳ trang tiêu chuẩn nào làm trang chủ website mặc định của mình. Khi có ai đó truy cập vào website của bạn, họ sẽ thấy trang chủ là trang đích mặc định trên website của bạn.