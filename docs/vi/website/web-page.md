...
![New Web Page](https://docs.erpnext.com/docs/v13/assets/img/website/new-web-page.png)
*Trang Web Mới*

Xem Trang Web của bạn bằng cách nhấn vào **See on Website** ở thanh bên.

![Web Page](https://docs.erpnext.com/docs/v13/assets/img/website/web-page.png)
*Trang Web*
...
![Image Link](https://docs.erpnext.com/docs/v13/assets/img/website/get-image-link.png)
...
Bạn cũng có thể thêm một Slideshow vào Trang Web của mình. Tham khảo cách tạo Slideshow tại [Homepage Slideshow](/docs/v13/user/manual/en/website/homepage#22-homepage-slideshow)
...
![Web Page Sidebar](https://docs.erpnext.com/docs/v13/assets/img/website/web-page-sidebar.png)
*Thanh bên Trang Web*

Thêm các liên kết và đường dẫn của chúng trong bảng Mục thanh bên (Sidebar Items).
![Website Sidebar](https://docs.erpnext.com/docs/v13/assets/img/website/new-website-sidebar.png)
*Thanh bên Website*

![Web Page with Sidebar](https://docs.erpnext.com/docs/v13/assets/img/website/web-page-with-sidebar.png)
...
![Web Page Comments](https://docs.erpnext.com/docs/v13/assets/img/website/web-page-comments.gif)
*Bình luận Trang Web*
...
![Web Page Header](https://docs.erpnext.com/docs/v13/assets/img/website/web-page-header.png)
*Tiêu đề đầu trang Trang Web*

![Web Page with Custom Header](https://docs.erpnext.com/docs/v13/assets/img/website/web-page-with-custom-header.png)
...
![Web Page Breadcrumbs](https://docs.erpnext.com/docs/v13/assets/img/website/web-page-breadcrumbs.png)
*Đường dẫn điều hướng Trang Web*

![Web Page with Breadcrumbs](https://docs.erpnext.com/docs/v13/assets/img/website/web-page-with-breadcrumbs.png)
...
![Web Page Meta Tags](https://docs.erpnext.com/docs/v13/assets/img/website/web-page-meta-tags.gif)
*Thẻ Meta Trang Web*
