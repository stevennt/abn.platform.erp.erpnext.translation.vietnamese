...
![Shopping Cart Settings](https://docs.erpnext.com/docs/v13/assets/img/website/shopping-cart-settings.png)
...
![Item without Variants](https://docs.erpnext.com/docs/v13/assets/img/website/item-without-variants.png)
...
![Item with Variants](https://docs.erpnext.com/docs/v13/assets/img/website/item-with-variants.gif)
...
![Cart Quotation](https://docs.erpnext.com/docs/v13/assets/img/website/cart-quotation.png)
*Báo giá từ giỏ hàng*
...
![Cart Checkout Settings](https://docs.erpnext.com/docs/v13/assets/img/website/cart-checkout-settings.png)
*Cài đặt thanh toán giỏ hàng*

![Cart Checkout](https://docs.erpnext.com/docs/v13/assets/img/website/cart-checkout.png)
*Thanh toán giỏ hàng*