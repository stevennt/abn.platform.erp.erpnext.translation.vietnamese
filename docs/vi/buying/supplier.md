...
Các tùy chọn Cảnh báo RFQ, PO, Ngăn chặn RFQ, PO sẽ khả dụng sau khi bạn tạo [Bảng điểm Nhà cung cấp](/docs/v13/user/manual/en/buying/supplier-scorecard) và các giao dịch được thực hiện.
...
* **Danh mục thuế**: Mục này được liên kết với [Quy tắc thuế](/docs/v13/user/manual/en/accounts/tax-rule). Nếu một Danh mục thuế được thiết lập tại đây, khi bạn chọn nhà cung cấp này, mẫu Thuế mua hàng và Phí tương ứng sẽ được áp dụng. Mẫu này được liên kết với Quy tắc thuế và Quy tắc thuế được liên kết với Danh mục thuế. Danh mục thuế có thể được sử dụng để nhóm các nhà cung cấp mà cùng một loại thuế sẽ được áp dụng. Ví dụ: Chính phủ, thương mại, v.v.
* **Ngôn ngữ in**: Ngôn ngữ mà tài liệu sẽ được in ra.
* **Danh mục khấu trừ thuế**: Đối với Ấn Độ, danh mục TDS cho Nhà cung cấp. Khi thiết lập một danh mục tại đây, nó sẽ được lấy vào [Hóa đơn mua hàng](/docs/v13/user/manual/en/accounts/purchase-invoice). Để biết thêm thông tin, hãy truy cập trang [Danh mục khấu trừ thuế](/docs/v13/user/manual/en/accounts/tax-withholding-category).
