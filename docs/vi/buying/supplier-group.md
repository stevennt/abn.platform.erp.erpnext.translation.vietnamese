...
Với [Phân quyền người dùng](https://docs.erpnext.com/docs/v13/user/manual/en/setting-up/users-and-permissions) mới, giờ đây bạn có thể áp dụng các quyền dựa trên phân cấp. Nghĩa là, nếu một Người dùng được phép xem nút cha của Nhóm nhà cung cấp, người đó sẽ mặc nhiên có quyền xem các nút con của nút cha đó.
