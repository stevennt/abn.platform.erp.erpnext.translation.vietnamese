...
![Buying Flow](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/buying/buying_flow_sq.png)
...
![Supplier Quotation from Material Receipt](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/buying/supplier-quotation-from-mr.png)
...
1. Nhập mã Mặt hàng, chọn số lượng. Đơn giá sẽ được tự động lấy về nếu bạn đã thiết lập Đơn giá mua tiêu chuẩn cho mặt hàng đó trong [Item Price](../stock/item-price.md).
    <img class="screenshot" alt="Supplier Quotation" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/buying/supplier-quotation.png">
