...
![Twitter App Permission](https://docs.erpnext.com/docs/v13/assets/img/crm/twitter-app-permission.png)
...
![Twitter App Callback URL](https://docs.erpnext.com/docs/v13/assets/img/crm/twitter-callback-url.png)
...
![Twitter Settings](https://docs.erpnext.com/docs/v13/assets/img/crm/twitter-settings.png)
...
![Twitter Keys Tokens](https://docs.erpnext.com/docs/v13/assets/img/crm/twitter-key-token.png)
...
![Twitter Authorize App](https://docs.erpnext.com/docs/v13/assets/img/crm/twitter-authorize-app.png)
