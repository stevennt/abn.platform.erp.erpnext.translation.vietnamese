...
7. Lưu
    ...
    ![Email Campaign](https://docs.erpnext.com/docs/v13/assets/img/crm/email-campaign.png)
...
2. Nhấp vào dấu + trước mục Chiến dịch Email để tạo một Chiến dịch Email mới cho Chiến dịch đó.
    ...
    ![Email Campaigns from Dashboard](https://docs.erpnext.com/docs/v13/assets/img/crm/campaign-dashboard.png)
...
![Linked Communication](https://docs.erpnext.com/docs/v13/assets/img/crm/email-campaign-linked-comm.png)
...
![Unsubscribe Link](https://docs.erpnext.com/docs/v13/assets/img/crm/unsubscribe-link.png)
...
![Unsubscribed](https://docs.erpnext.com/docs/v13/assets/img/crm/email-campaign-unsubscribed.png)
...
<img class="screenshot" alt="Email Template Document" src="https://docs.erpnext.com/docs/v13/assets/img/crm/email-template-doc.png">
![](https://docs.erpnext.com/docs/v13/assets/img/crm/)

Khi đó, các email được gửi đi sẽ trông như thế này:

<img class="screenshot" alt="Email Campaign Doc Data" src="https://docs.erpnext.com/docs/v13/assets/img/crm/email-campaign-doc-data.png">
![](https://docs.erpnext.com/docs/v13/assets/img/crm/)
...
![Email Campaign Status](https://docs.erpnext.com/docs/v13/assets/img/crm/email-campaign-status.png)
