...
* [Khách hàng tiềm năng](/docs/v13/user/manual/en/CRM/lead) hoặc [Liên hệ](/docs/v13/user/manual/en/CRM/contact) hoặc [Nhóm Email](/docs/v13/user/manual/en/CRM/email_group)

## 2. Cách tạo một Chiến dịch Email

1. Đi tới danh sách Chiến dịch Email, nhấn vào Mới.
2. Chọn [Chiến dịch](/docs/v13/user/manual/en/CRM/campaign) mà bạn muốn thiết lập Chiến dịch Email.
...
7. Lưu
    ...
    ![Email Campaign](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/crm/email-campaign.png)
...
2. Nhấp vào dấu + trước mục Chiến dịch Email để tạo một Chiến dịch Email mới cho Chiến dịch đó.
    ...
    ![Email Campaigns from Dashboard](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/crm/campaign-dashboard.png)
...
![Linked Communication](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/crm/email-campaign-linked-comm.png)
...
![Unsubscribe Link](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/crm/unsubscribe-link.png)
...
![Unsubscribed](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/crm/email-campaign-unsubscribed.png)
...
<img class="screenshot" alt="Email Template Document" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/crm/email-template-doc.png">
![](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/crm/)

Khi đó, các email được gửi đi sẽ trông như thế này:

<img class="screenshot" alt="Email Campaign Doc Data" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/crm/email-campaign-doc-data.png">
![](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/crm/)
...
![Email Campaign Status](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/crm/email-campaign-status.png)

## 4. Các chủ đề liên quan
1. [Chiến dịch](/docs/v13/user/manual/en/CRM/campaign)
1. [Khách hàng tiềm năng](/docs/v13/user/manual/en/CRM/lead)
1. [Liên hệ](/docs/v13/user/manual/en/CRM/contact)

Tiếp theo: [Bản tin](/docs/v13/user/manual/en/CRM/newsletter)