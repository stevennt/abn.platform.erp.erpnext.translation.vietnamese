...
4. Lưu.
    ![Contact](https://docs.erpnext.com/docs/v13/assets/img/crm/address.png)
...
![Add Address From Customer](https://docs.erpnext.com/docs/v13/assets/img/crm/add-address-from-customer.png)
...
![Link One Address to Multiple Entities](https://docs.erpnext.com/docs/v13/assets/img/crm/link-address-to-multiple-entities.png)
...
![Address Title](https://docs.erpnext.com/docs/v13/assets/img/crm/address-title.png)
...
![GST Details in Address](https://docs.erpnext.com/docs/v13/assets/img/crm/gst-details-in-address.png)

Trong các giao dịch bán hàng, cùng với địa chỉ, GSTIN cũng sẽ được lấy ra.

![GST Details in Sales Order](https://docs.erpnext.com/docs/v13/assets/img/crm/gst-details-in-sales-order.png)
...
![Company Address](https://docs.erpnext.com/docs/v13/assets/img/crm/company-address.png)
