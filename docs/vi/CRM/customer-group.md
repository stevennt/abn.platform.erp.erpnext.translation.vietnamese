...
![Customer Group](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/crm/customer-group.png)
...
![Sales Analytics Customer Group](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/crm/sales-analytics-customer-group.gif)

### 2. Các tính năng

#### 2.1 Gán Hạn mức tín dụng, Bảng giá mặc định và Mẫu điều khoản thanh toán mặc định

Bạn có thể gán hạn mức tín dụng, [Price List](/docs/v13/user/manual/en/stock/price-lists), và [Payment Terms](/docs/v13/user/manual/en/accounts/payment-terms), chúng sẽ được tự động áp dụng khi một khách hàng thuộc nhóm khách hàng đó được chọn trong các giao dịch bán hàng như [Sales Order](/docs/v13/user/manual/en/selling/sales-order) và [Sales Invoice](/docs/v13/user/manual/en/accounts/sales-invoice).

#### 2.2 Tài khoản phải thu mặc định

Bạn không cần phải tạo một sổ cái kế toán riêng biệt cho từng khách hàng trong ERPNext. Đọc [Common Receivable Account](/docs/v13/user/manual/en/accounts/articles/common-receivable-account) để biết thêm chi tiết.
