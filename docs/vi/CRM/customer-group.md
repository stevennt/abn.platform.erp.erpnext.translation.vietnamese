...
![Customer Group](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/crm/customer-group.png)
...
![Sales Analytics Customer Group](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/crm/sales-analytics-customer-group.gif)

### 2. Các tính năng

#### 2.1 Gán Hạn mức tín dụng, Bảng giá mặc định và Mẫu điều khoản thanh toán mặc định

Bạn có thể gán hạn mức tín dụng, [Price List](../stock/price-lists.md), và [Payment Terms](../accounts/payment-terms.md), chúng sẽ được tự động áp dụng khi một khách hàng thuộc nhóm khách hàng đó được chọn trong các giao dịch bán hàng như [Sales Order](../selling/sales-order.md) và [Sales Invoice](../accounts/sales-invoice.md).

#### 2.2 Tài khoản phải thu mặc định

Bạn không cần phải tạo một sổ cái kế toán riêng biệt cho từng khách hàng trong ERPNext. Đọc [Common Receivable Account](../accounts/articles/common-receivable-account.md) để biết thêm chi tiết.
...
1. [Price List](../stock/price-lists.md)
1. [Payment Terms](../accounts/payment-terms.md)
