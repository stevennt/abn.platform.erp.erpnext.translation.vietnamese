...
1. Lưu.
 ![New Appointment](https://docs.erpnext.com/docs/v13/assets/img/crm/new-appointment.png)
...
![Appointment Webform](https://docs.erpnext.com/docs/v13/assets/img/crm/appointment-webform.png)

Sau đó, thêm các chi tiết khác:
![Appointment Details](https://docs.erpnext.com/docs/v13/assets/img/crm/appointment-details.png)
