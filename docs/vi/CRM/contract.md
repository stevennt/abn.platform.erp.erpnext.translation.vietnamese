...
1. Lưu.
    ![Contract](https://docs.erpnext.com/docs/v13/assets/img/crm/contract.png)
...
![Contract Signee](https://docs.erpnext.com/docs/v13/assets/img/crm/contract-signee.png)
...
![Contract Fulfilment](https://docs.erpnext.com/docs/v13/assets/img/crm/contract-fulfilment.png)
...
![Contract Template](https://docs.erpnext.com/docs/v13/assets/img/crm/contract-template-jinja.gif)
...
![Contract References](https://docs.erpnext.com/docs/v13/assets/img/crm/contract-reference.png)
