...
<img class="screenshot" alt="Item" src="https://docs.erpnext.com/docs/v13/assets/img/manufacturing/allow-alternative-item.png">
...
<img class="screenshot" alt="Item Alternative" src="https://docs.erpnext.com/docs/v13/assets/img/manufacturing/item-alternative.png">
...
<img class="screenshot" alt="Item" src="https://docs.erpnext.com/docs/v13/assets/img/manufacturing/allow-alternative-item-bom.png">
...
<img class="screenshot" alt="Item" src="https://docs.erpnext.com/docs/v13/assets/img/manufacturing/allow-alternative-item-wo.png">
...
<img class="screenshot" alt="Item" src="https://docs.erpnext.com/docs/v13/assets/img/manufacturing/work_order_item_alternative.gif">

Đây là cách bạn sử dụng Mặt hàng thay thế với một Phiếu kho:
<img class="screenshot" alt="Item" src="https://docs.erpnext.com/docs/v13/assets/img/manufacturing/se_item_alternative.gif">
...
<img class="screenshot" alt="Item" src="https://docs.erpnext.com/docs/v13/assets/img/manufacturing/purchase_order_item_alternative.gif">
