...
1. Lưu.
    ...
    ![Routing](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/manufacturing/routing.png)

Sau khi được tạo, một Quy trình sản xuất có thể được chọn trong BOM để lấy các Công đoạn đã được lưu trong Quy trình đó.
![Routing BOM](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/manufacturing/routing-bom.png)

## 3. Sequence ID trong Quy trình sản xuất
![Routing Sequence ID](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/manufacturing/sequence-id-routing.png)
...
<!-- ![Error](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/manufacturing/sequence-id-error.png) -->
