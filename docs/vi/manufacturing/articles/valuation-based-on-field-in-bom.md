...
<img alt="Nested BOM" class="screenshot" src="https://docs.erpnext.com/docs/v13/assets/img/articles/valuation-based-on-1.png">
...
**Price List Rate:** Tùy chọn này cho phép lấy đơn giá mặt hàng từ [Bảng giá.](/docs/v13/user/manual/en/stock/item-price)
