...
![Multi-level BOM](https://docs.erpnext.com/docs/v13/assets/img/articles/multi-bom.png)
...
![Multi-level BOM](https://docs.erpnext.com/docs/v13/assets/img/articles/bom-materials.png)

Trong chế độ xem phân rã (exploded view), chỉ các nguyên vật liệu thô được hiển thị:
![Multi-level BOM](https://docs.erpnext.com/docs/v13/assets/img/articles/bom-materials-exploded.png)
...
<!-- <img alt="Nested BOM" class="screenshot" src="https://docs.erpnext.com/docs/v13/assets/img/articles/nested-bom-1.png"> -->
