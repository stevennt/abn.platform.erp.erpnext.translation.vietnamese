...
![BOM in different Currency](https://docs.erpnext.com/docs/v13/assets/img/manufacturing/bom-currency.png)
...
![BOM in different Currency](https://docs.erpnext.com/docs/v13/assets/img/manufacturing/bom-currency-1.png)