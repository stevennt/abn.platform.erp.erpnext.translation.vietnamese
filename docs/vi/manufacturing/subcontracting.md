...
3. Đối với Mặt hàng đã qua chế biến, trong danh mục Mặt hàng, hãy bật “Is Sub Contracted Item”.
  ...
  <img class="screenshot" alt="Sub-Contracting" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/manufacturing/subcontract.png">

### 1.1 Tạo BOM
Tạo [Định mức nguyên vật liệu](bill-of-materials.md) cho Mặt hàng đã qua chế biến, với các Mặt hàng chưa qua chế biến là các mặt hàng con. Hãy xem xét một ví dụ đơn giản, nơi bạn sản xuất một cây bút. Cây bút đã qua chế biến sẽ được đặt tên theo Định mức nguyên vật liệu (BOM), trong khi ngòi bút, nhựa, mực, v.v. sẽ được phân loại là các mặt hàng con.
...
<img class="screenshot" alt="Sub-Contracting" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/manufacturing/subcontract2.png">
...
1. Các chi phí liên quan đến quy trình gia công ngoài nên được ghi lại trong trường Đơn giá của bảng Mặt hàng trong Đơn mua hàng như sau:
  ...
  <img class="screenshot" alt="Sub-Contracting" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/manufacturing/subcontract3.png">
...
1. Từ một Đơn mua hàng, chọn nguyên vật liệu để chuyển cho bên gia công:
  ![Sub-Contracting](https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/buying/subcontract-transfer-materials.gif)

1. Sau khi [Đơn mua hàng](../buying/purchase-order.md#35-raw-materials-supplied) được Xác nhận, bạn cũng có thể xem số lượng dự trữ của mặt hàng từ trang tổng quan mặt hàng.

  <img class="screenshot" alt="Sub-Contracting" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/manufacturing/subcontract3-reserved-material.png">
...
<img class="screenshot" alt="Sub-Contracting" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/manufacturing/subcontract4.png">

### 1.4 Tạo Phiếu nhập hàng để nhận các mặt hàng thành phẩm
Nhận các Mặt hàng từ Nhà cung cấp của bạn bằng cách sử dụng [Phiếu nhập hàng](../stock/purchase-receipt.md). Bạn cần nhập Kho của Nhà cung cấp nơi nguyên vật liệu sẽ được lấy ra và thành phẩm sẽ được nhận tại Kho Chấp nhận (Accepted Warehouse). Hãy coi việc này giống như một quy trình backflush cho gia công ngoài.
...
<img class="screenshot" alt="Sub-Contracting" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/manufacturing/subcontract5.png">
...
<img class="screenshot" alt="Supplier Sourced Raw Material" src="https://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/wwwhttps://raw.githubusercontent.com/frappe/erpnext_documentation/master/erpnext_documentation/www/docs/v13/assets/img/manufacturing/supplier_sourced_subcontracting.png">

Tuy nhiên, Nhà cung cấp có thể chọn đưa các mặt hàng do họ cung cấp vào Đơn bán hàng gửi cho bạn.

## 2. Ghi chú
* Đảm bảo rằng “Đơn giá” của Mặt hàng đã qua chế biến là đơn giá gia công (không bao gồm đơn giá nguyên vật liệu).

* ERPNext sẽ tự động thêm nguyên vật liệu m