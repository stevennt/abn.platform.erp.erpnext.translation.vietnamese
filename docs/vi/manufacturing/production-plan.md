...
* [Yêu cầu vật tư](/docs/v13/user/manual/en/stock/material-request)
* [Đơn bán hàng](/docs/v13/user/manual/en/selling/sales-order)
* [Định mức nguyên vật liệu](/docs/docs/v13/user/manual/en/manufacturing/bill-of-materials)
* [Định tuyến](/docs/v13/user/manual/en/manufacturing/routing)
...
1. Chọn lấy mặt hàng từ [Đơn bán hàng](/docs/v13/user/manual/en/selling/sales-order) hay [Yêu cầu vật tư](/docs/v13/user/manual/en/stock/material-request).
...
1. Chọn tùy chọn Sales Order từ danh sách thả xuống 'Get Items From'. Hệ thống sẽ hiển thị các bộ lọc, sử dụng bộ lọc đó bạn có thể lấy các Đơn bán hàng để sản xuất. Bạn không cần sử dụng tất cả các bộ lọc này nếu chỉ có một vài Đơn bán hàng trong một khoảng thời gian cụ thể.
  ...
  ![Production Plan fetch items](https://docs.erpnext.com/docs/v13/assets/img/manufacturing/pp_fetch_from.png)

1. Nhấp vào Get Sales Orders để lấy các đơn bán hàng dựa trên các bộ lọc trên.

  ![Sales Order Filters](https://docs.erpnext.com/docs/v13/assets/img/manufacturing/sales_order_filter.png)
...
1. Nhấp vào 'Get Items for Work Order' để lấy các mặt hàng từ các Đơn bán hàng trên. Chỉ những mặt hàng có Định mức nguyên vật liệu mới được lấy ra.
  ![Get items for Production Plan](https://docs.erpnext.com/docs/v13/assets/img/manufacturing/get_items_wo.png)
...
1. Chọn tùy chọn Material Request từ danh sách thả xuống Get Items From. Hệ thống sẽ hiển thị các bộ lọc, sử dụng bộ lọc đó chúng ta có thể lấy các Yêu cầu vật tư để sản xuất.
  ...
  <img class="screenshot" alt="Material Request Filters" src="https://docs.erpnext.com/docs/v13/assets/img/manufacturing/material_request_filter.png">

1. Nhấp vào 'Get Material Request' để lấy các yêu cầu vật tư dựa trên các bộ lọc trên.

  <img class="screenshot" alt="Material Requests" src="https://docs.erpnext.com/docs/v13/assets/img/manufacturing/material_requests.png">

1. Nhấp vào Get Items for Work Order để lấy các mặt hàng từ các yêu cầu vật tư trên.

  <img class="screenshot" alt="Material Request Item" src="https://docs.erpnext.com/docs/v13/assets/img/manufacturing/material_request_items.png">
...
<img class="screenshot" alt="Material Request Plan" src="https://docs.erpnext.com/docs/v13/assets/img/manufacturing/material_request_plan.png">

Sử dụng các hộp kiểm sau để thực hiện các hành động nhất định:

  * <b>Include Non Stock Items</b>: Để bao gồm các mặt hàng không lưu kho trong việc lập kế hoạch yêu cầu vật tư. Tức là các Mặt hàng mà ô 'Maintain Stock' không được tích. Tham khảo [trang Mặt hàng](/docs/v13/user/manual/en/stock/item#12-options-when-creating-an-item) để biết thêm chi tiết.
 ...
 <img class="screenshot" alt="Material Request Plan" src="https://docs.erpnext.com/docs/v13/assets/img/manufacturing/material_request_excel.png">
...
<img class="screenshot" alt="Make PO or MR" src="https://docs.erpnext.com/docs/v13/assets/img/manufacturing/make_prod_mr_wo.png">
