...
**Loại Dự án là việc phân loại các dự án thành các loại khác nhau để nhóm các loại dự án tương tự lại với nhau.**
...
## 2. Các chủ đề liên quan
  1. [Dự án](/docs/v13/user/manual/en/projects/project)
  2. [Mẫu Dự án](/docs/v13/user/manual/en/projects/project-template)